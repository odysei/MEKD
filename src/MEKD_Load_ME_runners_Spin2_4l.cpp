...
#include "../interface/MEKD_Supported_MEs_Spin2_4l.h"

namespace mekd
{

bool MEKD_MG::Load_ME_runners_try_Spin2_4l(const process_description &d,
										   vector<ME_runner *> &v)
{
...
bool MEKD_MG::Load_ME_runners_try_Spin2_4lA(const process_description &d,
											vector<ME_runner *> &v)
{
