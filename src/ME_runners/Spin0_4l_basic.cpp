...
const process_description ME_runner_no_Spin0Pm_ZZ_4l_2::my_type() { return me; }

bool ME_runner_no_Spin0Pm_ZZ_4l_2::is_my_type(const process_description &in)
{
    return compare_types(in, me);
}
...
const process_description ME_runner_no_Spin0_ZZ_4l_2::my_type() { return me; }

bool ME_runner_no_Spin0_ZZ_4l_2::is_my_type(const process_description &in)
{
    return compare_types(in, me);
}
