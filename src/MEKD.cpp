...
void MEKD::Run_calculate(data &da)
{
    ...
    while (model != NULL) {
        ...
        // Is it a "background"?
        else if ((*model) == "qqZZ" || (*model) == "!qqZZ") {
            d.production = prod_qq;
            Run_ME_Configurator_BKG_ZZ(d, da);
        } else if ((*model) == "ZZ" || (*model) == "!ZZ") {
            d.production = prod_qq;
            Run_ME_Configurator_BKG_ZZ(d, da);
        }

        else if ((*model) == "qqDY" || (*model) == "!qqDY") {
            d.production = prod_qq;
            Run_ME_Configurator_BKG_ZZ(d, da);
        } else if ((*model) == "DY" || (*model) == "!DY") {
        ...
        } else if ((*model) == "qqZ4l_Signal" || (*model) == "!qqZ4l_Signal") {
            d.production = prod_qq;
        ...
        if ((*model) == "ggSpin0Pm" || (*model) == "!ggSpin0Pm") { // SM Higgs
            d.production = prod_gg;
            Run_ME_Configurator_Spin0Pm(d, da);
        } else if ((*model) == "Spin0Pm" || (*model) == "!Spin0Pm") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0Pm(d, da);
        }

        else if ((*model) == "ggSpin0M" || (*model) == "!ggSpin0M") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin0M(d, da);
        } else if ((*model) == "Spin0M" || (*model) == "!Spin0M") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0M(d, da);
        }

        else if ((*model) == "ggSpin0Ph" || (*model) == "!ggSpin0Ph") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin0Ph(d, da);
        } else if ((*model) == "Spin0Ph" || (*model) == "!Spin0Ph") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0Ph(d, da);
        }

        else if ((*model) == "ggSpin0" || (*model) == "!ggSpin0") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin0(d, da, params_MG);
        } else if ((*model) == "Spin0" || (*model) == "!Spin0") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0(d, da, params_MG);
        }

        // Is it a spin-1 resonance?
        else if ((*model) == "qqSpin1M" || (*model) == "!qqSpin1M") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1M(d, da);
        } else if ((*model) == "Spin1M" || (*model) == "!Spin1M") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1M(d, da);
        }

        else if ((*model) == "qqSpin1P" || (*model) == "!qqSpin1P") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1P(d, da);
        } else if ((*model) == "Spin1P" || (*model) == "!Spin1P") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1P(d, da);
        }

        else if ((*model) == "qqSpin1" || (*model) == "!qqSpin1") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1(d, da, params_MG);
        } else if ((*model) == "Spin1" || (*model) == "!Spin1") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1(d, da, params_MG);
        }

        // Is it a spin-2 resonance?
        else if ((*model) == "ggSpin2Pm" || (*model) == "!ggSpin2Pm") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "qqSpin2Pm" || (*model) == "!qqSpin2Pm") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "Spin2Pm" || (*model) == "!Spin2Pm") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Pm(d, da);
        }

        else if ((*model) == "ggSpin2Ph" || (*model) == "!ggSpin2Ph") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Ph(d, da);
        } else if ((*model) == "qqSpin2Ph" || (*model) == "!qqSpin2Ph") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Ph(d, da);
        } else if ((*model) == "Spin2Ph" || (*model) == "!Spin2Ph") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Ph(d, da);
        }

        else if ((*model) == "ggSpin2Mh" || (*model) == "!ggSpin2Mh") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Mh(d, da);
        } else if ((*model) == "qqSpin2Mh" || (*model) == "!qqSpin2Mh") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Mh(d, da);
        } else if ((*model) == "Spin2Mh" || (*model) == "!Spin2Mh") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Mh(d, da);
        }

        else if ((*model) == "ggSpin2Pb" || (*model) == "!ggSpin2Pb") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Pb(d, da);
        } else if ((*model) == "qqSpin2Pb" || (*model) == "!qqSpin2Pb") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Pb(d, da);
        } else if ((*model) == "Spin2Pb" || (*model) == "!Spin2Pb") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Pb(d, da);
        }

        else if ((*model) == "ggSpin2Ph2" || (*model) == "!ggSpin2Ph2") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Ph2(d, da);
        } else if ((*model) == "qqSpin2Ph2" || (*model) == "!qqSpin2Ph2") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Ph2(d, da);
        } else if ((*model) == "Spin2Ph2" || (*model) == "!Spin2Ph2") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Ph2(d, da);
        }

        else if ((*model) == "ggSpin2Ph3" || (*model) == "!ggSpin2Ph3") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Ph3(d, da);
        } else if ((*model) == "qqSpin2Ph3" || (*model) == "!qqSpin2Ph3") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Ph3(d, da);
        } else if ((*model) == "Spin2Ph3" || (*model) == "!Spin2Ph3") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Ph3(d, da);
        }

        else if ((*model) == "ggSpin2Ph6" || (*model) == "!ggSpin2Ph6") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Ph6(d, da);
        } else if ((*model) == "qqSpin2Ph6" || (*model) == "!qqSpin2Ph6") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Ph6(d, da);
        } else if ((*model) == "Spin2Ph6" || (*model) == "!Spin2Ph6") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Ph6(d, da);
        }

        else if ((*model) == "ggSpin2Ph7" || (*model) == "!ggSpin2Ph7") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Ph7(d, da);
        } else if ((*model) == "qqSpin2Ph7" || (*model) == "!qqSpin2Ph7") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Ph7(d, da);
        } else if ((*model) == "Spin2Ph7" || (*model) == "!Spin2Ph7") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Ph7(d, da);
        }

        else if ((*model) == "ggSpin2Mh9" || (*model) == "!ggSpin2Mh9") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Mh9(d, da);
        } else if ((*model) == "qqSpin2Mh9" || (*model) == "!qqSpin2Mh9") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Mh9(d, da);
        } else if ((*model) == "Spin2Mh9" || (*model) == "!Spin2Mh9") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Mh9(d, da);
        }

        else if ((*model) == "ggSpin2Mh10" || (*model) == "!ggSpin2Mh10") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Mh10(d, da);
        } else if ((*model) == "qqSpin2Mh10" || (*model) == "!qqSpin2Mh10") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Mh10(d, da);
        } else if ((*model) == "Spin2Mh10" || (*model) == "!Spin2Mh10") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Mh10(d, da);
        }

        else if ((*model) == "ggSpin2" || (*model) == "!ggSpin2") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2(d, da, params_MG);
        } else if ((*model) == "qqSpin2" || (*model) == "!qqSpin2") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2(d, da, params_MG);
        } else if ((*model) == "Spin2" || (*model) == "!Spin2") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2(d, da, params_MG);
        }
        ...
        if ((*model) == "ggSpin0Pm_2f" ||
            ...
            d.production = prod_gg;
            Run_ME_Configurator_Spin0Pm(d, da);
        } else if ((*model) == "Spin0Pm_2f" || (*model) == "!Spin0Pm_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0Pm(d, da);
        }

        else if ((*model) == "ggSpin0M_2f" || (*model) == "!ggSpin0M_2f") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin0M(d, da);
        } else if ((*model) == "Spin0M_2f" || (*model) == "!Spin0M_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0M(d, da);
        }

        else if ((*model) == "ggSpin0_2f" || (*model) == "!ggSpin0_2f") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin0(d, da, params_MG);
        } else if ((*model) == "Spin0_2f" || (*model) == "!Spin0_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin0(d, da, params_MG);
        }

        // Is it a spin-1 resonance?
        else if ((*model) == "qqSpin1M_2f" || (*model) == "!qqSpin1M_2f") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1M(d, da);
        } else if ((*model) == "Spin1M" || (*model) == "!Spin1M_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1M(d, da);
        }

        else if ((*model) == "qqSpin1P_2f" || (*model) == "!qqSpin1P_2f") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1P(d, da);
        } else if ((*model) == "Spin1P_2f" || (*model) == "!Spin1P_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1P(d, da);
        }

        else if ((*model) == "qqSpin1_2f" || (*model) == "!qqSpin1_2f") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin1(d, da, params_MG);
        } else if ((*model) == "Spin1_2f" || (*model) == "!Spin1_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin1(d, da, params_MG);
        }

        // Is it a spin-2 resonance?
        else if ((*model) == "ggSpin2Pm_2f" || (*model) == "!ggSpin2Pm_2f") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "qqSpin2Pm_2f" || (*model) == "!qqSpin2Pm_2f") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "Spin2Pm_2f" || (*model) == "!Spin2Pm_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Pm(d, da);
        }

        else if ((*model) == "ggSpin2_2f" || (*model) == "!ggSpin2_2f") {
            d.production = prod_gg;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "qqSpin2_2f" || (*model) == "!qqSpin2_2f") {
            d.production = prod_qq;
            Run_ME_Configurator_Spin2Pm(d, da);
        } else if ((*model) == "Spin2_2f" || (*model) == "!Spin2_2f") {
            d.production = prod_no;
            Run_ME_Configurator_Spin2Pm(d, da);
        }
        ...
        } else if ((*model) == "qqCPPProcess" || (*model) == "!qqCPPProcess") {
            d.production = prod_qq;
            Run_ME_Configurator_CPPProcess(d, da);
        } else if ((*model) == "CPPProcess" || (*model) == "!CPPProcess") {
            d.production = prod_no;
            Run_ME_Configurator_CPPProcess(d, da);
        }
...
int MEKD::setProcessName(const string &process)
{
    ...
    /// "Backgrounds"
    else if (process == "qqZZ" || process == "ZZ") {
        m_process = "qqZZ";
    ...
    /// Spin-0 models
    else if (process == "Higgs" || process == "SMHiggs" ||
             process == "ggSpin0Pm") {
        m_process = "ggSpin0Pm";
    } else if (process == "Spin0Pm") {
        m_process = "Spin0Pm";
    } else if (process == "CP-odd" || process == "Higgs0M" ||
               process == "ggSpin0M") {
        m_process = "ggSpin0M";
    } else if (process == "Spin0M") {
        m_process = "Spin0M";
    } else if (process == "ggSpin0PH" || process == "ggSpin0Ph") {
        m_process = "ggSpin0Ph";
...
/// B
///------------------------------------------------------------------------
int MEKD::computeKD(const string &processA, const string &processB, double &kd,
...
int MEKD::computeKD(const string &processA, const string &processB,
                    ...
                    const double lept4P[], const int lept4Id, double &kd,
                    double &me2processA, double &me2processB)
{
    vector<double *> p(4);
    vector<int> id(4);
    ...
    return computeKD(processA, processB, p, id, kd, me2processA, me2processB);
}
...
///------------------------------------------------------------------------
int MEKD::computeME(const string &processName, const vector<double *> &input_Ps,
...
int MEKD::computeKD(const TString &processA, const TString &processB,
                    ...
                    const TLorentzVector &lept4P, const int lept4Id, double &kd,
                    double &me2processA, double &me2processB)
{
    ...
    return computeKD((string)processA.Data(), (string)processB.Data(), p, id,
