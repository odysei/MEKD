						   ...
						   double mass4, double *pi4, double mass5, double *pi5)
{
	...
	p4[2] = (long double)pi4[2];
	p4[3] = (long double)pi4[3];
	p5[1] = (long double)pi5[1];
	p5[2] = (long double)pi5[2];
	p5[3] = (long double)pi5[3];
						   ...
						   double mass6, double *pi6)
{
	...
	p5[2] = (long double)pi5[2];
	p5[3] = (long double)pi5[3];
	p6[1] = (long double)pi6[1];
	p6[2] = (long double)pi6[2];
	p6[3] = (long double)pi6[3];
