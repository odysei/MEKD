											   ...
											   const int hel[])
{
	...
	//   FFV42_43_2(w[0], w[23], pars->GC_109, pars->GC_115, pars->MS,
	//   pars->ZERO,
	//       w[26]);
	//   FFV42_43_2(w[0], w[10], pars->GC_109, pars->GC_115, pars->MS,
	//   pars->ZERO,
	//       w[27]);
	//   FFV41_2(w[0], w[14], pars->GC_1, pars->MS, pars->ZERO, w[28]);
	//   FFV41_2(w[0], w[18], pars->GC_1, pars->MS, pars->ZERO, w[29]);
	//   FFV42_43_2(w[0], w[20], pars->GC_109, pars->GC_115, pars->MS,
	//   pars->ZERO,
	//       w[30]);
	//   FFV42_43_2(w[0], w[16], pars->GC_109, pars->GC_115, pars->MS,
	//   pars->ZERO,
	//       w[31]);
