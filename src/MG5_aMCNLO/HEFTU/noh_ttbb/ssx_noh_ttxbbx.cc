...
void ssx_noh_ttxbbx::initProc(string param_card_name)
{
...
void ssx_noh_ttxbbx::updateProc()
{
    ntry = 0, sum_hel = 0, ngood = 0;
    // Set external particle masses for this matrix element
    mME[0] = (pars->mdl_MS);
...
double ssx_noh_ttxbbx::sigmaHat()
{
...
void ssx_noh_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double ssx_noh_ttxbbx::matrix_1_ssx_noh_ttxbbx()
{
    int i, j;
    // Local variables
