...
void gg_noh_ttxbbx::initProc(string param_card_name)
{
...
void gg_noh_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double gg_noh_ttxbbx::matrix_1_gg_noh_ttxbbx()
{
    int i, j;
    // Local variables
