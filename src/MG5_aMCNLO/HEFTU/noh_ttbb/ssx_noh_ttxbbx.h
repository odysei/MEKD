...
#ifndef MG5_Sigma_heft_updated_full_ssx_noh_ttxbbx_H
#define MG5_Sigma_heft_updated_full_ssx_noh_ttxbbx_H
...
class ssx_noh_ttxbbx
{
  public:
    ...
    std::string name() const { return "s s~ > t t~ b b~ (heft_updated_full)"; }
  ...
  private:
    ...
    double matrix_1_ssx_noh_ttxbbx();
...
#endif // MG5_Sigma_heft_updated_full_ssx_noh_ttxbbx_H
