...
#ifndef MG5_Sigma_heft_updated_full_uux_noh_ttxbbx_H
#define MG5_Sigma_heft_updated_full_uux_noh_ttxbbx_H
...
class uux_noh_ttxbbx
{
  public:
    ...
    std::string name() const { return "u u~ > t t~ b b~ (heft_updated_full)"; }
  ...
  private:
    ...
    double matrix_1_uux_noh_ttxbbx();
...
#endif // MG5_Sigma_heft_updated_full_uux_noh_ttxbbx_H
