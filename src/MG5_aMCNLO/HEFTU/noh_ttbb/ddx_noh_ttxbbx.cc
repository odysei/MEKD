...
void ddx_noh_ttxbbx::initProc(string param_card_name)
{
...
void ddx_noh_ttxbbx::updateProc()
{
    ntry = 0, sum_hel = 0, ngood = 0;
    // Set external particle masses for this matrix element
    mME[0] = (pars->mdl_MD);
...
double ddx_noh_ttxbbx::sigmaHat()
{
...
void ddx_noh_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double ddx_noh_ttxbbx::matrix_1_ddx_noh_ttxbbx()
{
    int i, j;
    // Local variables
    ...
    jamp[2] = +1. / 2. * amp[13] + 1. / 2. * amp[21] + 1. / 2. * amp[22] -
              ...
              1. / 6. * amp[34] + 1. / 2. * amp[37] + 1. / 2. * amp[38] -
              1. / 12. * amp[39] - 1. / 12. * amp[40] + 1. / 2. * amp[41] +
              1. / 2. * amp[42];
    jamp[3] = +1. / 4. * amp[4] -
              1. / 4. * std::complex<double>(0, 1) * amp[12] -
              1. / 2. * amp[15] - 1. / 2. * amp[16] + 1. / 4. * amp[24] -
              1. / 2. * amp[33] - 1. / 2. * amp[34] + 1. / 4. * amp[40];
    jamp[4] = +1. / 4. * amp[5] +
              1. / 4. * std::complex<double>(0, 1) * amp[12] -
              1. / 2. * amp[17] - 1. / 2. * amp[18] + 1. / 4. * amp[23] -
              1. / 2. * amp[31] - 1. / 2. * amp[32] + 1. / 4. * amp[39];
    jamp[5] = +1. / 2. * amp[2] + 1. / 2. * amp[3] - 1. / 12. * amp[4] -
              1. / 12. * amp[5] + 1. / 2. * amp[6] + 1. / 2. * amp[7] +
              1. / 2. * amp[8] + 1. / 2. * amp[9] + 1. / 2. * amp[14] +
              1. / 2. * amp[35] + 1. / 2. * amp[36] - 1. / 12. * amp[39] -
              1. / 12. * amp[40] + 1. / 2. * amp[43] + 1. / 2. * amp[44];
