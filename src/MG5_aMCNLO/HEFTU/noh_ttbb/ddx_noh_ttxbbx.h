...
#ifndef MG5_Sigma_heft_updated_full_ddx_noh_ttxbbx_H
#define MG5_Sigma_heft_updated_full_ddx_noh_ttxbbx_H
...
class ddx_noh_ttxbbx
{
  ...
  private:
    ...
    double matrix_1_ddx_noh_ttxbbx();
