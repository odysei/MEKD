            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP19 = (F1[2] * F2[2] + F1[3] * F2[3] + F1[4] * F2[4] + F1[5] * F2[5]);
    vertex = COUP * -cI * TMP19 * S3[2];
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] =
        denom * -4. * cI * (OM3 * -1. / 4. * P3[0] * (TMP10 + 4. * (TMP17)) +
                            (+1. / 4. * (F1[2] * F2[4] + F1[3] * F2[5]) +
                             F1[4] * F2[2] + F1[5] * F2[3]));
    V3[3] =
        denom * -4. * cI * (OM3 * -1. / 4. * P3[1] * (TMP10 + 4. * (TMP17)) +
                            (-1. / 4. * (F1[2] * F2[5] + F1[3] * F2[4]) +
                             F1[4] * F2[3] + F1[5] * F2[2]));
    V3[4] = denom * 4. * cI *
            (OM3 * 1. / 4. * P3[2] * (TMP10 + 4. * (TMP17)) +
             (+1. / 4. * cI * (F1[2] * F2[5]) - 1. / 4. * cI * (F1[3] * F2[4]) -
              cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
    V3[5] = denom * 4. * cI *
            (OM3 * 1. / 4. * P3[3] * (TMP10 + 4. * (TMP17)) +
            ...
            double M3, double W3, complex<double> S3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    S3[2] = denom * (-cI * (TMP1 * TMP18) + cI * (TMP4 * TMP7));
}
             ...
             complex<double> &vertex)
{
    ...
    TMP14 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]);
    TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
    TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]);
    TMP12 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]);
    vertex = COUP * (-cI * (TMP6 * TMP14) + cI * (TMP1 * TMP12));
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    V3[3] =
        denom * -cI * (-F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 * TMP10);
    V3[4] = denom * -cI * (-cI * (F1[2] * F2[5]) + cI * (F1[3] * F2[4]) -
                           P3[2] * OM3 * TMP10);
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * 2. * cI * (OM3 * 1. / 2. * P3[0] * (TMP10 - 2. * (TMP17)) +
                               (-1. / 2. * (F1[2] * F2[4] + F1[3] * F2[5]) +
                                F1[4] * F2[2] + F1[5] * F2[3]));
    V3[3] = denom * 2. * cI * (OM3 * 1. / 2. * P3[1] * (TMP10 - 2. * (TMP17)) +
                               (+1. / 2. * (F1[2] * F2[5] + F1[3] * F2[4]) +
                                F1[4] * F2[3] + F1[5] * F2[2]));
    V3[4] = denom * -2. * cI *
            (OM3 * 1. / 2. * P3[2] * (+2. * (TMP17)-TMP10) +
             (-1. / 2. * cI * (F1[2] * F2[5]) + 1. / 2. * cI * (F1[3] * F2[4]) -
              cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
    V3[5] = denom * -2. * cI *
            (OM3 * 1. / 2. * P3[3] * (+2. * (TMP17)-TMP10) +
             ...
             complex<double> &vertex)
{
    ...
    TMP11 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]);
    TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]);
    vertex = COUP * (-cI * (TMP6 * TMP14) + cI * (TMP3 * TMP11));
}
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]);
    TMP18 = (P1[0] * P2[0] - P1[1] * P2[1] - P1[2] * P2[2] - P1[3] * P2[3]);
    vertex = COUP * S3[2] * (-cI * (TMP4 * TMP7) + cI * (TMP1 * TMP18));
}
             ...
             complex<double> &vertex)
{
    ...
    TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]);
    TMP2 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]);
    vertex = COUP * S4[2] * (TMP1 * (-cI * (TMP0) + cI * (TMP2)) +
                             (TMP3 * (-cI * (TMP5) + cI * (TMP4)) +
                              TMP6 * (-cI * (TMP7) + cI * (TMP8))));
}
              ...
              double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] = denom * S3[2] * (-cI * (P2[0] * TMP4) + cI * (V2[2] * TMP18));
    V1[3] = denom * S3[2] * (-cI * (P2[1] * TMP4) + cI * (V2[3] * TMP18));
    V1[4] = denom * S3[2] * (-cI * (P2[2] * TMP4) + cI * (V2[4] * TMP18));
    V1[5] = denom * S3[2] * (-cI * (P2[3] * TMP4) + cI * (V2[5] * TMP18));
}
              ...
              double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] = denom * (TMP6 * (-cI * (P2[0]) + cI * (P3[0])) +
                     (V2[2] * (-cI * (TMP0) + cI * (TMP2)) +
                      V3[2] * (-cI * (TMP5) + cI * (TMP4))));
    V1[3] = denom * (TMP6 * (-cI * (P2[1]) + cI * (P3[1])) +
                     (V2[3] * (-cI * (TMP0) + cI * (TMP2)) +
                      V3[3] * (-cI * (TMP5) + cI * (TMP4))));
    V1[4] = denom * (TMP6 * (-cI * (P2[2]) + cI * (P3[2])) +
                     (V2[4] * (-cI * (TMP0) + cI * (TMP2)) +
                      V3[4] * (-cI * (TMP5) + cI * (TMP4))));
    V1[5] = denom * (TMP6 * (-cI * (P2[3]) + cI * (P3[3])) +
                     (V2[5] * (-cI * (TMP0) + cI * (TMP2)) +
                      V3[5] * (-cI * (TMP5) + cI * (TMP4))));
}

} // end namespace $(namespace)s_heft_updated_full
