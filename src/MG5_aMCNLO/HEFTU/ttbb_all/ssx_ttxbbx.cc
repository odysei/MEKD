...
// Process: s s~ > t t~ b b~ HIW=1 QED=2 HIG=1 @1
...
//   int i, j; 
  ...
  FFV2_5_2(w[3], w[16], pars->GC_41, pars->GC_53, pars->mdl_MT, pars->mdl_WT,
      w[30]);
  FFV2_3(w[0], w[2], pars->GC_38, pars->mdl_MW, pars->mdl_WW, w[31]); 
  FFV2_1(w[1], w[31], pars->GC_98, pars->mdl_MT, pars->mdl_WT, w[32]); 
  FFV2_2(w[3], w[31], pars->GC_98, pars->mdl_MS, pars->ZERO, w[33]); 
  FFV2_3(w[3], w[1], pars->GC_98, pars->mdl_MW, pars->mdl_WW, w[34]); 
  FFV2_2(w[0], w[34], pars->GC_38, pars->mdl_MT, pars->mdl_WT, w[35]); 
  FFV1_2(w[0], w[19], pars->GC_11, pars->mdl_MS, pars->ZERO, w[36]); 
  FFV1_2(w[0], w[11], pars->GC_2, pars->mdl_MS, pars->ZERO, w[37]); 
  FFV1_2(w[0], w[7], pars->GC_11, pars->mdl_MS, pars->ZERO, w[38]); 
  FFV1_2(w[0], w[27], pars->GC_2, pars->mdl_MS, pars->ZERO, w[39]); 
  FFV2_3_2(w[0], w[28], pars->GC_40, pars->GC_53, pars->mdl_MS, pars->ZERO,
      w[40]);
  FFV2_3_2(w[0], w[15], pars->GC_40, pars->GC_53, pars->mdl_MS, pars->ZERO,
      w[41]);
  ...
  FFV2_0(w[36], w[2], w[34], pars->GC_38, amp[34]); 
