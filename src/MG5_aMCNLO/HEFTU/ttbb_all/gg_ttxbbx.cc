...
//   const int ngraphs = 163; 
  ...
  jamp[0] = -std::complex<double> (0, 1) * amp[12] - std::complex<double> (0,
      1) * amp[20] - std::complex<double> (0, 1) * amp[21] + 1./6. *
      std::complex<double> (0, 1) * amp[22] + 1./6. * std::complex<double> (0,
      1) * amp[23] - std::complex<double> (0, 1) * amp[24] -
      std::complex<double> (0, 1) * amp[25] - std::complex<double> (0, 1) *
      amp[26] - std::complex<double> (0, 1) * amp[27] + amp[29] - 1./6. *
      amp[30] + amp[31] + amp[32] + amp[44] - 1./6. * amp[45] + amp[48] +
      amp[49] + amp[50] + amp[129] - 1./6. * amp[130] + amp[133] + amp[134] +
      amp[135] - std::complex<double> (0, 1) * amp[157] + std::complex<double>
      (0, 1) * amp[158] - std::complex<double> (0, 1) * amp[159];
  jamp[1] = -1./2. * std::complex<double> (0, 1) * amp[5] + 1./2. * amp[11] +
      std::complex<double> (0, 1) * amp[16] + std::complex<double> (0, 1) *
      amp[17] - 1./2. * std::complex<double> (0, 1) * amp[22] + 1./2. * amp[39]
      - amp[42] - amp[43] + 1./2. * amp[45] - 1./2. * std::complex<double> (0,
      1) * amp[46] + 1./2. * amp[145] + 1./2. * std::complex<double> (0, 1) *
      amp[147] - amp[151] + 1./2. * amp[152] + 1./2. * amp[153] + 1./2. *
      amp[155];
  jamp[2] = -1./2. * std::complex<double> (0, 1) * amp[4] - 1./2. * amp[11] +
      std::complex<double> (0, 1) * amp[14] + std::complex<double> (0, 1) *
      amp[15] - 1./2. * std::complex<double> (0, 1) * amp[23] + 1./2. * amp[80]
      - amp[83] + 1./2. * amp[90] - 1./2. * std::complex<double> (0, 1) *
      amp[91] - amp[96] - amp[128] + 1./2. * amp[130] + 1./2. *
      std::complex<double> (0, 1) * amp[132] - 1./2. * amp[152] + 1./2. *
      amp[154] + 1./2. * amp[156];
  jamp[3] = -std::complex<double> (0, 1) * amp[2] - std::complex<double> (0, 1)
      * amp[3] + 1./6. * std::complex<double> (0, 1) * amp[4] + 1./6. *
      ...
      (0, 1) * amp[13] + amp[85] - 1./6. * amp[86] + amp[87] + amp[88] +
      amp[89] - 1./6. * amp[90] + amp[93] + amp[94] + amp[95] + amp[144] -
      1./6. * amp[145] + amp[148] + amp[149] + amp[150] - std::complex<double>
      (0, 1) * amp[160] - std::complex<double> (0, 1) * amp[161] +
      std::complex<double> (0, 1) * amp[162];
  jamp[4] = +amp[33] - 1./6. * amp[34] + amp[35] + amp[36] + amp[38] - 1./6. *
      amp[39] + amp[40] + amp[41] + amp[47] + amp[56] - 1./6. * amp[57] +
      amp[58] + amp[59] + amp[61] - 1./6. * amp[62] + amp[63] + amp[64] +
      amp[70] + amp[138] + amp[146];
  jamp[5] = -amp[28] + 1./2. * amp[30] + 1./2. * amp[34] - amp[37] + 1./2. *
      std::complex<double> (0, 1) * amp[46] - amp[102] + 1./2. * amp[104] -
      amp[107] + 1./2. * amp[109] - 1./2. * std::complex<double> (0, 1) *
      amp[114] - 1./2. * std::complex<double> (0, 1) * amp[132] + 1./2. *
      std::complex<double> (0, 1) * amp[139] - 1./2. * amp[153] - 1./2. *
      amp[154] - 1./2. * amp[155] - 1./2. * amp[156];
  jamp[6] = -amp[51] + 1./2. * amp[53] + 1./2. * amp[62] - amp[65] - 1./2. *
      std::complex<double> (0, 1) * amp[69] - amp[74] + 1./2. * amp[76] -
      amp[84] + 1./2. * amp[86] + 1./2. * std::complex<double> (0, 1) * amp[91]
      + 1./2. * std::complex<double> (0, 1) * amp[124] - 1./2. *
      std::complex<double> (0, 1) * amp[147] - 1./2. * amp[153] - 1./2. *
      amp[154] - 1./2. * amp[155] - 1./2. * amp[156];
  jamp[7] = +amp[75] - 1./6. * amp[76] + amp[77] + amp[78] + amp[79] - 1./6. *
      amp[80] + amp[81] + amp[82] + amp[92] + amp[97] - 1./6. * amp[98] +
      amp[99] + amp[100] + amp[103] - 1./6. * amp[104] + amp[105] + amp[106] +
      amp[115] + amp[123] + amp[131];
  jamp[8] = +std::complex<double> (0, 1) * amp[12] + std::complex<double> (0,
      1) * amp[20] + std::complex<double> (0, 1) * amp[21] - 1./6. *
      std::complex<double> (0, 1) * amp[22] - 1./6. * std::complex<double> (0,
      1) * amp[23] + std::complex<double> (0, 1) * amp[24] +
      std::complex<double> (0, 1) * amp[25] + std::complex<double> (0, 1) *
      amp[26] + std::complex<double> (0, 1) * amp[27] + amp[52] - 1./6. *
      amp[53] + amp[54] + amp[55] + amp[67] - 1./6. * amp[68] + amp[71] +
      amp[72] + amp[73] + amp[121] - 1./6. * amp[122] + amp[125] + amp[126] +
      amp[127] + std::complex<double> (0, 1) * amp[157] - std::complex<double>
      (0, 1) * amp[158] + std::complex<double> (0, 1) * amp[159];
  jamp[9] = +1./2. * std::complex<double> (0, 1) * amp[5] - 1./2. * amp[11] -
      std::complex<double> (0, 1) * amp[16] - std::complex<double> (0, 1) *
      amp[17] + 1./2. * std::complex<double> (0, 1) * amp[22] + 1./2. * amp[98]
      - amp[101] + 1./2. * amp[113] + 1./2. * std::complex<double> (0, 1) *
      amp[114] - amp[119] - amp[120] + 1./2. * amp[122] - 1./2. *
      std::complex<double> (0, 1) * amp[124] - 1./2. * amp[152] + 1./2. *
      amp[154] + 1./2. * amp[156];
  jamp[10] = +1./2. * std::complex<double> (0, 1) * amp[4] + 1./2. * amp[11] -
      std::complex<double> (0, 1) * amp[14] - std::complex<double> (0, 1) *
      amp[15] + 1./2. * std::complex<double> (0, 1) * amp[23] + 1./2. * amp[57]
      - amp[60] - amp[66] + 1./2. * amp[68] + 1./2. * std::complex<double> (0,
      1) * amp[69] + 1./2. * amp[137] - 1./2. * std::complex<double> (0, 1) *
      amp[139] - amp[143] + 1./2. * amp[152] + 1./2. * amp[153] + 1./2. *
      amp[155];
  jamp[11] = +std::complex<double> (0, 1) * amp[2] + std::complex<double> (0,
      1) * amp[3] - 1./6. * std::complex<double> (0, 1) * amp[4] - 1./6. *
      std::complex<double> (0, 1) * amp[5] + std::complex<double> (0, 1) *
      amp[6] + std::complex<double> (0, 1) * amp[7] + std::complex<double> (0,
      1) * amp[8] + std::complex<double> (0, 1) * amp[9] + std::complex<double>
      (0, 1) * amp[13] + amp[108] - 1./6. * amp[109] + amp[110] + amp[111] +
      amp[112] - 1./6. * amp[113] + amp[116] + amp[117] + amp[118] + amp[136] -
      1./6. * amp[137] + amp[140] + amp[141] + amp[142] + std::complex<double>
      (0, 1) * amp[160] + std::complex<double> (0, 1) * amp[161] -
      std::complex<double> (0, 1) * amp[162];
  jamp[12] = -1./3. * amp[0] - 1./3. * amp[1] + 2. * amp[10] - 1./3. * amp[18]
      - 1./3. * amp[19];
