...
#ifndef MG5_Sigma_heft_updated_full_ccx_ttxbbx_H
#define MG5_Sigma_heft_updated_full_ccx_ttxbbx_H
...
class ccx_ttxbbx
{
  public:
    ...
    virtual string name() const {return "c c~ > t t~ b b~ (heft_updated_full)";}
...
#endif  // MG5_Sigma_heft_updated_full_ccx_ttxbbx_H
