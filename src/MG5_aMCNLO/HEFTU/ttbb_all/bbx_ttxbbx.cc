...
//   int i, j; 
  ...
  FFV2_3_3(w[0], w[1], pars->GC_40, pars->GC_53, pars->mdl_MZ, pars->mdl_WZ,
      w[19]);
  FFV2_3_1(w[4], w[19], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[20]);
  FFV2_3_2(w[5], w[19], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[21]);
  ...
  FFV2_5_1(w[2], w[19], pars->GC_41, pars->GC_53, pars->mdl_MT, pars->mdl_WT,
      w[34]);
  FFV2_5_2(w[3], w[19], pars->GC_41, pars->GC_53, pars->mdl_MT, pars->mdl_WT,
      w[35]);
  ...
  FFV2_3_3(w[5], w[1], pars->GC_40, pars->GC_53, pars->mdl_MZ, pars->mdl_WZ,
      w[51]);
  ...
  FFV2_3_3(w[0], w[4], pars->GC_40, pars->GC_53, pars->mdl_MZ, pars->mdl_WZ,
      w[55]);
  FFV2_5_1(w[2], w[55], pars->GC_41, pars->GC_53, pars->mdl_MT, pars->mdl_WT,
      w[56]);
  FFV2_5_2(w[3], w[55], pars->GC_41, pars->GC_53, pars->mdl_MT, pars->mdl_WT,
      w[57]);
  ...
  FFV2_3_1(w[1], w[55], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[63]);
  FFV2_3_2(w[5], w[55], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[64]);
  ...
  FFV2_3_2(w[0], w[15], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[72]);
  FFS2_2(w[0], w[50], pars->GC_74, pars->mdl_MB, pars->ZERO, w[73]); 
  FFV2_3_2(w[0], w[51], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[74]);
  ...
  FFV2_3_2(w[0], w[31], pars->GC_40, pars->GC_53, pars->mdl_MB, pars->ZERO,
      w[78]);
...
//   const int ngraphs = 108; 
  ...
  jamp[0] = -1./6. * amp[0] - 1./6. * amp[1] - 1./6. * amp[2] - 1./6. * amp[3]
      + 1./36. * amp[4] + 1./36. * amp[5] - 1./6. * amp[6] - 1./6. * amp[7] -
      1./6. * amp[8] - 1./6. * amp[9] - 1./6. * amp[10] - 1./6. * amp[11] -
      1./6. * amp[12] - 1./6. * amp[13] - 1./6. * amp[15] - 1./6. * amp[16] -
      1./6. * amp[17] - 1./6. * amp[22] - 1./6. * amp[23] - 1./6. * amp[24] -
      1./6. * amp[25] + 1./36. * amp[26] + 1./36. * amp[27] - 1./6. * amp[28] -
      1./6. * amp[29] - 1./6. * amp[30] - 1./6. * amp[31] - 1./6. * amp[32] -
      1./6. * amp[33] - 1./6. * amp[34] - 1./6. * amp[35] - 1./2. * amp[57] -
      1./2. * amp[62] - 1./2. * amp[63] + 1./12. * amp[64] + 1./12. * amp[65] -
      1./2. * amp[66] - 1./2. * amp[67] - 1./2. * amp[68] - 1./2. * amp[69] -
      1./2. * amp[80] - 1./2. * amp[81] + 1./12. * amp[82] + 1./12. * amp[83] -
      1./2. * amp[84] - 1./2. * amp[85] - 1./2. * amp[86] - 1./2. * amp[87] -
      1./6. * amp[94] - 1./6. * amp[95] - 1./6. * amp[96] - 1./6. * amp[97] +
      1./36. * amp[98] + 1./36. * amp[99] - 1./6. * amp[100] - 1./6. * amp[101]
      - 1./6. * amp[102] - 1./6. * amp[103] - 1./6. * amp[104] - 1./6. *
      amp[105] - 1./6. * amp[106] - 1./6. * amp[107];
  jamp[1] = +1./2. * amp[0] + 1./2. * amp[1] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[10] + 1./2. * amp[11] + 1./2. * amp[12] + 1./2. *
      amp[13] + 1./2. * amp[17] + 1./6. * amp[18] + 1./6. * amp[19] + 1./6. *
      amp[20] + 1./6. * amp[21] + 1./2. * amp[22] + 1./2. * amp[23] - 1./12. *
      amp[26] - 1./12. * amp[27] + 1./2. * amp[32] + 1./2. * amp[33] + 1./2. *
      amp[34] + 1./2. * amp[35] - 1./4. * amp[47] - 1./4. *
      std::complex<double> (0, 1) * amp[56] - 1./4. * amp[64] + 1./2. * amp[74]
      + 1./2. * amp[75] - 1./4. * amp[82] + 1./2. * amp[92] + 1./2. * amp[93];
  jamp[2] = +1./2. * amp[15] + 1./2. * amp[24] + 1./2. * amp[25] - 1./12. *
      amp[26] - 1./12. * amp[27] + 1./2. * amp[28] + 1./2. * amp[29] + 1./2. *
      amp[30] + 1./2. * amp[31] + 1./2. * amp[36] + 1./2. * amp[37] + 1./6. *
      amp[38] + 1./6. * amp[39] + 1./2. * amp[40] + 1./2. * amp[41] - 1./4. *
      amp[46] + 1./4. * std::complex<double> (0, 1) * amp[56] - 1./4. * amp[65]
      + 1./6. * amp[76] + 1./6. * amp[77] - 1./4. * amp[83] + 1./2. * amp[96] +
      1./2. * amp[97] - 1./12. * amp[98] - 1./12. * amp[99] + 1./2. * amp[100]
      + 1./2. * amp[101] + 1./2. * amp[102] + 1./2. * amp[103];
  jamp[3] = +1./4. * amp[4] - 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[18] - 1./2. * amp[19] + 1./4. * amp[27] - 1./6. * amp[40] -
      1./6. * amp[41] - 1./2. * amp[42] - 1./2. * amp[43] + 1./12. * amp[46] +
      1./12. * amp[47] - 1./2. * amp[52] - 1./2. * amp[53] - 1./2. * amp[54] -
      1./2. * amp[55] - 1./2. * amp[59] - 1./2. * amp[60] - 1./2. * amp[61] +
      1./12. * amp[64] + 1./12. * amp[65] - 1./2. * amp[70] - 1./2. * amp[71] -
      1./2. * amp[72] - 1./2. * amp[73] - 1./6. * amp[74] - 1./6. * amp[75] -
      1./2. * amp[76] - 1./2. * amp[77] + 1./4. * amp[99];
  jamp[4] = +1./4. * amp[5] + 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[20] - 1./2. * amp[21] + 1./4. * amp[26] - 1./6. * amp[36] -
      1./6. * amp[37] - 1./2. * amp[38] - 1./2. * amp[39] - 1./2. * amp[44] -
      1./2. * amp[45] + 1./12. * amp[46] + 1./12. * amp[47] - 1./2. * amp[48] -
      1./2. * amp[49] - 1./2. * amp[50] - 1./2. * amp[51] - 1./2. * amp[58] -
      1./2. * amp[78] - 1./2. * amp[79] + 1./12. * amp[82] + 1./12. * amp[83] -
      1./2. * amp[88] - 1./2. * amp[89] - 1./2. * amp[90] - 1./2. * amp[91] -
      1./6. * amp[92] - 1./6. * amp[93] + 1./4. * amp[98];
  jamp[5] = +1./2. * amp[2] + 1./2. * amp[3] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[6] + 1./2. * amp[7] + 1./2. * amp[8] + 1./2. *
      amp[9] + 1./2. * amp[16] + 1./6. * amp[42] + 1./6. * amp[43] + 1./6. *
      amp[44] + 1./6. * amp[45] - 1./36. * amp[46] - 1./36. * amp[47] + 1./6. *
      amp[48] + 1./6. * amp[49] + 1./6. * amp[50] + 1./6. * amp[51] + 1./6. *
      amp[52] + 1./6. * amp[53] + 1./6. * amp[54] + 1./6. * amp[55] + 1./6. *
      amp[57] + 1./6. * amp[58] + 1./6. * amp[59] + 1./6. * amp[60] + 1./6. *
      amp[61] + 1./6. * amp[62] + 1./6. * amp[63] - 1./36. * amp[64] - 1./36. *
      amp[65] + 1./6. * amp[66] + 1./6. * amp[67] + 1./6. * amp[68] + 1./6. *
      amp[69] + 1./6. * amp[70] + 1./6. * amp[71] + 1./6. * amp[72] + 1./6. *
      amp[73] + 1./6. * amp[78] + 1./6. * amp[79] + 1./6. * amp[80] + 1./6. *
      amp[81] - 1./36. * amp[82] - 1./36. * amp[83] + 1./6. * amp[84] + 1./6. *
      amp[85] + 1./6. * amp[86] + 1./6. * amp[87] + 1./6. * amp[88] + 1./6. *
      amp[89] + 1./6. * amp[90] + 1./6. * amp[91] + 1./2. * amp[94] + 1./2. *
      amp[95] - 1./12. * amp[98] - 1./12. * amp[99] + 1./2. * amp[104] + 1./2.
      * amp[105] + 1./2. * amp[106] + 1./2. * amp[107];
