...
#ifndef MG5_Sigma_heft_updated_full_uux_ttxbbx_H
#define MG5_Sigma_heft_updated_full_uux_ttxbbx_H
...
class uux_ttxbbx
{
  public:
    ...
    virtual string name() const {return "u u~ > t t~ b b~ (heft_updated_full)";}
...
#endif  // MG5_Sigma_heft_updated_full_uux_ttxbbx_H
