...
//   const int ngraphs = 45; 
  ...
  jamp[2] = +1./2. * amp[13] + 1./2. * amp[21] + 1./2. * amp[22] - 1./12. *
      ...
      amp[27] + 1./2. * amp[28] + 1./2. * amp[37] + 1./2. * amp[38] - 1./12. *
      amp[39] - 1./12. * amp[40] + 1./2. * amp[41] + 1./2. * amp[42];
  jamp[3] = +1./4. * amp[4] - 1./4. * std::complex<double> (0, 1) * amp[12] -
      1./2. * amp[15] - 1./2. * amp[16] + 1./4. * amp[24] - 1./2. * amp[31] -
      1./2. * amp[32] + 1./4. * amp[40];
  jamp[4] = +1./4. * amp[5] + 1./4. * std::complex<double> (0, 1) * amp[12] -
      1./2. * amp[17] - 1./2. * amp[18] + 1./4. * amp[23] - 1./2. * amp[33] -
      1./2. * amp[34] + 1./4. * amp[39];
  jamp[5] = +1./2. * amp[2] + 1./2. * amp[3] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[6] + 1./2. * amp[7] + 1./2. * amp[8] + 1./2. *
      amp[9] + 1./2. * amp[14] + 1./6. * amp[31] + 1./6. * amp[32] + 1./6. *
      amp[33] + 1./6. * amp[34] + 1./2. * amp[35] + 1./2. * amp[36] - 1./12. *
