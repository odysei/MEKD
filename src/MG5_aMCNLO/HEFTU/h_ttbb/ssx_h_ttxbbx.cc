...
void ssx_h_ttxbbx::initProc(string param_card_name)
{
...
void ssx_h_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double ssx_h_ttxbbx::matrix_1_ssx_h_ttxbbx()
{
    int i, j;
    // Local variables
