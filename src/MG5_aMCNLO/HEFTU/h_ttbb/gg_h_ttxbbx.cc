...
void gg_h_ttxbbx::initProc(string param_card_name)
{
...
void gg_h_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    //     FFV2_5_3(w[3], w[26], pars->GC_41, pars->GC_53, pars->mdl_MZ,
    //     pars->mdl_WZ,
    //              w[33]);
    ...
    //     FFV2_5_3(w[36], w[2], pars->GC_41, pars->GC_53, pars->mdl_MZ,
    //     pars->mdl_WZ,
    //              w[42]);
    ...
    //     FFV2_3_3(w[5], w[44], pars->GC_40, pars->GC_53, pars->mdl_MZ,
    //     pars->mdl_WZ,
    //              w[49]);
    ...
    //     FFV2_3_3(w[51], w[4], pars->GC_40, pars->GC_53, pars->mdl_MZ,
    //     pars->mdl_WZ,
    //              w[55]);
...
double gg_h_ttxbbx::matrix_1_gg_h_ttxbbx()
{
    int i, j;
    // Local variables
