...
void ddx_h_ttxbbx::initProc(string param_card_name)
{
...
void ddx_h_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double ddx_h_ttxbbx::matrix_1_ddx_h_ttxbbx()
{
    int i, j;
    // Local variables
