    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[3] = denom * - 4. * cI * (OM3 * - 1./4. * P3[1] * (TMP2 + 4. * (TMP17)) +
      ...
      F2[2]));
  V3[4] = denom * 4. * cI * (OM3 * 1./4. * P3[2] * (TMP2 + 4. * (TMP17)) +
      (+1./4. * cI * (F1[2] * F2[5]) - 1./4. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * 4. * cI * (OM3 * 1./4. * P3[3] * (TMP2 + 4. * (TMP17)) +
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * (TMP12 * (-cI * (TMP11) + cI * (TMP13)) + (TMP4 * (-cI *
      (TMP10) + cI * (TMP9)) + TMP6 * (-cI * (TMP7) + cI * (TMP8))));
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[3] = denom * 2. * cI * (OM3 * 1./2. * P3[1] * (TMP2 - 2. * (TMP17)) +
      ...
      F2[2]));
  V3[4] = denom * - 2. * cI * (OM3 * 1./2. * P3[2] * (+2. * (TMP17) - TMP2) +
      (-1./2. * cI * (F1[2] * F2[5]) + 1./2. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * - 2. * cI * (OM3 * 1./2. * P3[3] * (+2. * (TMP17) - TMP2) +
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (TMP12 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP7) + cI * (TMP8)) + V3[2] * (-cI * (TMP10) + cI * (TMP9))));
  V1[3] = denom * (TMP12 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP7) + cI * (TMP8)) + V3[3] * (-cI * (TMP10) + cI * (TMP9))));
  V1[4] = denom * (TMP12 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP7) + cI * (TMP8)) + V3[4] * (-cI * (TMP10) + cI * (TMP9))));
  V1[5] = denom * (TMP12 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP7) + cI * (TMP8)) + V3[5] * (-cI * (TMP10) + cI * (TMP9))));
}
