...
class SLHAReader
{
  public:
    ...
    double get_block_entry(string block_name, vector<int> indices,
                           double def_val = 0);
    double get_block_entry(string block_name, int index, double def_val = 0);
    void set_block_entry(string block_name, vector<int> indices, double value);
    void set_block_entry(string block_name, int index, double value);
