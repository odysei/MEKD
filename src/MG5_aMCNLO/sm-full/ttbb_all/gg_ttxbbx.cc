...
//   const int ngraphs = 134; 
  ...
  jamp[0] = -std::complex<double> (0, 1) * amp[13] - std::complex<double> (0,
      1) * amp[14] + 1./6. * std::complex<double> (0, 1) * amp[15] + 1./6. *
      std::complex<double> (0, 1) * amp[16] - std::complex<double> (0, 1) *
      amp[17] - std::complex<double> (0, 1) * amp[18] - std::complex<double>
      (0, 1) * amp[19] - std::complex<double> (0, 1) * amp[20] + amp[22] -
      1./6. * amp[23] + amp[24] + amp[25] + amp[37] - 1./6. * amp[38] + amp[40]
      + amp[41] + amp[112] - 1./6. * amp[113] + amp[115] + amp[116];
  jamp[1] = -1./2. * std::complex<double> (0, 1) * amp[3] + 1./2. * amp[8] +
      std::complex<double> (0, 1) * amp[11] + std::complex<double> (0, 1) *
      amp[12] - 1./2. * std::complex<double> (0, 1) * amp[15] + 1./2. * amp[32]
      - amp[35] - amp[36] + 1./2. * amp[38] - 1./2. * std::complex<double> (0,
      1) * amp[39] + 1./2. * amp[124] + 1./2. * std::complex<double> (0, 1) *
      amp[125] - amp[128] + 1./2. * amp[129] + 1./2. * amp[130] + 1./2. *
      amp[132];
  jamp[2] = -1./2. * std::complex<double> (0, 1) * amp[2] - 1./2. * amp[8] +
      std::complex<double> (0, 1) * amp[9] + std::complex<double> (0, 1) *
      amp[10] - 1./2. * std::complex<double> (0, 1) * amp[16] + 1./2. * amp[69]
      - amp[72] + 1./2. * amp[79] - 1./2. * std::complex<double> (0, 1) *
      amp[80] - amp[83] - amp[111] + 1./2. * amp[113] + 1./2. *
      std::complex<double> (0, 1) * amp[114] - 1./2. * amp[129] + 1./2. *
      amp[131] + 1./2. * amp[133];
  jamp[3] = -std::complex<double> (0, 1) * amp[0] - std::complex<double> (0, 1)
      * amp[1] + 1./6. * std::complex<double> (0, 1) * amp[2] + 1./6. *
      ...
      1) * amp[6] - std::complex<double> (0, 1) * amp[7] + amp[74] - 1./6. *
      amp[75] + amp[76] + amp[77] + amp[78] - 1./6. * amp[79] + amp[81] +
      amp[82] + amp[123] - 1./6. * amp[124] + amp[126] + amp[127];
  jamp[4] = +amp[26] - 1./6. * amp[27] + amp[28] + amp[29] + amp[31] - 1./6. *
      amp[32] + amp[33] + amp[34] + amp[47] - 1./6. * amp[48] + amp[49] +
      amp[50] + amp[52] - 1./6. * amp[53] + amp[54] + amp[55];
  jamp[5] = -amp[21] + 1./2. * amp[23] + 1./2. * amp[27] - amp[30] + 1./2. *
      std::complex<double> (0, 1) * amp[39] - amp[89] + 1./2. * amp[91] -
      amp[94] + 1./2. * amp[96] - 1./2. * std::complex<double> (0, 1) *
      amp[101] - 1./2. * std::complex<double> (0, 1) * amp[114] + 1./2. *
      std::complex<double> (0, 1) * amp[119] - 1./2. * amp[130] - 1./2. *
      amp[131] - 1./2. * amp[132] - 1./2. * amp[133];
  jamp[6] = -amp[42] + 1./2. * amp[44] + 1./2. * amp[53] - amp[56] - 1./2. *
      std::complex<double> (0, 1) * amp[60] - amp[63] + 1./2. * amp[65] -
      amp[73] + 1./2. * amp[75] + 1./2. * std::complex<double> (0, 1) * amp[80]
      + 1./2. * std::complex<double> (0, 1) * amp[108] - 1./2. *
      std::complex<double> (0, 1) * amp[125] - 1./2. * amp[130] - 1./2. *
      amp[131] - 1./2. * amp[132] - 1./2. * amp[133];
  jamp[7] = +amp[64] - 1./6. * amp[65] + amp[66] + amp[67] + amp[68] - 1./6. *
      amp[69] + amp[70] + amp[71] + amp[84] - 1./6. * amp[85] + amp[86] +
      amp[87] + amp[90] - 1./6. * amp[91] + amp[92] + amp[93];
  jamp[8] = +std::complex<double> (0, 1) * amp[13] + std::complex<double> (0,
      1) * amp[14] - 1./6. * std::complex<double> (0, 1) * amp[15] - 1./6. *
      std::complex<double> (0, 1) * amp[16] + std::complex<double> (0, 1) *
      amp[17] + std::complex<double> (0, 1) * amp[18] + std::complex<double>
      (0, 1) * amp[19] + std::complex<double> (0, 1) * amp[20] + amp[43] -
      1./6. * amp[44] + amp[45] + amp[46] + amp[58] - 1./6. * amp[59] + amp[61]
      + amp[62] + amp[106] - 1./6. * amp[107] + amp[109] + amp[110];
  jamp[9] = +1./2. * std::complex<double> (0, 1) * amp[3] - 1./2. * amp[8] -
      std::complex<double> (0, 1) * amp[11] - std::complex<double> (0, 1) *
      amp[12] + 1./2. * std::complex<double> (0, 1) * amp[15] + 1./2. * amp[85]
      - amp[88] + 1./2. * amp[100] + 1./2. * std::complex<double> (0, 1) *
      amp[101] - amp[104] - amp[105] + 1./2. * amp[107] - 1./2. *
      std::complex<double> (0, 1) * amp[108] - 1./2. * amp[129] + 1./2. *
      amp[131] + 1./2. * amp[133];
  jamp[10] = +1./2. * std::complex<double> (0, 1) * amp[2] + 1./2. * amp[8] -
      std::complex<double> (0, 1) * amp[9] - std::complex<double> (0, 1) *
      amp[10] + 1./2. * std::complex<double> (0, 1) * amp[16] + 1./2. * amp[48]
      - amp[51] - amp[57] + 1./2. * amp[59] + 1./2. * std::complex<double> (0,
      1) * amp[60] + 1./2. * amp[118] - 1./2. * std::complex<double> (0, 1) *
      amp[119] - amp[122] + 1./2. * amp[129] + 1./2. * amp[130] + 1./2. *
      amp[132];
  jamp[11] = +std::complex<double> (0, 1) * amp[0] + std::complex<double> (0,
      1) * amp[1] - 1./6. * std::complex<double> (0, 1) * amp[2] - 1./6. *
      std::complex<double> (0, 1) * amp[3] + std::complex<double> (0, 1) *
      amp[4] + std::complex<double> (0, 1) * amp[5] + std::complex<double> (0,
      1) * amp[6] + std::complex<double> (0, 1) * amp[7] + amp[95] - 1./6. *
      amp[96] + amp[97] + amp[98] + amp[99] - 1./6. * amp[100] + amp[102] +
      amp[103] + amp[117] - 1./6. * amp[118] + amp[120] + amp[121];
