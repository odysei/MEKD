...
//   const int ngraphs = 102; 
  ...
  jamp[0] = -1./6. * amp[0] - 1./6. * amp[1] - 1./6. * amp[2] - 1./6. * amp[3]
      ...
      1./6. * amp[12] - 1./6. * amp[13] - 1./6. * amp[19] - 1./6. * amp[20] -
      ...
      1./2. * amp[56] - 1./2. * amp[57] + 1./12. * amp[58] + 1./12. * amp[59] -
      1./2. * amp[60] - 1./2. * amp[61] - 1./2. * amp[62] - 1./2. * amp[63] -
      1./2. * amp[74] - 1./2. * amp[75] + 1./12. * amp[76] + 1./12. * amp[77] -
      1./2. * amp[78] - 1./2. * amp[79] - 1./2. * amp[80] - 1./2. * amp[81] -
      1./6. * amp[88] - 1./6. * amp[89] - 1./6. * amp[90] - 1./6. * amp[91] +
      1./36. * amp[92] + 1./36. * amp[93] - 1./6. * amp[94] - 1./6. * amp[95] -
      1./6. * amp[96] - 1./6. * amp[97] - 1./6. * amp[98] - 1./6. * amp[99] -
      1./6. * amp[100] - 1./6. * amp[101];
  jamp[1] = +1./2. * amp[0] + 1./2. * amp[1] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[10] + 1./2. * amp[11] + 1./2. * amp[12] + 1./2. *
      amp[13] + 1./6. * amp[15] + 1./6. * amp[16] + 1./6. * amp[17] + 1./6. *
      amp[18] + 1./2. * amp[19] + 1./2. * amp[20] - 1./12. * amp[23] - 1./12. *
      amp[24] + 1./2. * amp[29] + 1./2. * amp[30] + 1./2. * amp[31] + 1./2. *
      amp[32] - 1./4. * amp[44] - 1./4. * std::complex<double> (0, 1) * amp[53]
      - 1./4. * amp[58] + 1./2. * amp[68] + 1./2. * amp[69] - 1./4. * amp[76] +
      1./2. * amp[86] + 1./2. * amp[87];
  jamp[2] = +1./2. * amp[21] + 1./2. * amp[22] - 1./12. * amp[23] - 1./12. *
      amp[24] + 1./2. * amp[25] + 1./2. * amp[26] + 1./2. * amp[27] + 1./2. *
      amp[28] + 1./2. * amp[33] + 1./2. * amp[34] + 1./6. * amp[35] + 1./6. *
      amp[36] + 1./2. * amp[37] + 1./2. * amp[38] - 1./4. * amp[43] + 1./4. *
      std::complex<double> (0, 1) * amp[53] - 1./4. * amp[59] + 1./6. * amp[70]
      + 1./6. * amp[71] - 1./4. * amp[77] + 1./2. * amp[90] + 1./2. * amp[91] -
      1./12. * amp[92] - 1./12. * amp[93] + 1./2. * amp[94] + 1./2. * amp[95] +
      1./2. * amp[96] + 1./2. * amp[97];
  jamp[3] = +1./4. * amp[4] - 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[15] - 1./2. * amp[16] + 1./4. * amp[24] - 1./6. * amp[37] -
      1./6. * amp[38] - 1./2. * amp[39] - 1./2. * amp[40] + 1./12. * amp[43] +
      1./12. * amp[44] - 1./2. * amp[49] - 1./2. * amp[50] - 1./2. * amp[51] -
      1./2. * amp[52] - 1./2. * amp[54] - 1./2. * amp[55] + 1./12. * amp[58] +
      1./12. * amp[59] - 1./2. * amp[64] - 1./2. * amp[65] - 1./2. * amp[66] -
      1./2. * amp[67] - 1./6. * amp[68] - 1./6. * amp[69] - 1./2. * amp[70] -
      1./2. * amp[71] + 1./4. * amp[93];
  jamp[4] = +1./4. * amp[5] + 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[17] - 1./2. * amp[18] + 1./4. * amp[23] - 1./6. * amp[33] -
      1./6. * amp[34] - 1./2. * amp[35] - 1./2. * amp[36] - 1./2. * amp[41] -
      1./2. * amp[42] + 1./12. * amp[43] + 1./12. * amp[44] - 1./2. * amp[45] -
      1./2. * amp[46] - 1./2. * amp[47] - 1./2. * amp[48] - 1./2. * amp[72] -
      1./2. * amp[73] + 1./12. * amp[76] + 1./12. * amp[77] - 1./2. * amp[82] -
      1./2. * amp[83] - 1./2. * amp[84] - 1./2. * amp[85] - 1./6. * amp[86] -
      1./6. * amp[87] + 1./4. * amp[92];
  jamp[5] = +1./2. * amp[2] + 1./2. * amp[3] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[6] + 1./2. * amp[7] + 1./2. * amp[8] + 1./2. *
      amp[9] + 1./6. * amp[39] + 1./6. * amp[40] + 1./6. * amp[41] + 1./6. *
      amp[42] - 1./36. * amp[43] - 1./36. * amp[44] + 1./6. * amp[45] + 1./6. *
      amp[46] + 1./6. * amp[47] + 1./6. * amp[48] + 1./6. * amp[49] + 1./6. *
      amp[50] + 1./6. * amp[51] + 1./6. * amp[52] + 1./6. * amp[54] + 1./6. *
      amp[55] + 1./6. * amp[56] + 1./6. * amp[57] - 1./36. * amp[58] - 1./36. *
      amp[59] + 1./6. * amp[60] + 1./6. * amp[61] + 1./6. * amp[62] + 1./6. *
      amp[63] + 1./6. * amp[64] + 1./6. * amp[65] + 1./6. * amp[66] + 1./6. *
      amp[67] + 1./6. * amp[72] + 1./6. * amp[73] + 1./6. * amp[74] + 1./6. *
      amp[75] - 1./36. * amp[76] - 1./36. * amp[77] + 1./6. * amp[78] + 1./6. *
      amp[79] + 1./6. * amp[80] + 1./6. * amp[81] + 1./6. * amp[82] + 1./6. *
      amp[83] + 1./6. * amp[84] + 1./6. * amp[85] + 1./2. * amp[88] + 1./2. *
      amp[89] - 1./12. * amp[92] - 1./12. * amp[93] + 1./2. * amp[98] + 1./2. *
      amp[99] + 1./2. * amp[100] + 1./2. * amp[101];
