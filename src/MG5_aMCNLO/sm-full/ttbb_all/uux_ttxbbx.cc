...
double uux_ttxbbx::matrix_1_uux_ttxbbx()
{
    ...
    jamp[2] = +1. / 2. * amp[19] + 1. / 2. * amp[20] - 1. / 12. * amp[21] -
              ...
              1. / 2. * amp[25] + 1. / 2. * amp[26] + 1. / 2. * amp[35] +
              1. / 2. * amp[36] - 1. / 12. * amp[37] - 1. / 12. * amp[38] +
              1. / 2. * amp[39] + 1. / 2. * amp[40];
    jamp[3] = +1. / 4. * amp[4] -
              1. / 4. * std::complex<double>(0, 1) * amp[12] -
              1. / 2. * amp[13] - 1. / 2. * amp[14] + 1. / 4. * amp[22] -
              1. / 2. * amp[29] - 1. / 2. * amp[30] + 1. / 4. * amp[38];
    jamp[4] = +1. / 4. * amp[5] +
              1. / 4. * std::complex<double>(0, 1) * amp[12] -
              1. / 2. * amp[15] - 1. / 2. * amp[16] + 1. / 4. * amp[21] -
              1. / 2. * amp[31] - 1. / 2. * amp[32] + 1. / 4. * amp[37];
    jamp[5] = +1. / 2. * amp[2] + 1. / 2. * amp[3] - 1. / 12. * amp[4] -
              1. / 12. * amp[5] + 1. / 2. * amp[6] + 1. / 2. * amp[7] +
              1. / 2. * amp[8] + 1. / 2. * amp[9] + 1. / 6. * amp[29] +
              1. / 6. * amp[30] + 1. / 6. * amp[31] + 1. / 6. * amp[32] +
              1. / 2. * amp[33] + 1. / 2. * amp[34] - 1. / 12. * amp[37] -
              1. / 12. * amp[38] + 1. / 2. * amp[41] + 1. / 2. * amp[42];
