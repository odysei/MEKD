...
#ifndef MG5_Sigma_sm_full_bbx_ttxbbx_H
#define MG5_Sigma_sm_full_bbx_ttxbbx_H
...
class bbx_ttxbbx
{
  public:
    ...
    virtual string name() const {return "b b~ > t t~ b b~ (sm_full)";}
...
#endif  // MG5_Sigma_sm_full_bbx_ttxbbx_H
