...
void ccx_ttxbbx::initProc(string param_card_name) 
{
...
void ccx_ttxbbx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double ccx_ttxbbx::matrix_1_ccx_ttxbbx() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 51; 
  ...
  jamp[0] = -1./6. * amp[0] - 1./6. * amp[1] - 1./6. * amp[2] - 1./6. * amp[3]
      ...
      1./6. * amp[37] - 1./6. * amp[38] - 1./6. * amp[39] - 1./6. * amp[40] +
      1./36. * amp[41] + 1./36. * amp[42] - 1./6. * amp[43] - 1./6. * amp[44] -
      1./6. * amp[45] - 1./6. * amp[46] - 1./6. * amp[47] - 1./6. * amp[48] -
      1./6. * amp[49] - 1./6. * amp[50];
  ...
  jamp[2] = +1./2. * amp[21] + 1./2. * amp[22] - 1./12. * amp[23] - 1./12. *
      ...
      amp[28] + 1./2. * amp[39] + 1./2. * amp[40] - 1./12. * amp[41] - 1./12. *
      amp[42] + 1./2. * amp[43] + 1./2. * amp[44] + 1./2. * amp[45] + 1./2. *
      amp[46];
  jamp[3] = +1./4. * amp[4] - 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[15] - 1./2. * amp[16] + 1./4. * amp[24] - 1./2. * amp[33] -
      1./2. * amp[34] + 1./4. * amp[42];
  jamp[4] = +1./4. * amp[5] + 1./4. * std::complex<double> (0, 1) * amp[14] -
      1./2. * amp[17] - 1./2. * amp[18] + 1./4. * amp[23] - 1./2. * amp[35] -
      1./2. * amp[36] + 1./4. * amp[41];
  jamp[5] = +1./2. * amp[2] + 1./2. * amp[3] - 1./12. * amp[4] - 1./12. *
      amp[5] + 1./2. * amp[6] + 1./2. * amp[7] + 1./2. * amp[8] + 1./2. *
      amp[9] + 1./6. * amp[33] + 1./6. * amp[34] + 1./6. * amp[35] + 1./6. *
      amp[36] + 1./2. * amp[37] + 1./2. * amp[38] - 1./12. * amp[41] - 1./12. *
      amp[42] + 1./2. * amp[47] + 1./2. * amp[48] + 1./2. * amp[49] + 1./2. *
      amp[50];
