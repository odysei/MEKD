...
// Process: c c~ > zp > mu- mu+ WEIGHTED=2 / h xg

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin1_UP_2l::initProc(string param_card_name)
{
...
void qq_Spin1_UP_2l::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
...
double qq_Spin1_UP_2l::sigmaHat()
{
...
void qq_Spin1_UP_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV1_2_3_4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_111, pars->HEF_MEKD2_1_GC_108,
                 ...
                 pars->mdl_MZp, pars->mdl_WZp, w[4]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    FFV1_2_3_4_0(w[3], w[2], w[4], pars->HEF_MEKD2_1_GC_141,
                 pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
                 pars->HEF_MEKD2_1_GC_140, amp[0]);
}
double qq_Spin1_UP_2l::matrix_ccx_zp_mummup_no_hxg()
{
    int i, j;
    // Local variables
