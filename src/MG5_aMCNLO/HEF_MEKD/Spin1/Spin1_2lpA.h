...
#ifndef MG5_Sigma_HEF_MEKD2_1_zp_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_zp_mummupa_H
...
class Spin1_2lpA
{
  public:
	...
	virtual string name() const { return "zp > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_zp_mummupa_no_hxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_zp_mummupa_H
