...
#ifndef MG5_Sigma_HEF_MEKD2_1_zp_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_zp_mummupmummup_H
...
class Spin1_2f_SF
{
  public:
	...
	virtual string name() const { return "zp > mu- mu+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_zp_mummupmummup_no_hxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_zp_mummupmummup_H
