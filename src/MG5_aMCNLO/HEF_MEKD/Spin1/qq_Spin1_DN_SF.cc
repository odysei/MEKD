...
void qq_Spin1_DN_SF::initProc(string param_card_name)
{
...
void qq_Spin1_DN_SF::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
double qq_Spin1_DN_SF::sigmaHat()
{
...
void qq_Spin1_DN_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_Spin1_DN_SF::matrix_ssx_zp_mummupmummup()
{
    int i, j;
    // Local variables
    //   const int ngraphs = 2;
