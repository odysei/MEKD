...
#ifndef MG5_Sigma_HEF_MEKD2_1_ccx_zp_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_ccx_zp_mummup_H
...
class qq_Spin1_UP_2l
{
  public:
	...
	virtual string name() const { return "c c~ > mu- mu+ (HEF_MEKD2_1)"; }
...
#endif // MG5_Sigma_HEF_MEKD2_1_ccx_zp_mummup_H
