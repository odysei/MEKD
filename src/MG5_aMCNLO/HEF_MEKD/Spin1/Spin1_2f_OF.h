...
#ifndef MG5_Sigma_HEF_MEKD2_1_zp_emepmummup_H
#define MG5_Sigma_HEF_MEKD2_1_zp_emepmummup_H
...
class Spin1_2f_OF
{
  public:
    ...
    virtual string name() const { return "zp > e- e+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_zp_emepmummup_no_hxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_zp_emepmummup_H
