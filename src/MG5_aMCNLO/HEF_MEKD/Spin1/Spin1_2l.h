...
#ifndef MG5_Sigma_HEF_MEKD2_1_zp_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_zp_mummup_H
...
class Spin1_2l
{
  public:
	...
	virtual string name() const { return "zp > mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_zp_mummup_no_hxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_zp_mummup_H
