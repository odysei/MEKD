...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummup_H
...
class qq_Spin1_DN_2l
{
  public:
    ...
    virtual string name() const { return "s s~ > mu- mu+ (HEF_MEKD2_1)"; }
...
#endif // MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummup_H
