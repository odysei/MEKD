...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_Z_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_Z_mummupa_H
...
class qq_DY_DN_2lpA
{
  public:
    ...
    std::string name() const { return "s s~ > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_ssx_mummupa_no_hzpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_ssx_Z_mummupa_H
