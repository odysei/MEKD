...
#ifndef MG5_Sigma_HEF_MEKD2_1_z_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_z_mummup_H
...
class DY_2l
{
  public:
    ...
    virtual string name() const { return "z > mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_z_mummup_no_hzpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_z_mummup_H
