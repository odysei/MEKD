...
#ifndef MG5_Sigma_HEF_MEKD2_1_z_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_z_mummupa_H
...
class DY_2lpA
{
  public:
	...
	virtual string name() const { return "z > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_z_mummupa_no_hzpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_z_mummupa_H
