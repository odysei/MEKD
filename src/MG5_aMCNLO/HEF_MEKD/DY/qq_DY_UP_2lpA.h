...
#ifndef MG5_Sigma_HEF_MEKD2_1_ccx_Z_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_ccx_Z_mummupa_H
...
class qq_DY_UP_2lpA
{
  public:
    ...
    std::string name() const { return "c c~ > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_ccx_mummupa_no_hzpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_ccx_Z_mummupa_H
