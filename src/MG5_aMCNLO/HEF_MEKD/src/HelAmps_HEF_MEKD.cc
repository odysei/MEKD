            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    V3[2] =
        denom * -2. * cI * (OM3 * -0.500000000 * P3[0] * (TMP1 + 2. * (TMP2)) +
                            (+0.500000000 * (F2[4] * F1[2] + F2[5] * F1[3]) +
                             F2[2] * F1[4] + F2[3] * F1[5]));
    V3[3] =
        denom * -2. * cI * (OM3 * -0.500000000 * P3[1] * (TMP1 + 2. * (TMP2)) +
                            (-0.500000000 * (F2[5] * F1[2] + F2[4] * F1[3]) +
                             F2[3] * F1[4] + F2[2] * F1[5]));
    V3[4] =
        denom * 2. * cI * (OM3 * 0.500000000 * P3[2] * (TMP1 + 2. * (TMP2)) +
                           (+0.500000000 * cI * (F2[5] * F1[2]) -
                            0.500000000 * cI * (F2[4] * F1[3]) -
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP12 = (P3[0] * P1[0] - P3[1] * P1[1] - P3[2] * P1[2] - P3[3] * P1[3]);
    vertex =
        COUP * S3[2] * (TMP10 * (-cI * (TMP8 * TMP13) + cI * (TMP11 * TMP12)) +
            ...
            double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] =
        denom * -2. * cI * S3[2] * (P1[1] * (V2[4] * P2[3] - V2[5] * P2[2]) +
                                    (P1[2] * (V2[5] * P2[1] - V2[3] * P2[3]) +
                                     P1[3] * (V2[3] * P2[2] - V2[4] * P2[1])));
    V1[3] =
        denom * 2. * cI * S3[2] * (P1[0] * (V2[5] * P2[2] - V2[4] * P2[3]) +
                                   (P1[2] * (V2[2] * P2[3] - V2[5] * P2[0]) +
                                    P1[3] * (V2[4] * P2[0] - V2[2] * P2[2])));
    V1[4] =
        denom * 2. * cI * S3[2] * (P1[0] * (V2[3] * P2[3] - V2[5] * P2[1]) +
                                   (P1[1] * (V2[5] * P2[0] - V2[2] * P2[3]) +
                                    P1[3] * (V2[2] * P2[1] - V2[3] * P2[0])));
    V1[5] =
        denom * 2. * cI * S3[2] * (P1[0] * (V2[4] * P2[1] - V2[3] * P2[2]) +
            ...
            double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] =
        denom * S3[2] * (P3[0] * (-cI * (TMP10 * TMP13) + cI * (TMP7 * TMP9)) +
                         TMP12 * (-cI * (V2[2] * TMP9) + cI * (P2[0] * TMP10)));
    V1[3] =
        denom * S3[2] * (P3[1] * (-cI * (TMP10 * TMP13) + cI * (TMP7 * TMP9)) +
                         TMP12 * (-cI * (V2[3] * TMP9) + cI * (P2[1] * TMP10)));
    V1[4] =
        denom * S3[2] * (P3[2] * (-cI * (TMP10 * TMP13) + cI * (TMP7 * TMP9)) +
                         TMP12 * (-cI * (V2[4] * TMP9) + cI * (P2[2] * TMP10)));
    V1[5] =
        denom * S3[2] * (P3[3] * (-cI * (TMP10 * TMP13) + cI * (TMP7 * TMP9)) +
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI * (F2[2] * F1[4] + F2[3] * F1[5] - F2[4] * F1[2] -
                           F2[5] * F1[3] - P3[0] * OM3 * TMP10);
    V3[3] = denom * -cI * (F2[5] * F1[2] + F2[4] * F1[3] + F2[3] * F1[4] +
                           F2[2] * F1[5] - P3[1] * OM3 * TMP10);
    V3[4] = denom * -cI *
            (-cI * (F2[4] * F1[3] + F2[2] * F1[5]) +
             cI * (F2[5] * F1[2] + F2[3] * F1[4]) - P3[2] * OM3 * TMP10);
    V3[5] = denom * -cI * (F2[4] * F1[2] + F2[2] * F1[4] - F2[5] * F1[3] -
                           F2[3] * F1[5] - P3[3] * OM3 * TMP10);
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * TMP0 * (OM3 * P3[0] * (-cI * (TMP2) + cI * (TMP1)) +
                            (-cI * (P1[0]) + cI * (P2[0])));
    V3[3] = denom * TMP0 * (OM3 * P3[1] * (-cI * (TMP2) + cI * (TMP1)) +
                            (-cI * (P1[1]) + cI * (P2[1])));
    V3[4] = denom * TMP0 * (OM3 * P3[2] * (-cI * (TMP2) + cI * (TMP1)) +
                            (-cI * (P1[2]) + cI * (P2[2])));
    V3[5] = denom * TMP0 * (OM3 * P3[3] * (-cI * (TMP2) + cI * (TMP1)) +
                            (-cI * (P1[3]) + cI * (P2[3])));
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * TMP15 * (OM3 * P3[0] * (-cI * (TMP2) + cI * (TMP1)) +
                             (-cI * (P1[0]) + cI * (P2[0])));
    V3[3] = denom * TMP15 * (OM3 * P3[1] * (-cI * (TMP2) + cI * (TMP1)) +
                             (-cI * (P1[1]) + cI * (P2[1])));
    V3[4] = denom * TMP15 * (OM3 * P3[2] * (-cI * (TMP2) + cI * (TMP1)) +
                             (-cI * (P1[2]) + cI * (P2[2])));
    V3[5] = denom * TMP15 * (OM3 * P3[3] * (-cI * (TMP2) + cI * (TMP1)) +
                             (-cI * (P1[3]) + cI * (P2[3])));
}
         ...
         (P1[1] *
          ...
          (P1[2] * (V2[3] * T3[11] + V2[4] * T3[12] + V2[5] * T3[13] -
           ...
           P1[3] * (V2[3] * T3[15] + V2[4] * T3[16] + V2[5] * T3[17] -
                    V2[2] * T3[14]))));
    vertex = COUP * -1. * (TMP23 * (+cI * (TMP24 + TMP25)) +
                           TMP26 * (+cI * (TMP27 + TMP28)));
}
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        denom * -2. * cI *
        (OM3 * P3[0] * (TMP1 * (P3[1] * (V2[5] * V1[4] - V2[4] * V1[5]) +
    ...
    T3[7] =
        denom * 2. * cI *
        (OM3 * P3[1] * (TMP1 * (P3[0] * (V2[4] * V1[5] - V2[5] * V1[4]) +
                                (P3[2] * (V2[5] * V1[2] - V2[2] * V1[5]) +
                                 P3[3] * (V2[2] * V1[4] - V2[4] * V1[2]))) +
                        (TMP2 * (P3[0] * (V2[5] * V1[4] - V2[4] * V1[5]) +
                                 (P3[2] * (V2[2] * V1[5] - V2[5] * V1[2]) +
    ...
    T3[12] =
        denom * 2. * cI *
        (OM3 * P3[2] * (TMP1 * (P3[0] * (V2[5] * V1[3] - V2[3] * V1[5]) +
                                (P3[1] * (V2[2] * V1[5] - V2[5] * V1[2]) +
                                 P3[3] * (V2[3] * V1[2] - V2[2] * V1[3]))) +
                        (TMP2 * (P3[0] * (V2[3] * V1[5] - V2[5] * V1[3]) +
                                 (P3[1] * (V2[5] * V1[2] - V2[2] * V1[5]) +
    ...
    T3[17] =
        denom * 2. * cI *
        (OM3 * P3[3] * (TMP1 * (P3[0] * (V2[3] * V1[4] - V2[4] * V1[3]) +
                                (P3[1] * (V2[4] * V1[2] - V2[2] * V1[4]) +
                                 P3[2] * (V2[2] * V1[3] - V2[3] * V1[2]))) +
                        (TMP2 * (P3[0] * (V2[4] * V1[3] - V2[3] * V1[4]) +
                                 (P3[1] * (V2[2] * V1[4] - V2[4] * V1[2]) +
    ...
    T3[3] =
        ...
        (OM3 *
             (P3[0] *
              ...
              P3[1] *
                  (TMP1 * TMP23 * (P2[1] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                                   (P2[2] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                                    P2[3] * (P3[2] * V1[3] - P3[1] * V1[4]))) +
                   TMP2 * TMP26 *
             ...
             (P3[1] *
                  (TMP23 * (TMP1 * (P2[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                   ...
                   TMP26 * (TMP2 * (P1[0] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                            ...
                            0.666666667 * (P3[2] * TMP34))) +
              P3[2] *
                  (TMP1 * TMP23 * (P2[0] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                                   (P2[2] * (P3[0] * V1[5] - P3[3] * V1[2]) +
                                    P2[3] * (P3[2] * V1[2] - P3[0] * V1[4]))) +
                   TMP2 * TMP26 *
             ...
             (P3[2] *
                  (TMP23 * (TMP1 * (P2[0] * (P3[2] * V1[3] - P3[1] * V1[4]) +
                   ...
                   TMP26 * (TMP2 * (P1[0] * (P3[2] * V2[3] - P3[1] * V2[4]) +
                            ...
                            0.666666667 * (P3[3] * TMP34))) +
              P3[3] *
                  (TMP1 * TMP23 * (P2[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                                   (P2[1] * (P3[3] * V1[2] - P3[0] * V1[5]) +
                                    P2[3] * (P3[0] * V1[3] - P3[1] * V1[2]))) +
                   TMP2 * TMP26 *
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    T3[6] =
        denom * cI *
        (OM3 * (P3[0] * (TMP1 * -1. * (F2[5] * F1[2] + F2[4] * F1[3] +
                                       F2[3] * F1[4] + F2[2] * F1[5] -
                         ...
                         (TMP2 * (F2[5] * F1[2] + F2[4] * F1[3] +
                          ...
                          (P3[1] * 0.666666667 * (TMP39 - TMP40) +
                           TMP11 * (P2[1] - P1[1])))) +
                P3[1] * (TMP1 * (F2[4] * F1[2] + F2[5] * F1[3] - F2[2] * F1[4] -
                                 F2[3] * F1[5]) +
    ...
    T3[10] =
        ...
        (OM3 * (P3[0] * (TMP1 * (-cI * (F2[5] * F1[2] + F2[3] * F1[4]) +
                         ...
                         (TMP2 * -1. * (-cI * (F2[5] * F1[2] + F2[3] * F1[4]) +
                                        cI * (F2[4] * F1[3] + F2[2] * F1[5]) +
                                        1.333333333 * (P3[2] * OM3 * TMP11)) +
                          (P3[2] * 0.666666667 * (TMP39 - TMP40) +
                           TMP11 * (P2[2] - P1[2])))) +
                P3[2] * (TMP1 * (F2[4] * F1[2] + F2[5] * F1[3] - F2[2] * F1[4] -
                                 F2[3] * F1[5]) +
                         (TMP2 * (F2[2] * F1[4] + F2[3] * F1[5] -
                                  F2[4] * F1[2] - F2[5] * F1[3]) +
                          TMP11 * (P2[0] - P1[0])))) +
    ...
    T3[14] =
        ...
        (OM3 * (P3[0] * (TMP1 * (F2[5] * F1[3] + F2[3] * F1[5] +
                                 ...
                                 F2[4] * F1[2] - F2[2] * F1[4]) +
                         (TMP2 * -1. * (F2[5] * F1[3] + F2[3] * F1[5] +
                                        1.333333333 * (P3[3] * OM3 * TMP11) -
                                        F2[4] * F1[2] - F2[2] * F1[4]) +
                          (P3[3] * 0.666666667 * (TMP39 - TMP40) +
                           TMP11 * (P2[3] - P1[3])))) +
                P3[3] * (TMP1 * (F2[4] * F1[2] + F2[5] * F1[3] - F2[2] * F1[4] -
                                 F2[3] * F1[5]) +
                         (TMP2 * (F2[2] * F1[4] + F2[3] * F1[5] -
                                  F2[4] * F1[2] - F2[5] * F1[3]) +
                          TMP11 * (P2[0] - P1[0])))) +
    ...
    T3[7] =
        denom * 2. * cI *
        (OM3 * (P3[1] * (TMP1 * -1. * (F2[5] * F1[2] + F2[4] * F1[3] +
                                       F2[3] * F1[4] + F2[2] * F1[5] -
    ...
    T3[11] =
        ...
        (OM3 * (P3[1] * (TMP1 * (-cI * (F2[5] * F1[2] + F2[3] * F1[4]) +
                         ...
                         (TMP2 * -1. * (-cI * (F2[5] * F1[2] + F2[3] * F1[4]) +
                          ...
                          (P3[2] * 0.666666667 * (TMP39 - TMP40) +
                           TMP11 * (P2[2] - P1[2])))) +
                P3[2] * (TMP1 * -1. * (F2[5] * F1[2] + F2[4] * F1[3] +
                                       F2[3] * F1[4] + F2[2] * F1[5]) +
                         (TMP2 * (F2[5] * F1[2] + F2[4] * F1[3] +
                                  F2[3] * F1[4] + F2[2] * F1[5]) +
                          TMP11 * (P2[1] - P1[1])))) +
    ...
    T3[15] =
        ...
        (OM3 * (P3[1] * (TMP1 * (F2[5] * F1[3] + F2[3] * F1[5] +
                         ...
                         (TMP2 * -1. * (F2[5] * F1[3] + F2[3] * F1[5] +
                          ...
                          (P3[3] * 0.666666667 * (TMP39 - TMP40) +
                           TMP11 * (P2[3] - P1[3])))) +
                P3[3] * (TMP1 * -1. * (F2[5] * F1[2] + F2[4] * F1[3] +
                                       F2[3] * F1[4] + F2[2] * F1[5]) +
                         (TMP2 * (F2[5] * F1[2] + F2[4] * F1[3] +
                                  F2[3] * F1[4] + F2[2] * F1[5]) +
                          TMP11 * (P2[1] - P1[1])))) +
             ...
             (P3[0] *
                  (P3[1] *
                       (OM3 *
                        ...
                        (TMP10 * (TMP4 * -0.333333333 * (-2. * cI * (TMP10) +
                                                         cI * (TMP47 + TMP48)) +
                                  (-0.666666667 * cI * (TMP7 * TMP9) -
                                   0.333333333 * cI *
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    T3[2] = denom * 2. *
            (OM3 * (TMP23 * (TMP26 * (P3[0] * (OM3 * 0.666666667 * P3[0] *
                                                   (+cI * (TMP2 + TMP1)) +
                                               (-cI * (P2[0] + P1[0]))) +
                                      (+0.333333333 * cI * (TMP2 + TMP1))) +
                             P3[0] * (-cI * (TMP2 * V1[2]) +
                                      0.333333333 * cI * (P3[0] * TMP9))) +
                    P3[0] * TMP26 * (-cI * (TMP1 * V2[2]) +
                                     0.333333333 * cI * (P3[0] * TMP7))) +
    ...
    T3[7] = denom * 2. *
            (OM3 * (TMP23 * (TMP26 * (P3[1] * (OM3 * 0.666666667 * P3[1] *
                                                   (+cI * (TMP2 + TMP1)) +
                                               (-cI * (P2[1] + P1[1]))) +
                                      (-0.333333333 * cI * (TMP2 + TMP1))) +
                             P3[1] * (-cI * (TMP2 * V1[3]) +
                                      0.333333333 * cI * (P3[1] * TMP9))) +
                    P3[1] * TMP26 * (-cI * (TMP1 * V2[3]) +
                                     0.333333333 * cI * (P3[1] * TMP7))) +
    ...
    T3[12] = denom * 2. *
             (OM3 * (TMP23 * (TMP26 * (P3[2] * (OM3 * 0.666666667 * P3[2] *
                                                    (+cI * (TMP2 + TMP1)) +
                                                (-cI * (P2[2] + P1[2]))) +
                                       (-0.333333333 * cI * (TMP2 + TMP1))) +
                              P3[2] * (-cI * (TMP2 * V1[4]) +
                                       0.333333333 * cI * (P3[2] * TMP9))) +
                     P3[2] * TMP26 * (-cI * (TMP1 * V2[4]) +
                                      0.333333333 * cI * (P3[2] * TMP7))) +
    ...
    T3[17] = denom * 2. *
             (OM3 * (TMP23 * (TMP26 * (P3[3] * (OM3 * 0.666666667 * P3[3] *
                                                    (+cI * (TMP2 + TMP1)) +
                                                (-cI * (P2[3] + P1[3]))) +
                                       (-0.333333333 * cI * (TMP2 + TMP1))) +
                              P3[3] * (-cI * (TMP2 * V1[5]) +
                                       0.333333333 * cI * (P3[3] * TMP9))) +
                     P3[3] * TMP26 * (-cI * (TMP1 * V2[5]) +
                                      0.333333333 * cI * (P3[3] * TMP7))) +
    ...
    T3[3] =
        ...
        (OM3 *
             (P3[0] *
              ...
              P3[1] *
                  (TMP1 * TMP26 * (P2[1] * (P3[3] * V2[4] - P3[2] * V2[5]) +
                                   (P2[2] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                                    P2[3] * (P3[2] * V2[3] - P3[1] * V2[4]))) +
                   TMP2 * TMP23 *
             ...
             (P3[1] *
                  (TMP23 * (TMP2 * (P1[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                   ...
                   TMP26 * (TMP1 * (P2[0] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                            ...
                            0.666666667 * (P3[2] * TMP31))) +
              P3[2] *
                  (TMP1 * TMP26 * (P2[0] * (P3[3] * V2[4] - P3[2] * V2[5]) +
                                   (P2[2] * (P3[0] * V2[5] - P3[3] * V2[2]) +
                                    P2[3] * (P3[2] * V2[2] - P3[0] * V2[4]))) +
                   TMP2 * TMP23 *
             ...
             (P3[2] *
                  (TMP23 * (TMP2 * (P1[0] * (P3[2] * V1[3] - P3[1] * V1[4]) +
                   ...
                   TMP26 * (TMP1 * (P2[0] * (P3[2] * V2[3] - P3[1] * V2[4]) +
                            ...
                            0.666666667 * (P3[3] * TMP31))) +
              P3[3] *
                  (TMP1 * TMP26 * (P2[0] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                                   (P2[1] * (P3[3] * V2[2] - P3[0] * V2[5]) +
                                    P2[3] * (P3[0] * V2[3] - P3[1] * V2[2]))) +
                   TMP2 * TMP23 *
             ...
             double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        ...
        (TMP1 * (TMP2 * (TMP4 * 0.333333333 *
                         ...
                         cI * (V2[2] * V1[2])) +
                 TMP23 * (TMP9 * -0.333333333 * (+cI * (P3[0] * P3[0] * OM3) +
                                                 -1.000000000 * cI) -
                          cI * (P2[0] * V1[2]))) +
         TMP26 * (TMP2 * (TMP7 * -0.333333333 * (+cI * (P3[0] * P3[0] * OM3) +
                                                 -1.000000000 * cI) -
                          cI * (P1[0] * V2[2])) +
                  TMP23 * (TMP10 * 0.333333333 * (+cI * (P3[0] * P3[0] * OM3) +
                                                  -1.000000000 * cI) +
                           cI * (P1[0] * P2[0]))));
    T3[3] =
        denom *
    ...
    T3[7] =
        ...
        (TMP1 * (TMP2 * (TMP4 * 0.333333333 *
                 ...
                 TMP23 * (TMP9 * -0.333333333 *
                              (+cI * (P3[1] * P3[1] * OM3) + 1.000000000 * cI) -
                          cI * (P2[1] * V1[3]))) +
         TMP26 * (TMP2 * (TMP7 * -0.333333333 *
                              (+cI * (P3[1] * P3[1] * OM3) + 1.000000000 * cI) -
                          cI * (P1[1] * V2[3])) +
                  TMP23 * (TMP10 * 0.333333333 * (+cI * (P3[1] * P3[1] * OM3) +
                                                  1.000000000 * cI) +
                           cI * (P1[1] * P2[1]))));
    T3[8] =
        denom *
    ...
    T3[12] =
        ...
        (TMP1 * (TMP2 * (TMP4 * 0.333333333 *
         ...
         TMP26 * (TMP2 * (TMP7 * -0.333333333 *
                              (+cI * (P3[2] * P3[2] * OM3) + 1.000000000 * cI) -
                          cI * (P1[2] * V2[4])) +
                  TMP23 * (TMP10 * 0.333333333 * (+cI * (P3[2] * P3[2] * OM3) +
                                                  1.000000000 * cI) +
                           cI * (P1[2] * P2[2]))));
    T3[13] =
        denom *
    ...
    T3[17] =
        ...
        (TMP1 * (TMP2 * (TMP4 * 0.333333333 *
         ...
         TMP26 * (TMP2 * (TMP7 * -0.333333333 *
                              (+cI * (P3[3] * P3[3] * OM3) + 1.000000000 * cI) -
                          cI * (P1[3] * V2[5])) +
                  TMP23 * (TMP10 * 0.333333333 * (+cI * (P3[3] * P3[3] * OM3) +
                                                  1.000000000 * cI) +
                           cI * (P1[3] * P2[3]))));
}
             ...
             double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] =
        denom * (TMP1 * (TMP2 * (OM1 * P1[0] * (-cI * (TMP27 + TMP28) +
                                                cI * (TMP68 + TMP69)) +
                                 (V2[3] * (+cI * (T3[6] + T3[3])) +
                                  (V2[4] * (+cI * (T3[10] + T3[4])) +
                                   (V2[5] * (+cI * (T3[14] + T3[5])) -
                 ...
                 P3[0] * (TMP2 * (+cI * (TMP27 + TMP28)) -
                          TMP23 * (+cI * (TMP21 + TMP22))));
    V1[3] =
        denom * (TMP1 * (TMP2 * (OM1 * P1[1] * (-cI * (TMP27 + TMP28) +
                                                cI * (TMP68 + TMP69)) +
                                 (V2[2] * -1. * (+cI * (T3[3] + T3[6])) +
                                  (V2[4] * (+cI * (T3[11] + T3[8])) +
                                   (V2[5] * (+cI * (T3[15] + T3[9])) +
                 ...
                 P3[1] * (TMP2 * (+cI * (TMP27 + TMP28)) -
                          TMP23 * (+cI * (TMP21 + TMP22))));
    V1[4] =
        denom * (TMP1 * (TMP2 * (OM1 * P1[2] * (-cI * (TMP27 + TMP28) +
                                                cI * (TMP68 + TMP69)) +
                 ...
                 P3[2] * (TMP2 * (+cI * (TMP27 + TMP28)) -
                          TMP23 * (+cI * (TMP21 + TMP22))));
    V1[5] =
        denom * (TMP1 * (TMP2 * (OM1 * P1[3] * (-cI * (TMP27 + TMP28) +
                                                cI * (TMP68 + TMP69)) +
             ...
             double M1, double W1, complex<double> V1[])
{
    ...
    V1[3] =
        denom * cI * (OM1 * P1[1] * (TMP68 + TMP69) +
                      (V2[2] * -1. * (T3[3] + T3[6]) +
                       (V2[4] * (T3[11] + T3[8]) +
                        (V2[5] * (T3[15] + T3[9]) + 2. * (V2[3] * T3[7])))));
    V1[4] =
        denom * cI * (OM1 * P1[2] * (TMP68 + TMP69) +
                      (V2[2] * -1. * (T3[4] + T3[10]) +
                       (V2[3] * (T3[8] + T3[11]) +
                        (V2[5] * (T3[16] + T3[13]) + 2. * (V2[4] * T3[12])))));
    V1[5] =
        denom * cI * (OM1 * P1[3] * (TMP68 + TMP69) +
                      (V2[2] * -1. * (T3[5] + T3[14]) +
                       (V2[3] * (T3[9] + T3[15]) +
         ...
         (P1[1] * (P1[2] * (P3[0] * (V2[5] * (T3[12] - T3[7]) +
          ...
          (P1[2] * (P1[3] * (P3[0] * (V2[3] * (T3[17] - T3[12]) +
                    ...
                    P1[2] * (P3[0] * (V2[3] * T3[16] - V2[5] * T3[8]) +
                             (P3[1] * (V2[5] * T3[4] - V2[2] * T3[16]) +
                              P3[3] * (V2[2] * T3[8] - V2[3] * T3[4])))) +
           P1[3] * P1[3] * (P3[0] * (V2[4] * T3[9] - V2[3] * T3[13]) +
                            (P3[1] * (V2[2] * T3[13] - V2[4] * T3[5]) +
                             P3[2] * (V2[3] * T3[5] - V2[2] * T3[9]))))));
    TMP71 =
        -1. *
         ...
         (P1[1] * (P1[2] * (P3[0] * (V2[5] * (T3[12] - T3[7]) +
          ...
          (P1[2] * (P1[3] * (P3[0] * (V2[3] * (T3[17] - T3[12]) +
                    ...
                    P1[2] * (P3[0] * (V2[3] * T3[13] - V2[5] * T3[11]) +
                             (P3[1] * (V2[5] * T3[10] - V2[2] * T3[13]) +
                              P3[3] * (V2[2] * T3[11] - V2[3] * T3[10])))) +
           P1[3] * P1[3] * (P3[0] * (V2[4] * T3[15] - V2[3] * T3[16]) +
                            (P3[1] * (V2[2] * T3[16] - V2[4] * T3[14]) +
                             P3[2] * (V2[3] * T3[14] - V2[2] * T3[15]))))));
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
            ...
            (TMP21 * (P1[1] * (P2[3] * V2[4] - P2[2] * V2[5]) +
             ...
             TMP22 * (P1[1] * (P2[3] * V2[4] - P2[2] * V2[5]) +
                      (P1[2] * (P2[1] * V2[5] - P2[3] * V2[3]) +
                       P1[3] * (P2[2] * V2[3] - P2[1] * V2[4]))));
    V1[3] =
        denom * 2. * cI * (TMP21 * (P1[0] * (P2[2] * V2[5] - P2[3] * V2[4]) +
                           ...
                           TMP22 * (P1[0] * (P2[2] * V2[5] - P2[3] * V2[4]) +
                                    (P1[2] * (P2[3] * V2[2] - P2[0] * V2[5]) +
                                     P1[3] * (P2[0] * V2[4] - P2[2] * V2[2]))));
    V1[4] =
        denom * 2. * cI * (TMP21 * (P1[0] * (P2[3] * V2[3] - P2[1] * V2[5]) +
                           ...
                           TMP22 * (P1[0] * (P2[3] * V2[3] - P2[1] * V2[5]) +
                                    (P1[1] * (P2[0] * V2[5] - P2[3] * V2[2]) +
                                     P1[3] * (P2[1] * V2[2] - P2[0] * V2[3]))));
    V1[5] =
        denom * 2. * cI * (TMP21 * (P1[0] * (P2[1] * V2[4] - P2[2] * V2[3]) +
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        denom * 2. * cI *
        (OM3 * (P3[0] * (TMP1 * -1. * (F2[4] * F1[2] + F2[5] * F1[3] +
                                       F2[2] * F1[4] + F2[3] * F1[5] -
    ...
    T3[6] =
        ...
        (OM3 * (P3[0] * (TMP1 * (F2[5] * F1[2] + F2[4] * F1[3] +
                                 ...
                                 F2[3] * F1[4] - F2[2] * F1[5]) +
                         (TMP2 * -1. * (F2[5] * F1[2] + F2[4] * F1[3] +
                                        1.333333333 * (P3[1] * OM3 * TMP20) -
                                        F2[3] * F1[4] - F2[2] * F1[5]) +
                          (P3[1] * 0.666666667 * (TMP37 - TMP38) +
                           TMP20 * (P2[1] - P1[1])))) +
                P3[1] * (TMP1 * -1. * (F2[4] * F1[2] + F2[5] * F1[3] +
                                       F2[2] * F1[4] + F2[3] * F1[5]) +
                         (TMP2 * (F2[4] * F1[2] + F2[5] * F1[3] +
                                  F2[2] * F1[4] + F2[3] * F1[5]) +
                          TMP20 * (P2[0] - P1[0])))) +
    ...
    T3[10] =
        ...
        (OM3 * (P3[0] * (TMP1 * (-cI * (F2[4] * F1[3] + F2[3] * F1[4]) +
                         ...
                         (TMP2 * -1. * (-cI * (F2[4] * F1[3] + F2[3] * F1[4]) +
                                        cI * (F2[5] * F1[2] + F2[2] * F1[5]) +
                                        1.333333333 * (P3[2] * OM3 * TMP20)) +
                          (P3[2] * 0.666666667 * (TMP37 - TMP38) +
                           TMP20 * (P2[2] - P1[2])))) +
                P3[2] * (TMP1 * -1. * (F2[4] * F1[2] + F2[5] * F1[3] +
                                       F2[2] * F1[4] + F2[3] * F1[5]) +
                         (TMP2 * (F2[4] * F1[2] + F2[5] * F1[3] +
                                  F2[2] * F1[4] + F2[3] * F1[5]) +
                          TMP20 * (P2[0] - P1[0])))) +
    ...
    T3[14] =
        ...
        (OM3 * (P3[0] * (TMP1 * (F2[4] * F1[2] + F2[3] * F1[5] +
                                 ...
                                 F2[5] * F1[3] - F2[2] * F1[4]) +
                         (TMP2 * -1. * (F2[4] * F1[2] + F2[3] * F1[5] +
                                        1.333333333 * (P3[3] * OM3 * TMP20) -
                                        F2[5] * F1[3] - F2[2] * F1[4]) +
                          (P3[3] * 0.666666667 * (TMP37 - TMP38) +
                           TMP20 * (P2[3] - P1[3])))) +
                P3[3] * (TMP1 * -1. * (F2[4] * F1[2] + F2[5] * F1[3] +
                                       F2[2] * F1[4] + F2[3] * F1[5]) +
                         (TMP2 * (F2[4] * F1[2] + F2[5] * F1[3] +
                                  F2[2] * F1[4] + F2[3] * F1[5]) +
                          TMP20 * (P2[0] - P1[0])))) +
