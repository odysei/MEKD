             ...
             complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP15 =
        (P2[0] * -1. *
             (T3[6] * V1[3] + T3[10] * V1[4] + T3[14] * V1[5] - T3[2] * V1[2]) +
    ...
    TMP10 =
        (P1[0] * -1. *
             (T3[6] * P2[1] + T3[10] * P2[2] + T3[14] * P2[3] - T3[2] * P2[0]) +
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    V3[4] =
        denom * -cI *
        (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) - P3[2] * OM3 * TMP20);
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -2. * cI *
            (OM3 * -1. / 2. * P3[0] * (TMP20 + 2. * (TMP21)) +
             (+1. / 2. * (F2[4] * F1[2] + F2[5] * F1[3]) + F2[2] * F1[4] +
              F2[3] * F1[5]));
    V3[3] = denom * -2. * cI *
            (OM3 * -1. / 2. * P3[1] * (TMP20 + 2. * (TMP21)) +
             (-1. / 2. * (F2[5] * F1[2] + F2[4] * F1[3]) + F2[3] * F1[4] +
              F2[2] * F1[5]));
    V3[4] = denom * 2. * cI *
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    vertex =
        COUP * -1. *
        (TMP14 * (+cI * (TMP15 + TMP16)) + TMP17 * (+cI * (TMP18 + TMP19)));
}
                     ...
                     (P1[2] * (P3[0] * (T3[9] * V1[5] - T3[17] * V1[3]) +
                      ...
                      P1[3] * (P3[0] * (T3[13] * V1[3] - T3[9] * V1[4]) +
                               (P3[1] * (T3[5] * V1[4] - T3[13] * V1[2]) +
                                P3[2] * (T3[9] * V1[2] - T3[5] * V1[3])))))))));
    vertex = COUP * -1. *
             (TMP14 * (+cI * (TMP24 + TMP26 + TMP28 + TMP30)) +
