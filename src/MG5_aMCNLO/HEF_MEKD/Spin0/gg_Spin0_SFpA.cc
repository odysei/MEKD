...
void gg_Spin0_SFpA::initProc(string param_card_name)
{
...
void gg_Spin0_SFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV5_7_3(w[5], w[2], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
    ...
    VVS2_1(w[16], w[7], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[19]);
    VVS3_4_5_1(w[16], w[12], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, pars->mdl_MZ, pars->mdl_WZ, w[20]);
    VVS2_1(w[16], w[12], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[21]);
    FFV2_1(w[2], w[6], pars->HEF_MEKD_GC_5, pars->mdl_MM, pars->ZERO, w[22]);
    FFV5_7_3(w[3], w[4], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
    ...
    VVS2_1(w[23], w[7], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[25]);
    VVS3_4_5_1(w[23], w[12], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, pars->mdl_MZ, pars->mdl_WZ, w[26]);
    VVS2_1(w[23], w[12], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[27]);
    ...
    VVS2_1(w[28], w[7], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[30]);
    VVS3_4_5_1(w[28], w[12], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, pars->mdl_MZ, pars->mdl_WZ, w[31]);
    VVS2_1(w[28], w[12], pars->HEF_MEKD_GC_25, pars->mdl_MZ, pars->mdl_WZ,
           w[32]);
    ...
    FFV5_7_0(w[15], w[4], w[14], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[7]);
    FFV5_7_0(w[17], w[4], w[18], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[8]);
    FFV5_7_0(w[17], w[4], w[19], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[9]);
    FFV5_7_0(w[17], w[4], w[20], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[10]);
    FFV5_7_0(w[17], w[4], w[21], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[11]);
    FFV5_7_0(w[3], w[9], w[18], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[12]);
    FFV5_7_0(w[3], w[9], w[19], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[13]);
    FFV5_7_0(w[3], w[9], w[20], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[14]);
    FFV5_7_0(w[3], w[9], w[21], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[15]);
    FFV5_7_0(w[5], w[22], w[24], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[16]);
    FFV5_7_0(w[5], w[22], w[25], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[17]);
    FFV5_7_0(w[5], w[22], w[26], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[18]);
    FFV5_7_0(w[5], w[22], w[27], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[19]);
    FFV5_7_0(w[3], w[22], w[29], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[20]);
    FFV5_7_0(w[3], w[22], w[30], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[21]);
    FFV5_7_0(w[3], w[22], w[31], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[22]);
    FFV5_7_0(w[3], w[22], w[32], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[23]);
    FFV5_7_0(w[15], w[2], w[24], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[24]);
    FFV5_7_0(w[15], w[2], w[25], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[25]);
    FFV5_7_0(w[15], w[2], w[26], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[26]);
    FFV5_7_0(w[15], w[2], w[27], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[27]);
    FFV5_7_0(w[17], w[2], w[29], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[28]);
    FFV5_7_0(w[17], w[2], w[30], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[29]);
    FFV5_7_0(w[17], w[2], w[31], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[30]);
    FFV5_7_0(w[17], w[2], w[32], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[31]);
}
double gg_Spin0_SFpA::matrix_gg_h_mummupmummupa_no_zpxg()
{
    int i, j;
    // Local variables
