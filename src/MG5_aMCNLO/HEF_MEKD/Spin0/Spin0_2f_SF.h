...
#ifndef MG5_Sigma_HEF_MEKD2_1_h_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_h_mummupmummup_H
...
class Spin0_2f_SF
{
  public:
    ...
    virtual string name() const { return "h > mu- mu+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_h_mummupmummup_no_zpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_h_mummupmummup_H
