...
void gg_Spin0_2f_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
	...
	FFS1_2_2(w[3], w[6], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[16]);
	FFV5_7_3(w[5], w[2], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188,
			 pars->mdl_MZ, pars->mdl_WZ, w[17]);
	FFS1_2_2(w[3], w[11], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
	...
	FFS1_2_1(w[2], w[6], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[21]);
	FFS1_2_1(w[2], w[11], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
	...
	//   VVS3_4_5_0(w[17], w[19], w[6], pars->HEF_MEKD2_1_GC_14,
	//   pars->HEF_MEKD2_1_GC_18, pars->HEF_MEKD2_1_GC_22,
	//       amp[20]);	// ZZ
	//   VVS2_0(w[17], w[19], w[6], pars->HEF_MEKD2_1_GC_25, amp[21]);	// ZZ
	//   VVS3_4_5_0(w[17], w[19], w[11], pars->HEF_MEKD2_1_GC_14,
	//   pars->HEF_MEKD2_1_GC_18, pars->HEF_MEKD2_1_GC_22,
	//       amp[22]);	// ZZ
	...
	FFV5_7_0(w[3], w[21], w[14], pars->HEF_MEKD2_1_GC_181,
			 pars->HEF_MEKD2_1_GC_188, amp[34]);
...
double gg_Spin0_2f_SF::matrix_gg_h_mummupmummup_no_zpxg()
{
	...
	jamp[0] = +2. * (+amp[0] + amp[1] + amp[2] + amp[3] + amp[4] + amp[5] +
					 ...
					 amp[30] - amp[31] + amp[32] + amp[33] + amp[34] + amp[35] +
					 amp[36] + amp[37] + amp[38] + amp[39]);
