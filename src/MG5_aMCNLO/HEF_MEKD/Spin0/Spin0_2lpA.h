...
#ifndef MG5_Sigma_HEF_MEKD2_1_h_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_h_mummupa_H
...
class Spin0_2lpA
{
  public:
    ...
    virtual string name() const { return "h > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_h_mummupa_no_zpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_h_mummupa_H
