...
void gg_Spin0_SF::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void gg_Spin0_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    VVS3_4_5_0(w[7], w[8], w[6], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, amp[0]);
    VVS2_0(w[7], w[8], w[6], pars->HEF_MEKD_GC_25, amp[1]);
    VVS3_4_5_0(w[7], w[8], w[9], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, amp[2]);
    VVS2_0(w[7], w[8], w[9], pars->HEF_MEKD_GC_25, amp[3]);
    VVS3_4_5_0(w[10], w[11], w[6], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, amp[4]);
    VVS2_0(w[10], w[11], w[6], pars->HEF_MEKD_GC_25, amp[5]);
    VVS3_4_5_0(w[10], w[11], w[9], pars->HEF_MEKD_GC_14, pars->HEF_MEKD_GC_18,
               pars->HEF_MEKD_GC_22, amp[6]);
    VVS2_0(w[10], w[11], w[9], pars->HEF_MEKD_GC_25, amp[7]);
}
double gg_Spin0_SF::matrix_gg_h_mummupmummup_no_zpxg()
{
    int i, j;
    // Local variables
    //   const int ngraphs = 8;
