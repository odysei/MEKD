...
#ifndef MG5_Sigma_HEF_MEKD2_1_h_emepmummup_H
#define MG5_Sigma_HEF_MEKD2_1_h_emepmummup_H
...
class Spin0_2f_OF
{
  public:
    ...
    virtual string name() const { return "h > e- e+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_h_emepmummup_no_zpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_h_emepmummup_H
