...
#ifndef MG5_Sigma_HEF_MEKD2_1_xg_emepmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_xg_emepmummupa_H
...
class Spin2_2f_OFpA
{
  public:
    ...
    virtual string name() const { return "xg > e- e+ mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_xg_emepmummupa_no_hzp();
...
#endif // MG5_Sigma_HEF_MEKD2_1_xg_emepmummupa_H
