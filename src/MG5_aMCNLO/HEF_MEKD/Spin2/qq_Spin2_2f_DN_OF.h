...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_xg_emepmummup_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_xg_emepmummup_H
...
class qq_Spin2_2f_DN_OF
{
  public:
    ...
    std::string name() const { return "s s~ > e- e+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_ssx_xg_emepmummup_no_zph();
...
#endif // MG5_Sigma_HEF_MEKD2_1_ssx_xg_emepmummup_H
