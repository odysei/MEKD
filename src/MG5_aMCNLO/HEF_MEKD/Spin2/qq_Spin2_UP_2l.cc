...
// Process: c c~ > xg > mu- mu+ WEIGHTED=2 / h zp

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin2_UP_2l::initProc(string param_card_name)
{
...
double qq_Spin2_UP_2l::sigmaHat()
{
...
void qq_Spin2_UP_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_Spin2_UP_2l::matrix_ccx_xg_mummup_no_hzp()
{
    int i, j;
    // Local variables
