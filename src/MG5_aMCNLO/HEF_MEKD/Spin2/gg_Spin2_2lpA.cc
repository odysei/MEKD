...
void gg_Spin2_2lpA::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
...
void gg_Spin2_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFT1_2_3_5_0(w[3], w[6], w[7], pars->HEF_MEKD2_1_GC_145,
                 pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
                 pars->HEF_MEKD2_1_GC_144, amp[1]);
    FFT1_2_3_5_0(w[8], w[2], w[5], pars->HEF_MEKD2_1_GC_145,
                 pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
                 pars->HEF_MEKD2_1_GC_144, amp[2]);
    FFT1_2_3_5_0(w[8], w[2], w[7], pars->HEF_MEKD2_1_GC_145,
                 pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
