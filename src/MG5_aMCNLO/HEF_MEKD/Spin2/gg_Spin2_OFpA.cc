...
void gg_Spin2_OFpA::initProc(string param_card_name)
{
...
void gg_Spin2_OFpA::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void gg_Spin2_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV5_7_0(w[13], w[4], w[12], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[3]);
    FFV5_7_0(w[3], w[14], w[16], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[4]);
    FFV5_7_0(w[3], w[14], w[17], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[5]);
    FFV5_7_0(w[18], w[2], w[16], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[6]);
    FFV5_7_0(w[18], w[2], w[17], pars->HEF_MEKD_GC_161, pars->HEF_MEKD_GC_168,
             amp[7]);
}
double gg_Spin2_OFpA::matrix_gg_xg_emepmummupa()
{
    int i, j;
    // Local variables
    //   const int ngraphs = 8;
