...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_mummup_H
...
class gg_Spin2_2l
{
  public:
    ...
    std::string name() const { return "g g > mu- mu+ (HEF_MEKD2_1)"; }
...
#endif // MG5_Sigma_HEF_MEKD2_1_gg_xg_mummup_H
