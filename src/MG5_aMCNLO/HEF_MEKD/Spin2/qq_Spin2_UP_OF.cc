...
void qq_Spin2_UP_OF::initProc(string param_card_name)
{
...
void qq_Spin2_UP_OF::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
double qq_Spin2_UP_OF::sigmaHat()
{
...
void qq_Spin2_UP_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_Spin2_UP_OF::matrix_ccx_xg_emepmummup_no_g()
{
    int i, j;
    // Local variables
    //   const int ngraphs = 1;
