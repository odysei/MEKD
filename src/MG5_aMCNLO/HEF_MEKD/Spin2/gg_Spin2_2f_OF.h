...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummup_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummup_H
...
class gg_Spin2_2f_OF
{
  public:
    ...
    std::string name() const { return "g g > e- e+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
    ...
    double matrix_gg_xg_emepmummup_no_zph();
...
#endif // MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummup_H
