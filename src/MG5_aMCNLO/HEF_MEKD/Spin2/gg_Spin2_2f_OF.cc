...
void gg_Spin2_2f_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFT1_2_3_5_1(w[2], w[11], pars->HEF_MEKD2_1_GC_135,
                 pars->HEF_MEKD2_1_GC_132, pars->HEF_MEKD2_1_GC_133,
                 pars->HEF_MEKD2_1_GC_134, pars->mdl_Me, pars->ZERO, w[18]);
    FFT1_2_3_5_2(w[3], w[11], pars->HEF_MEKD2_1_GC_135,
                 pars->HEF_MEKD2_1_GC_132, pars->HEF_MEKD2_1_GC_133,
                 pars->HEF_MEKD2_1_GC_134, pars->mdl_Me, pars->ZERO, w[19]);
