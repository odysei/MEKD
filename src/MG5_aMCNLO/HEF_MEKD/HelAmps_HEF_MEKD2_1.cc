             ...
             complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP15 = (P2[0] * -1. * (T3[6] * V1[3] + T3[10] * V1[4] + T3[14] * V1[5] -
                            T3[2] * V1[2]) +
             (P2[1] * (T3[7] * V1[3] + T3[11] * V1[4] + T3[15] * V1[5] -
                       T3[3] * V1[2]) +
              (P2[2] * (T3[8] * V1[3] + T3[12] * V1[4] + T3[16] * V1[5] -
                        T3[4] * V1[2]) +
               P2[3] * (T3[9] * V1[3] + T3[13] * V1[4] + T3[17] * V1[5] -
                        T3[5] * V1[2]))));
    TMP32 =
        (V1[2] * -1. *
             (T3[3] * V2[3] + T3[4] * V2[4] + T3[5] * V2[5] - T3[2] * V2[2]) +
         (V1[3] *
              (T3[7] * V2[3] + T3[8] * V2[4] + T3[9] * V2[5] - T3[6] * V2[2]) +
          (V1[4] * (T3[11] * V2[3] + T3[12] * V2[4] + T3[13] * V2[5] -
                    T3[10] * V2[2]) +
           V1[5] * (T3[15] * V2[3] + T3[16] * V2[4] + T3[17] * V2[5] -
                    T3[14] * V2[2]))));
    TMP31 = (V1[2] * -1. * (T3[6] * V2[3] + T3[10] * V2[4] + T3[14] * V2[5] -
                            T3[2] * V2[2]) +
             (V1[3] * (T3[7] * V2[3] + T3[11] * V2[4] + T3[15] * V2[5] -
                       T3[3] * V2[2]) +
              (V1[4] * (T3[8] * V2[3] + T3[12] * V2[4] + T3[16] * V2[5] -
                        T3[4] * V2[2]) +
               V1[5] * (T3[9] * V2[3] + T3[13] * V2[4] + T3[17] * V2[5] -
                        T3[5] * V2[2]))));
    TMP16 =
        (P2[0] * -1. *
             (T3[3] * V1[3] + T3[4] * V1[4] + T3[5] * V1[5] - T3[2] * V1[2]) +
         (P2[1] *
              (T3[7] * V1[3] + T3[8] * V1[4] + T3[9] * V1[5] - T3[6] * V1[2]) +
          (P2[2] * (T3[11] * V1[3] + T3[12] * V1[4] + T3[13] * V1[5] -
                    T3[10] * V1[2]) +
           P2[3] * (T3[15] * V1[3] + T3[16] * V1[4] + T3[17] * V1[5] -
                    T3[14] * V1[2]))));
    TMP11 =
        (P1[0] * -1. *
             (T3[3] * P2[1] + T3[4] * P2[2] + T3[5] * P2[3] - T3[2] * P2[0]) +
         (P1[1] *
              (T3[7] * P2[1] + T3[8] * P2[2] + T3[9] * P2[3] - T3[6] * P2[0]) +
          (P1[2] * (T3[11] * P2[1] + T3[12] * P2[2] + T3[13] * P2[3] -
                    T3[10] * P2[0]) +
           P1[3] * (T3[15] * P2[1] + T3[16] * P2[2] + T3[17] * P2[3] -
                    T3[14] * P2[0]))));
    TMP10 = (P1[0] * -1. * (T3[6] * P2[1] + T3[10] * P2[2] + T3[14] * P2[3] -
                            T3[2] * P2[0]) +
             (P1[1] * (T3[7] * P2[1] + T3[11] * P2[2] + T3[15] * P2[3] -
                       T3[3] * P2[0]) +
              (P1[2] * (T3[8] * P2[1] + T3[12] * P2[2] + T3[16] * P2[3] -
                        T3[4] * P2[0]) +
               P1[3] * (T3[9] * P2[1] + T3[13] * P2[2] + T3[17] * P2[3] -
                        T3[5] * P2[0]))));
    ...
    vertex =
        COUP *
        (TMP12 * -1. * (+cI * (TMP10 + TMP11)) +
         (TMP13 * -1. * (+cI * (TMP31 + TMP32)) +
          (TMP8 * (+cI * (TMP15 + TMP16)) + TMP9 * (+cI * (TMP18 + TMP19)))));
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    V3[3] =
        denom * -cI * (-F2[5] * F1[2] - F2[4] * F1[3] - P3[1] * OM3 * TMP20);
    V3[4] = denom * -cI * (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
                           P3[2] * OM3 * TMP20);
...
void FFV5_7_1(complex<double> F2[], complex<double> V3[], complex<double> COUP1,
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    P2[2] = F2[1].imag();
    P2[3] = F2[0].imag();
    TMP5 = (P2[0] * (F1[2] * (F2[4] * (T3[2] + T3[14]) +
                              F2[5] * (T3[6] + cI * (T3[10]))) +
                     (F1[3] * (F2[4] * (T3[6] - cI * (T3[10])) +
                               F2[5] * (T3[2] - T3[14])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[14]) -
                                F2[3] * (T3[6] + cI * (T3[10]))) +
                       F1[5] * (F2[2] * (+cI * (T3[10]) - T3[6]) +
                                F2[3] * (T3[2] + T3[14]))))) +
            (P2[1] * (F1[2] * (F2[4] * -1. * (T3[3] + T3[15]) -
                               F2[5] * (T3[7] + cI * (T3[11]))) +
                      (F1[3] * (F2[4] * (+cI * (T3[11]) - T3[7]) +
                                F2[5] * (T3[15] - T3[3])) +
                       (F1[4] * (F2[2] * (T3[15] - T3[3]) +
                                 F2[3] * (T3[7] + cI * (T3[11]))) +
                        F1[5] * (F2[2] * (T3[7] - cI * (T3[11])) -
                                 F2[3] * (T3[3] + T3[15]))))) +
             (P2[2] * (F1[2] * (F2[4] * -1. * (T3[4] + T3[16]) -
                                F2[5] * (T3[8] + cI * (T3[12]))) +
                       (F1[3] * (F2[4] * (+cI * (T3[12]) - T3[8]) +
                                 F2[5] * (T3[16] - T3[4])) +
                        (F1[4] * (F2[2] * (T3[16] - T3[4]) +
                                  F2[3] * (T3[8] + cI * (T3[12]))) +
                         F1[5] * (F2[2] * (T3[8] - cI * (T3[12])) -
                                  F2[3] * (T3[4] + T3[16]))))) +
              P2[3] * (F1[2] * (F2[4] * -1. * (T3[5] + T3[17]) -
                                F2[5] * (T3[9] + cI * (T3[13]))) +
                       (F1[3] * (F2[4] * (+cI * (T3[13]) - T3[9]) +
                                 F2[5] * (T3[17] - T3[5])) +
                        (F1[4] * (F2[2] * (T3[17] - T3[5]) +
                                  F2[3] * (T3[9] + cI * (T3[13]))) +
                         F1[5] * (F2[2] * (T3[9] - cI * (T3[13])) -
                                  F2[3] * (T3[5] + T3[17]))))))));
    TMP4 = (P1[0] * (F1[2] * (F2[4] * (T3[2] + T3[14]) +
                              F2[5] * (T3[6] + cI * (T3[10]))) +
                     (F1[3] * (F2[4] * (T3[6] - cI * (T3[10])) +
                               F2[5] * (T3[2] - T3[14])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[14]) -
              ...
              P1[3] * (F1[2] * (F2[4] * -1. * (T3[5] + T3[17]) -
                       ...
                       (F1[3] * (F2[4] * (+cI * (T3[13]) - T3[9]) +
                        ...
                        (F1[4] * (F2[2] * (T3[17] - T3[5]) +
                         ...
                         F1[5] * (F2[2] * (T3[9] - cI * (T3[13])) -
                                  F2[3] * (T3[5] + T3[17]))))))));
    TMP7 = (P2[0] * (F1[2] * (F2[4] * (T3[2] + T3[5]) +
                              F2[5] * (T3[3] + cI * (T3[4]))) +
                     (F1[3] * (F2[4] * (T3[3] - cI * (T3[4])) +
                               F2[5] * (T3[2] - T3[5])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[5]) -
                                F2[3] * (T3[3] + cI * (T3[4]))) +
                       F1[5] * (F2[2] * (+cI * (T3[4]) - T3[3]) +
                                F2[3] * (T3[2] + T3[5]))))) +
            (P2[1] * (F1[2] * (F2[4] * -1. * (T3[6] + T3[9]) -
                               F2[5] * (T3[7] + cI * (T3[8]))) +
                      (F1[3] * (F2[4] * (+cI * (T3[8]) - T3[7]) +
                                F2[5] * (T3[9] - T3[6])) +
                       (F1[4] * (F2[2] * (T3[9] - T3[6]) +
                                 F2[3] * (T3[7] + cI * (T3[8]))) +
                        F1[5] * (F2[2] * (T3[7] - cI * (T3[8])) -
                                 F2[3] * (T3[6] + T3[9]))))) +
             (P2[2] * (F1[2] * (F2[4] * -1. * (T3[10] + T3[13]) -
                                F2[5] * (T3[11] + cI * (T3[12]))) +
                       (F1[3] * (F2[4] * (+cI * (T3[12]) - T3[11]) +
                                 F2[5] * (T3[13] - T3[10])) +
                        (F1[4] * (F2[2] * (T3[13] - T3[10]) +
                                  F2[3] * (T3[11] + cI * (T3[12]))) +
                         F1[5] * (F2[2] * (T3[11] - cI * (T3[12])) -
                                  F2[3] * (T3[10] + T3[13]))))) +
              P2[3] * (F1[2] * (F2[4] * -1. * (T3[14] + T3[17]) -
                                F2[5] * (T3[15] + cI * (T3[16]))) +
                       (F1[3] * (F2[4] * (+cI * (T3[16]) - T3[15]) +
                                 F2[5] * (T3[17] - T3[14])) +
                        (F1[4] * (F2[2] * (T3[17] - T3[14]) +
                                  F2[3] * (T3[15] + cI * (T3[16]))) +
                         F1[5] * (F2[2] * (T3[15] - cI * (T3[16])) -
                                  F2[3] * (T3[14] + T3[17]))))))));
    TMP6 = (P1[0] * (F1[2] * (F2[4] * (T3[2] + T3[5]) +
                              F2[5] * (T3[3] + cI * (T3[4]))) +
                     (F1[3] * (F2[4] * (T3[3] - cI * (T3[4])) +
                               F2[5] * (T3[2] - T3[5])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[5]) -
             ...
             complex<double> COUP, complex<double> &vertex)
{
    ...
    vertex = COUP * (TMP14 * (TMP17 * -1. * (+cI * (TMP10 + TMP11)) +
                              TMP33 * (+cI * (TMP15 + TMP16))) +
                     TMP34 * (TMP17 * (+cI * (TMP18 + TMP19)) -
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP13 = (P1[0] * P2[0] - P1[1] * P2[1] - P1[2] * P2[2] - P1[3] * P2[3]);
    TMP12 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]);
    vertex = COUP * (TMP12 * TMP13 * (+cI * (TMP10 + TMP11)) -
                     TMP8 * TMP9 * (+cI * (TMP10 + TMP11)));
}
...
void FFV5_7_2(complex<double> F1[], complex<double> V3[], complex<double> COUP1,
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] =
        denom * -2. * cI * (OM3 * -1. / 2. * P3[0] * (TMP20 + 2. * (TMP21)) +
                            (+1. / 2. * (F2[4] * F1[2] + F2[5] * F1[3]) +
                             F2[2] * F1[4] + F2[3] * F1[5]));
    V3[3] =
        denom * -2. * cI * (OM3 * -1. / 2. * P3[1] * (TMP20 + 2. * (TMP21)) +
                            (-1. / 2. * (F2[5] * F1[2] + F2[4] * F1[3]) +
                             F2[3] * F1[4] + F2[2] * F1[5]));
    V3[4] = denom * 2. * cI *
            (OM3 * 1. / 2. * P3[2] * (TMP20 + 2. * (TMP21)) +
             (+1. / 2. * cI * (F2[5] * F1[2]) - 1. / 2. * cI * (F2[4] * F1[3]) -
              cI * (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
    V3[5] = denom * 2. * cI *
            (OM3 * 1. / 2. * P3[3] * (TMP20 + 2. * (TMP21)) +
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    P2[2] = F2[1].imag();
    P2[3] = F2[0].imag();
    TMP1 = (P2[0] * (F1[2] * (F2[4] * -1. * (T3[2] + T3[14]) -
                              F2[5] * (T3[6] + cI * (T3[10]))) +
                     (F1[3] * (F2[4] * (+cI * (T3[10]) - T3[6]) +
                               F2[5] * (T3[14] - T3[2])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[14]) -
                                F2[3] * (T3[6] + cI * (T3[10]))) +
                       F1[5] * (F2[2] * (+cI * (T3[10]) - T3[6]) +
                                F2[3] * (T3[2] + T3[14]))))) +
            (P2[1] * (F1[2] * (F2[4] * (T3[3] + T3[15]) +
                               F2[5] * (T3[7] + cI * (T3[11]))) +
                      (F1[3] * (F2[4] * (T3[7] - cI * (T3[11])) +
                                F2[5] * (T3[3] - T3[15])) +
                       (F1[4] * (F2[2] * (T3[15] - T3[3]) +
                                 F2[3] * (T3[7] + cI * (T3[11]))) +
                        F1[5] * (F2[2] * (T3[7] - cI * (T3[11])) -
                                 F2[3] * (T3[3] + T3[15]))))) +
             (P2[2] * (F1[2] * (F2[4] * (T3[4] + T3[16]) +
                                F2[5] * (T3[8] + cI * (T3[12]))) +
                       (F1[3] * (F2[4] * (T3[8] - cI * (T3[12])) +
                                 F2[5] * (T3[4] - T3[16])) +
                        (F1[4] * (F2[2] * (T3[16] - T3[4]) +
                                  F2[3] * (T3[8] + cI * (T3[12]))) +
                         F1[5] * (F2[2] * (T3[8] - cI * (T3[12])) -
                                  F2[3] * (T3[4] + T3[16]))))) +
              P2[3] * (F1[2] * (F2[4] * (T3[5] + T3[17]) +
                                F2[5] * (T3[9] + cI * (T3[13]))) +
                       (F1[3] * (F2[4] * (T3[9] - cI * (T3[13])) +
                                 F2[5] * (T3[5] - T3[17])) +
                        (F1[4] * (F2[2] * (T3[17] - T3[5]) +
                                  F2[3] * (T3[9] + cI * (T3[13]))) +
                         F1[5] * (F2[2] * (T3[9] - cI * (T3[13])) -
                                  F2[3] * (T3[5] + T3[17]))))))));
    TMP0 = (P1[0] * (F1[2] * (F2[4] * -1. * (T3[2] + T3[14]) -
                              F2[5] * (T3[6] + cI * (T3[10]))) +
                     (F1[3] * (F2[4] * (+cI * (T3[10]) - T3[6]) +
                               F2[5] * (T3[14] - T3[2])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[14]) -
              ...
              P1[3] * (F1[2] * (F2[4] * (T3[5] + T3[17]) +
                       ...
                       (F1[3] * (F2[4] * (T3[9] - cI * (T3[13])) +
                        ...
                        (F1[4] * (F2[2] * (T3[17] - T3[5]) +
                         ...
                         F1[5] * (F2[2] * (T3[9] - cI * (T3[13])) -
                                  F2[3] * (T3[5] + T3[17]))))))));
    TMP3 = (P2[0] * (F1[2] * (F2[4] * -1. * (T3[2] + T3[5]) -
                              F2[5] * (T3[3] + cI * (T3[4]))) +
                     (F1[3] * (F2[4] * (+cI * (T3[4]) - T3[3]) +
                               F2[5] * (T3[5] - T3[2])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[5]) -
                                F2[3] * (T3[3] + cI * (T3[4]))) +
                       F1[5] * (F2[2] * (+cI * (T3[4]) - T3[3]) +
                                F2[3] * (T3[2] + T3[5]))))) +
            (P2[1] * (F1[2] * (F2[4] * (T3[6] + T3[9]) +
                               F2[5] * (T3[7] + cI * (T3[8]))) +
                      (F1[3] * (F2[4] * (T3[7] - cI * (T3[8])) +
                                F2[5] * (T3[6] - T3[9])) +
                       (F1[4] * (F2[2] * (T3[9] - T3[6]) +
                                 F2[3] * (T3[7] + cI * (T3[8]))) +
                        F1[5] * (F2[2] * (T3[7] - cI * (T3[8])) -
                                 F2[3] * (T3[6] + T3[9]))))) +
             (P2[2] * (F1[2] * (F2[4] * (T3[10] + T3[13]) +
                                F2[5] * (T3[11] + cI * (T3[12]))) +
                       (F1[3] * (F2[4] * (T3[11] - cI * (T3[12])) +
                                 F2[5] * (T3[10] - T3[13])) +
                        (F1[4] * (F2[2] * (T3[13] - T3[10]) +
                                  F2[3] * (T3[11] + cI * (T3[12]))) +
                         F1[5] * (F2[2] * (T3[11] - cI * (T3[12])) -
                                  F2[3] * (T3[10] + T3[13]))))) +
              P2[3] * (F1[2] * (F2[4] * (T3[14] + T3[17]) +
                                F2[5] * (T3[15] + cI * (T3[16]))) +
                       (F1[3] * (F2[4] * (T3[15] - cI * (T3[16])) +
                                 F2[5] * (T3[14] - T3[17])) +
                        (F1[4] * (F2[2] * (T3[17] - T3[14]) +
                                  F2[3] * (T3[15] + cI * (T3[16]))) +
                         F1[5] * (F2[2] * (T3[15] - cI * (T3[16])) -
                                  F2[3] * (T3[14] + T3[17]))))))));
    TMP2 = (P1[0] * (F1[2] * (F2[4] * -1. * (T3[2] + T3[5]) -
                              F2[5] * (T3[3] + cI * (T3[4]))) +
                     (F1[3] * (F2[4] * (+cI * (T3[4]) - T3[3]) +
                               F2[5] * (T3[5] - T3[2])) +
                      (F1[4] * (F2[2] * (T3[2] - T3[5]) -
             ...
             complex<double> COUP, complex<double> &vertex)
{
    ...
    P3[2] = T3[1].imag();
    P3[3] = T3[0].imag();
    TMP42 = (P2[0] * (P2[1] * -1. * (T3[6] + T3[3]) +
                      (P2[2] * -1. * (T3[10] + T3[4]) +
                       (P2[3] * -1. * (T3[14] + T3[5]) + T3[2] * P2[0]))) +
             (P2[1] * (P2[2] * (T3[11] + T3[8]) +
                       (P2[3] * (T3[15] + T3[9]) + T3[7] * P2[1])) +
              (P2[2] * (P2[3] * (T3[16] + T3[13]) + T3[12] * P2[2]) +
               T3[17] * P2[3] * P2[3])));
    TMP43 = (P1[0] * -1. * (T3[6] * V1[3] + T3[10] * V1[4] + T3[14] * V1[5] -
                            T3[2] * V1[2]) +
             (P1[1] * (T3[7] * V1[3] + T3[11] * V1[4] + T3[15] * V1[5] -
                       T3[3] * V1[2]) +
              (P1[2] * (T3[8] * V1[3] + T3[12] * V1[4] + T3[16] * V1[5] -
                        T3[4] * V1[2]) +
               P1[3] * (T3[9] * V1[3] + T3[13] * V1[4] + T3[17] * V1[5] -
                        T3[5] * V1[2]))));
    TMP41 = (P1[0] * (P1[1] * -1. * (T3[6] + T3[3]) +
                      (P1[2] * -1. * (T3[10] + T3[4]) +
                       (P1[3] * -1. * (T3[14] + T3[5]) + T3[2] * P1[0]))) +
             (P1[1] * (P1[2] * (T3[11] + T3[8]) +
                       (P1[3] * (T3[15] + T3[9]) + T3[7] * P1[1])) +
              (P1[2] * (P1[3] * (T3[16] + T3[13]) + T3[12] * P1[2]) +
               T3[17] * P1[3] * P1[3])));
    TMP46 =
        (P2[0] * -1. *
             (T3[3] * V2[3] + T3[4] * V2[4] + T3[5] * V2[5] - T3[2] * V2[2]) +
    ...
    TMP44 =
        (P1[0] * -1. *
         ...
         (P1[1] *
              (T3[7] * V1[3] + T3[8] * V1[4] + T3[9] * V1[5] - T3[6] * V1[2]) +
          (P1[2] * (T3[11] * V1[3] + T3[12] * V1[4] + T3[13] * V1[5] -
                    T3[10] * V1[2]) +
           P1[3] * (T3[15] * V1[3] + T3[16] * V1[4] + T3[17] * V1[5] -
                    T3[14] * V1[2]))));
    ...
    TMP34 = (P2[0] * P3[0] - P2[1] * P3[1] - P2[2] * P3[2] - P2[3] * P3[3]);
    vertex = COUP *
             (TMP13 * (TMP12 * (-cI * (TMP10 + TMP11) + cI * (TMP41 + TMP42)) +
                       (+1. / 2. * (TMP17 * (+cI * (TMP45 + TMP46))) +
                        TMP14 * 1. / 2. * (+cI * (TMP43 + TMP44)))) +
              (TMP8 * (TMP9 * (-cI * (TMP41 + TMP42) + cI * (TMP10 + TMP11)) +
                       (TMP34 * -1. / 2. * (+cI * (TMP43 + TMP44)) -
                        cI * (TMP17 * TMP42))) +
               (TMP33 * (TMP9 * -1. / 2. * (+cI * (TMP45 + TMP46)) +
                         cI * (TMP12 * TMP42)) +
                TMP41 * (-cI * (TMP9 * TMP14) + cI * (TMP12 * TMP34)))));
}
        ...
        (P2[0] * -1. *
         ...
         (P2[1] *
          ...
          (P2[2] * (T3[11] * V1[3] + T3[12] * V1[4] + T3[13] * V1[5] -
           ...
           P2[3] * (T3[15] * V1[3] + T3[16] * V1[4] + T3[17] * V1[5] -
                    T3[14] * V1[2]))));
    vertex = COUP * -1. * (TMP14 * (+cI * (TMP15 + TMP16)) +
                           TMP17 * (+cI * (TMP18 + TMP19)));
}
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP24 =
        -1. *
        (P1[0] * (P2[0] * (P3[1] * (T3[5] * V1[4] - T3[4] * V1[5]) +
                           (P3[2] * (T3[3] * V1[5] - T3[5] * V1[3]) +
                            P3[3] * (T3[4] * V1[3] - T3[3] * V1[4]))) +
                  (P2[1] * (P3[0] * (T3[4] * V1[5] - T3[5] * V1[4]) +
                            (P3[2] * (T3[5] * V1[2] - T3[2] * V1[5]) +
                             P3[3] * (T3[2] * V1[4] - T3[4] * V1[2]))) +
                   (P2[2] * (P3[0] * (T3[5] * V1[3] - T3[3] * V1[5]) +
                             (P3[1] * (T3[2] * V1[5] - T3[5] * V1[2]) +
                              P3[3] * (T3[3] * V1[2] - T3[2] * V1[3]))) +
                    P2[3] * (P3[0] * (T3[3] * V1[4] - T3[4] * V1[3]) +
                             (P3[1] * (T3[4] * V1[2] - T3[2] * V1[4]) +
                              P3[2] * (T3[2] * V1[3] - T3[3] * V1[2])))))) +
         (P1[1] * (P2[0] * (P3[1] * (T3[8] * V1[5] - T3[9] * V1[4]) +
                            (P3[2] * (T3[9] * V1[3] - T3[7] * V1[5]) +
                             P3[3] * (T3[7] * V1[4] - T3[8] * V1[3]))) +
                   (P2[1] * (P3[0] * (T3[9] * V1[4] - T3[8] * V1[5]) +
                             (P3[2] * (T3[6] * V1[5] - T3[9] * V1[2]) +
                              P3[3] * (T3[8] * V1[2] - T3[6] * V1[4]))) +
                    (P2[2] * (P3[0] * (T3[7] * V1[5] - T3[9] * V1[3]) +
                              (P3[1] * (T3[9] * V1[2] - T3[6] * V1[5]) +
                               P3[3] * (T3[6] * V1[3] - T3[7] * V1[2]))) +
                     P2[3] * (P3[0] * (T3[8] * V1[3] - T3[7] * V1[4]) +
                              (P3[1] * (T3[6] * V1[4] - T3[8] * V1[2]) +
                               P3[2] * (T3[7] * V1[2] - T3[6] * V1[3])))))) +
          (P1[2] * (P2[0] * (P3[1] * (T3[12] * V1[5] - T3[13] * V1[4]) +
                             (P3[2] * (T3[13] * V1[3] - T3[11] * V1[5]) +
                              P3[3] * (T3[11] * V1[4] - T3[12] * V1[3]))) +
                    (P2[1] * (P3[0] * (T3[13] * V1[4] - T3[12] * V1[5]) +
                              (P3[2] * (T3[10] * V1[5] - T3[13] * V1[2]) +
                               P3[3] * (T3[12] * V1[2] - T3[10] * V1[4]))) +
                     (P2[2] * (P3[0] * (T3[11] * V1[5] - T3[13] * V1[3]) +
                               (P3[1] * (T3[13] * V1[2] - T3[10] * V1[5]) +
                                P3[3] * (T3[10] * V1[3] - T3[11] * V1[2]))) +
                      P2[3] * (P3[0] * (T3[12] * V1[3] - T3[11] * V1[4]) +
                               (P3[1] * (T3[10] * V1[4] - T3[12] * V1[2]) +
                                P3[2] * (T3[11] * V1[2] - T3[10] * V1[3])))))) +
           P1[3] *
               (P2[0] * (P3[1] * (T3[16] * V1[5] - T3[17] * V1[4]) +
                         (P3[2] * (T3[17] * V1[3] - T3[15] * V1[5]) +
                          P3[3] * (T3[15] * V1[4] - T3[16] * V1[3]))) +
                (P2[1] * (P3[0] * (T3[17] * V1[4] - T3[16] * V1[5]) +
                          (P3[2] * (T3[14] * V1[5] - T3[17] * V1[2]) +
                           P3[3] * (T3[16] * V1[2] - T3[14] * V1[4]))) +
                 (P2[2] * (P3[0] * (T3[15] * V1[5] - T3[17] * V1[3]) +
                           (P3[1] * (T3[17] * V1[2] - T3[14] * V1[5]) +
                            P3[3] * (T3[14] * V1[3] - T3[15] * V1[2]))) +
                  P2[3] * (P3[0] * (T3[16] * V1[3] - T3[15] * V1[4]) +
                           (P3[1] * (T3[14] * V1[4] - T3[16] * V1[2]) +
                            P3[2] * (T3[15] * V1[2] - T3[14] * V1[3])))))))));
    TMP25 =
        -1. *
        (P2[0] * (P1[0] * (P3[1] * (T3[5] * V2[4] - T3[4] * V2[5]) +
                           (P3[2] * (T3[3] * V2[5] - T3[5] * V2[3]) +
                            P3[3] * (T3[4] * V2[3] - T3[3] * V2[4]))) +
                  (P1[1] * (P3[0] * (T3[4] * V2[5] - T3[5] * V2[4]) +
                            (P3[2] * (T3[5] * V2[2] - T3[2] * V2[5]) +
                             P3[3] * (T3[2] * V2[4] - T3[4] * V2[2]))) +
                   (P1[2] * (P3[0] * (T3[5] * V2[3] - T3[3] * V2[5]) +
                             (P3[1] * (T3[2] * V2[5] - T3[5] * V2[2]) +
                              P3[3] * (T3[3] * V2[2] - T3[2] * V2[3]))) +
                    P1[3] * (P3[0] * (T3[3] * V2[4] - T3[4] * V2[3]) +
                             (P3[1] * (T3[4] * V2[2] - T3[2] * V2[4]) +
                              P3[2] * (T3[2] * V2[3] - T3[3] * V2[2])))))) +
         (P2[1] * (P1[0] * (P3[1] * (T3[8] * V2[5] - T3[9] * V2[4]) +
                            (P3[2] * (T3[9] * V2[3] - T3[7] * V2[5]) +
                             P3[3] * (T3[7] * V2[4] - T3[8] * V2[3]))) +
                   (P1[1] * (P3[0] * (T3[9] * V2[4] - T3[8] * V2[5]) +
                             (P3[2] * (T3[6] * V2[5] - T3[9] * V2[2]) +
                              P3[3] * (T3[8] * V2[2] - T3[6] * V2[4]))) +
                    (P1[2] * (P3[0] * (T3[7] * V2[5] - T3[9] * V2[3]) +
                              (P3[1] * (T3[9] * V2[2] - T3[6] * V2[5]) +
                               P3[3] * (T3[6] * V2[3] - T3[7] * V2[2]))) +
                     P1[3] * (P3[0] * (T3[8] * V2[3] - T3[7] * V2[4]) +
                              (P3[1] * (T3[6] * V2[4] - T3[8] * V2[2]) +
                               P3[2] * (T3[7] * V2[2] - T3[6] * V2[3])))))) +
          (P2[2] * (P1[0] * (P3[1] * (T3[12] * V2[5] - T3[13] * V2[4]) +
                             (P3[2] * (T3[13] * V2[3] - T3[11] * V2[5]) +
                              P3[3] * (T3[11] * V2[4] - T3[12] * V2[3]))) +
                    (P1[1] * (P3[0] * (T3[13] * V2[4] - T3[12] * V2[5]) +
                              (P3[2] * (T3[10] * V2[5] - T3[13] * V2[2]) +
                               P3[3] * (T3[12] * V2[2] - T3[10] * V2[4]))) +
                     (P1[2] * (P3[0] * (T3[11] * V2[5] - T3[13] * V2[3]) +
                               (P3[1] * (T3[13] * V2[2] - T3[10] * V2[5]) +
                                P3[3] * (T3[10] * V2[3] - T3[11] * V2[2]))) +
                      P1[3] * (P3[0] * (T3[12] * V2[3] - T3[11] * V2[4]) +
                               (P3[1] * (T3[10] * V2[4] - T3[12] * V2[2]) +
                                P3[2] * (T3[11] * V2[2] - T3[10] * V2[3])))))) +
           P2[3] *
               (P1[0] * (P3[1] * (T3[16] * V2[5] - T3[17] * V2[4]) +
                         (P3[2] * (T3[17] * V2[3] - T3[15] * V2[5]) +
                          P3[3] * (T3[15] * V2[4] - T3[16] * V2[3]))) +
                (P1[1] * (P3[0] * (T3[17] * V2[4] - T3[16] * V2[5]) +
                          (P3[2] * (T3[14] * V2[5] - T3[17] * V2[2]) +
                           P3[3] * (T3[16] * V2[2] - T3[14] * V2[4]))) +
                 (P1[2] * (P3[0] * (T3[15] * V2[5] - T3[17] * V2[3]) +
                           (P3[1] * (T3[17] * V2[2] - T3[14] * V2[5]) +
                            P3[3] * (T3[14] * V2[3] - T3[15] * V2[2]))) +
                  P1[3] * (P3[0] * (T3[16] * V2[3] - T3[15] * V2[4]) +
                           (P3[1] * (T3[14] * V2[4] - T3[16] * V2[2]) +
                            P3[2] * (T3[15] * V2[2] - T3[14] * V2[3])))))))));
    TMP26 =
        -1. *
        (P2[0] * (P1[0] * (P3[1] * (T3[5] * V1[4] - T3[4] * V1[5]) +
                           (P3[2] * (T3[3] * V1[5] - T3[5] * V1[3]) +
                            P3[3] * (T3[4] * V1[3] - T3[3] * V1[4]))) +
                  (P1[1] * (P3[0] * (T3[4] * V1[5] - T3[5] * V1[4]) +
                            (P3[2] * (T3[5] * V1[2] - T3[2] * V1[5]) +
                             P3[3] * (T3[2] * V1[4] - T3[4] * V1[2]))) +
                   (P1[2] * (P3[0] * (T3[5] * V1[3] - T3[3] * V1[5]) +
                             (P3[1] * (T3[2] * V1[5] - T3[5] * V1[2]) +
                              P3[3] * (T3[3] * V1[2] - T3[2] * V1[3]))) +
                    P1[3] * (P3[0] * (T3[3] * V1[4] - T3[4] * V1[3]) +
                             (P3[1] * (T3[4] * V1[2] - T3[2] * V1[4]) +
                              P3[2] * (T3[2] * V1[3] - T3[3] * V1[2])))))) +
         (P2[1] * (P1[0] * (P3[1] * (T3[8] * V1[5] - T3[9] * V1[4]) +
                            (P3[2] * (T3[9] * V1[3] - T3[7] * V1[5]) +
                             P3[3] * (T3[7] * V1[4] - T3[8] * V1[3]))) +
                   (P1[1] * (P3[0] * (T3[9] * V1[4] - T3[8] * V1[5]) +
                             (P3[2] * (T3[6] * V1[5] - T3[9] * V1[2]) +
                              P3[3] * (T3[8] * V1[2] - T3[6] * V1[4]))) +
                    (P1[2] * (P3[0] * (T3[7] * V1[5] - T3[9] * V1[3]) +
                              (P3[1] * (T3[9] * V1[2] - T3[6] * V1[5]) +
                               P3[3] * (T3[6] * V1[3] - T3[7] * V1[2]))) +
                     P1[3] * (P3[0] * (T3[8] * V1[3] - T3[7] * V1[4]) +
                              (P3[1] * (T3[6] * V1[4] - T3[8] * V1[2]) +
                               P3[2] * (T3[7] * V1[2] - T3[6] * V1[3])))))) +
          (P2[2] * (P1[0] * (P3[1] * (T3[12] * V1[5] - T3[13] * V1[4]) +
                             (P3[2] * (T3[13] * V1[3] - T3[11] * V1[5]) +
                              P3[3] * (T3[11] * V1[4] - T3[12] * V1[3]))) +
                    (P1[1] * (P3[0] * (T3[13] * V1[4] - T3[12] * V1[5]) +
                              (P3[2] * (T3[10] * V1[5] - T3[13] * V1[2]) +
                               P3[3] * (T3[12] * V1[2] - T3[10] * V1[4]))) +
                     (P1[2] * (P3[0] * (T3[11] * V1[5] - T3[13] * V1[3]) +
                               (P3[1] * (T3[13] * V1[2] - T3[10] * V1[5]) +
                                P3[3] * (T3[10] * V1[3] - T3[11] * V1[2]))) +
                      P1[3] * (P3[0] * (T3[12] * V1[3] - T3[11] * V1[4]) +
                               (P3[1] * (T3[10] * V1[4] - T3[12] * V1[2]) +
                                P3[2] * (T3[11] * V1[2] - T3[10] * V1[3])))))) +
           P2[3] *
               (P1[0] * (P3[1] * (T3[16] * V1[5] - T3[17] * V1[4]) +
                         (P3[2] * (T3[17] * V1[3] - T3[15] * V1[5]) +
                          P3[3] * (T3[15] * V1[4] - T3[16] * V1[3]))) +
                (P1[1] * (P3[0] * (T3[17] * V1[4] - T3[16] * V1[5]) +
                          (P3[2] * (T3[14] * V1[5] - T3[17] * V1[2]) +
                           P3[3] * (T3[16] * V1[2] - T3[14] * V1[4]))) +
                 (P1[2] * (P3[0] * (T3[15] * V1[5] - T3[17] * V1[3]) +
                           (P3[1] * (T3[17] * V1[2] - T3[14] * V1[5]) +
                            P3[3] * (T3[14] * V1[3] - T3[15] * V1[2]))) +
                  P1[3] * (P3[0] * (T3[16] * V1[3] - T3[15] * V1[4]) +
                           (P3[1] * (T3[14] * V1[4] - T3[16] * V1[2]) +
                            P3[2] * (T3[15] * V1[2] - T3[14] * V1[3])))))))));
    TMP27 =
        -1. *
        (P1[0] * (P2[0] * (P3[1] * (T3[14] * V2[4] - T3[10] * V2[5]) +
                           (P3[2] * (T3[6] * V2[5] - T3[14] * V2[3]) +
                            P3[3] * (T3[10] * V2[3] - T3[6] * V2[4]))) +
                  (P2[1] * (P3[0] * (T3[10] * V2[5] - T3[14] * V2[4]) +
                            (P3[2] * (T3[14] * V2[2] - T3[2] * V2[5]) +
                             P3[3] * (T3[2] * V2[4] - T3[10] * V2[2]))) +
                   (P2[2] * (P3[0] * (T3[14] * V2[3] - T3[6] * V2[5]) +
                             (P3[1] * (T3[2] * V2[5] - T3[14] * V2[2]) +
                              P3[3] * (T3[6] * V2[2] - T3[2] * V2[3]))) +
                    P2[3] * (P3[0] * (T3[6] * V2[4] - T3[10] * V2[3]) +
                             (P3[1] * (T3[10] * V2[2] - T3[2] * V2[4]) +
                              P3[2] * (T3[2] * V2[3] - T3[6] * V2[2])))))) +
         (P1[1] * (P2[0] * (P3[1] * (T3[11] * V2[5] - T3[15] * V2[4]) +
                            (P3[2] * (T3[15] * V2[3] - T3[7] * V2[5]) +
                             P3[3] * (T3[7] * V2[4] - T3[11] * V2[3]))) +
                   (P2[1] * (P3[0] * (T3[15] * V2[4] - T3[11] * V2[5]) +
                             (P3[2] * (T3[3] * V2[5] - T3[15] * V2[2]) +
                              P3[3] * (T3[11] * V2[2] - T3[3] * V2[4]))) +
                    (P2[2] * (P3[0] * (T3[7] * V2[5] - T3[15] * V2[3]) +
                              (P3[1] * (T3[15] * V2[2] - T3[3] * V2[5]) +
                               P3[3] * (T3[3] * V2[3] - T3[7] * V2[2]))) +
                     P2[3] * (P3[0] * (T3[11] * V2[3] - T3[7] * V2[4]) +
                              (P3[1] * (T3[3] * V2[4] - T3[11] * V2[2]) +
                               P3[2] * (T3[7] * V2[2] - T3[3] * V2[3])))))) +
          (P1[2] * (P2[0] * (P3[1] * (T3[12] * V2[5] - T3[16] * V2[4]) +
                             (P3[2] * (T3[16] * V2[3] - T3[8] * V2[5]) +
                              P3[3] * (T3[8] * V2[4] - T3[12] * V2[3]))) +
                    (P2[1] * (P3[0] * (T3[16] * V2[4] - T3[12] * V2[5]) +
                              (P3[2] * (T3[4] * V2[5] - T3[16] * V2[2]) +
                               P3[3] * (T3[12] * V2[2] - T3[4] * V2[4]))) +
                     (P2[2] * (P3[0] * (T3[8] * V2[5] - T3[16] * V2[3]) +
                               (P3[1] * (T3[16] * V2[2] - T3[4] * V2[5]) +
                                P3[3] * (T3[4] * V2[3] - T3[8] * V2[2]))) +
                      P2[3] * (P3[0] * (T3[12] * V2[3] - T3[8] * V2[4]) +
                               (P3[1] * (T3[4] * V2[4] - T3[12] * V2[2]) +
                                P3[2] * (T3[8] * V2[2] - T3[4] * V2[3])))))) +
           P1[3] * (P2[0] * (P3[1] * (T3[13] * V2[5] - T3[17] * V2[4]) +
                             (P3[2] * (T3[17] * V2[3] - T3[9] * V2[5]) +
                              P3[3] * (T3[9] * V2[4] - T3[13] * V2[3]))) +
                    (P2[1] * (P3[0] * (T3[17] * V2[4] - T3[13] * V2[5]) +
                              (P3[2] * (T3[5] * V2[5] - T3[17] * V2[2]) +
                               P3[3] * (T3[13] * V2[2] - T3[5] * V2[4]))) +
                     (P2[2] * (P3[0] * (T3[9] * V2[5] - T3[17] * V2[3]) +
                               (P3[1] * (T3[17] * V2[2] - T3[5] * V2[5]) +
                                P3[3] * (T3[5] * V2[3] - T3[9] * V2[2]))) +
                      P2[3] * (P3[0] * (T3[13] * V2[3] - T3[9] * V2[4]) +
                               (P3[1] * (T3[5] * V2[4] - T3[13] * V2[2]) +
                                P3[2] * (T3[9] * V2[2] - T3[5] * V2[3])))))))));
    TMP23 =
        -1. *
        (P1[0] * (P2[0] * (P3[1] * (T3[5] * V2[4] - T3[4] * V2[5]) +
                           (P3[2] * (T3[3] * V2[5] - T3[5] * V2[3]) +
                            P3[3] * (T3[4] * V2[3] - T3[3] * V2[4]))) +
                  (P2[1] * (P3[0] * (T3[4] * V2[5] - T3[5] * V2[4]) +
                            (P3[2] * (T3[5] * V2[2] - T3[2] * V2[5]) +
                             P3[3] * (T3[2] * V2[4] - T3[4] * V2[2]))) +
                   (P2[2] * (P3[0] * (T3[5] * V2[3] - T3[3] * V2[5]) +
                             (P3[1] * (T3[2] * V2[5] - T3[5] * V2[2]) +
                              P3[3] * (T3[3] * V2[2] - T3[2] * V2[3]))) +
                    P2[3] * (P3[0] * (T3[3] * V2[4] - T3[4] * V2[3]) +
                             (P3[1] * (T3[4] * V2[2] - T3[2] * V2[4]) +
                              P3[2] * (T3[2] * V2[3] - T3[3] * V2[2])))))) +
         (P1[1] * (P2[0] * (P3[1] * (T3[8] * V2[5] - T3[9] * V2[4]) +
                            (P3[2] * (T3[9] * V2[3] - T3[7] * V2[5]) +
                             P3[3] * (T3[7] * V2[4] - T3[8] * V2[3]))) +
                   (P2[1] * (P3[0] * (T3[9] * V2[4] - T3[8] * V2[5]) +
                             (P3[2] * (T3[6] * V2[5] - T3[9] * V2[2]) +
                              P3[3] * (T3[8] * V2[2] - T3[6] * V2[4]))) +
                    (P2[2] * (P3[0] * (T3[7] * V2[5] - T3[9] * V2[3]) +
                              (P3[1] * (T3[9] * V2[2] - T3[6] * V2[5]) +
                               P3[3] * (T3[6] * V2[3] - T3[7] * V2[2]))) +
                     P2[3] * (P3[0] * (T3[8] * V2[3] - T3[7] * V2[4]) +
                              (P3[1] * (T3[6] * V2[4] - T3[8] * V2[2]) +
                               P3[2] * (T3[7] * V2[2] - T3[6] * V2[3])))))) +
          (P1[2] * (P2[0] * (P3[1] * (T3[12] * V2[5] - T3[13] * V2[4]) +
                             (P3[2] * (T3[13] * V2[3] - T3[11] * V2[5]) +
                              P3[3] * (T3[11] * V2[4] - T3[12] * V2[3]))) +
                    (P2[1] * (P3[0] * (T3[13] * V2[4] - T3[12] * V2[5]) +
                              (P3[2] * (T3[10] * V2[5] - T3[13] * V2[2]) +
                               P3[3] * (T3[12] * V2[2] - T3[10] * V2[4]))) +
                     (P2[2] * (P3[0] * (T3[11] * V2[5] - T3[13] * V2[3]) +
                               (P3[1] * (T3[13] * V2[2] - T3[10] * V2[5]) +
                                P3[3] * (T3[10] * V2[3] - T3[11] * V2[2]))) +
                      P2[3] * (P3[0] * (T3[12] * V2[3] - T3[11] * V2[4]) +
                               (P3[1] * (T3[10] * V2[4] - T3[12] * V2[2]) +
                                P3[2] * (T3[11] * V2[2] - T3[10] * V2[3])))))) +
           P1[3] *
               (P2[0] * (P3[1] * (T3[16] * V2[5] - T3[17] * V2[4]) +
                         (P3[2] * (T3[17] * V2[3] - T3[15] * V2[5]) +
                          P3[3] * (T3[15] * V2[4] - T3[16] * V2[3]))) +
                (P2[1] * (P3[0] * (T3[17] * V2[4] - T3[16] * V2[5]) +
                          (P3[2] * (T3[14] * V2[5] - T3[17] * V2[2]) +
                           P3[3] * (T3[16] * V2[2] - T3[14] * V2[4]))) +
                 (P2[2] * (P3[0] * (T3[15] * V2[5] - T3[17] * V2[3]) +
                           (P3[1] * (T3[17] * V2[2] - T3[14] * V2[5]) +
                            P3[3] * (T3[14] * V2[3] - T3[15] * V2[2]))) +
                  P2[3] * (P3[0] * (T3[16] * V2[3] - T3[15] * V2[4]) +
                           (P3[1] * (T3[14] * V2[4] - T3[16] * V2[2]) +
                            P3[2] * (T3[15] * V2[2] - T3[14] * V2[3])))))))));
    TMP28 =
        -1. *
        (P1[0] * (P2[0] * (P3[1] * (T3[14] * V1[4] - T3[10] * V1[5]) +
                           (P3[2] * (T3[6] * V1[5] - T3[14] * V1[3]) +
                            P3[3] * (T3[10] * V1[3] - T3[6] * V1[4]))) +
                  (P2[1] * (P3[0] * (T3[10] * V1[5] - T3[14] * V1[4]) +
                            (P3[2] * (T3[14] * V1[2] - T3[2] * V1[5]) +
                             P3[3] * (T3[2] * V1[4] - T3[10] * V1[2]))) +
                   (P2[2] * (P3[0] * (T3[14] * V1[3] - T3[6] * V1[5]) +
                             (P3[1] * (T3[2] * V1[5] - T3[14] * V1[2]) +
                              P3[3] * (T3[6] * V1[2] - T3[2] * V1[3]))) +
                    P2[3] * (P3[0] * (T3[6] * V1[4] - T3[10] * V1[3]) +
                             (P3[1] * (T3[10] * V1[2] - T3[2] * V1[4]) +
                              P3[2] * (T3[2] * V1[3] - T3[6] * V1[2])))))) +
         (P1[1] * (P2[0] * (P3[1] * (T3[11] * V1[5] - T3[15] * V1[4]) +
                            (P3[2] * (T3[15] * V1[3] - T3[7] * V1[5]) +
                             P3[3] * (T3[7] * V1[4] - T3[11] * V1[3]))) +
                   (P2[1] * (P3[0] * (T3[15] * V1[4] - T3[11] * V1[5]) +
                             (P3[2] * (T3[3] * V1[5] - T3[15] * V1[2]) +
                              P3[3] * (T3[11] * V1[2] - T3[3] * V1[4]))) +
                    (P2[2] * (P3[0] * (T3[7] * V1[5] - T3[15] * V1[3]) +
                              (P3[1] * (T3[15] * V1[2] - T3[3] * V1[5]) +
                               P3[3] * (T3[3] * V1[3] - T3[7] * V1[2]))) +
                     P2[3] * (P3[0] * (T3[11] * V1[3] - T3[7] * V1[4]) +
                              (P3[1] * (T3[3] * V1[4] - T3[11] * V1[2]) +
                               P3[2] * (T3[7] * V1[2] - T3[3] * V1[3])))))) +
          (P1[2] * (P2[0] * (P3[1] * (T3[12] * V1[5] - T3[16] * V1[4]) +
                             (P3[2] * (T3[16] * V1[3] - T3[8] * V1[5]) +
                              P3[3] * (T3[8] * V1[4] - T3[12] * V1[3]))) +
                    (P2[1] * (P3[0] * (T3[16] * V1[4] - T3[12] * V1[5]) +
                              (P3[2] * (T3[4] * V1[5] - T3[16] * V1[2]) +
                               P3[3] * (T3[12] * V1[2] - T3[4] * V1[4]))) +
                     (P2[2] * (P3[0] * (T3[8] * V1[5] - T3[16] * V1[3]) +
                               (P3[1] * (T3[16] * V1[2] - T3[4] * V1[5]) +
                                P3[3] * (T3[4] * V1[3] - T3[8] * V1[2]))) +
                      P2[3] * (P3[0] * (T3[12] * V1[3] - T3[8] * V1[4]) +
                               (P3[1] * (T3[4] * V1[4] - T3[12] * V1[2]) +
                                P3[2] * (T3[8] * V1[2] - T3[4] * V1[3])))))) +
           P1[3] * (P2[0] * (P3[1] * (T3[13] * V1[5] - T3[17] * V1[4]) +
                             (P3[2] * (T3[17] * V1[3] - T3[9] * V1[5]) +
                              P3[3] * (T3[9] * V1[4] - T3[13] * V1[3]))) +
                    (P2[1] * (P3[0] * (T3[17] * V1[4] - T3[13] * V1[5]) +
                              (P3[2] * (T3[5] * V1[5] - T3[17] * V1[2]) +
                               P3[3] * (T3[13] * V1[2] - T3[5] * V1[4]))) +
                     (P2[2] * (P3[0] * (T3[9] * V1[5] - T3[17] * V1[3]) +
                               (P3[1] * (T3[17] * V1[2] - T3[5] * V1[5]) +
                                P3[3] * (T3[5] * V1[3] - T3[9] * V1[2]))) +
                      P2[3] * (P3[0] * (T3[13] * V1[3] - T3[9] * V1[4]) +
                               (P3[1] * (T3[5] * V1[4] - T3[13] * V1[2]) +
                                P3[2] * (T3[9] * V1[2] - T3[5] * V1[3])))))))));
    TMP29 =
        -1. *
        (P2[0] * (P1[0] * (P3[1] * (T3[14] * V2[4] - T3[10] * V2[5]) +
                           (P3[2] * (T3[6] * V2[5] - T3[14] * V2[3]) +
                            P3[3] * (T3[10] * V2[3] - T3[6] * V2[4]))) +
                  (P1[1] * (P3[0] * (T3[10] * V2[5] - T3[14] * V2[4]) +
                            (P3[2] * (T3[14] * V2[2] - T3[2] * V2[5]) +
                             P3[3] * (T3[2] * V2[4] - T3[10] * V2[2]))) +
                   (P1[2] * (P3[0] * (T3[14] * V2[3] - T3[6] * V2[5]) +
                             (P3[1] * (T3[2] * V2[5] - T3[14] * V2[2]) +
                              P3[3] * (T3[6] * V2[2] - T3[2] * V2[3]))) +
                    P1[3] * (P3[0] * (T3[6] * V2[4] - T3[10] * V2[3]) +
                             (P3[1] * (T3[10] * V2[2] - T3[2] * V2[4]) +
                              P3[2] * (T3[2] * V2[3] - T3[6] * V2[2])))))) +
         (P2[1] * (P1[0] * (P3[1] * (T3[11] * V2[5] - T3[15] * V2[4]) +
                            (P3[2] * (T3[15] * V2[3] - T3[7] * V2[5]) +
                             P3[3] * (T3[7] * V2[4] - T3[11] * V2[3]))) +
                   (P1[1] * (P3[0] * (T3[15] * V2[4] - T3[11] * V2[5]) +
                             (P3[2] * (T3[3] * V2[5] - T3[15] * V2[2]) +
                              P3[3] * (T3[11] * V2[2] - T3[3] * V2[4]))) +
                    (P1[2] * (P3[0] * (T3[7] * V2[5] - T3[15] * V2[3]) +
                              (P3[1] * (T3[15] * V2[2] - T3[3] * V2[5]) +
                               P3[3] * (T3[3] * V2[3] - T3[7] * V2[2]))) +
                     P1[3] * (P3[0] * (T3[11] * V2[3] - T3[7] * V2[4]) +
                              (P3[1] * (T3[3] * V2[4] - T3[11] * V2[2]) +
                               P3[2] * (T3[7] * V2[2] - T3[3] * V2[3])))))) +
          (P2[2] * (P1[0] * (P3[1] * (T3[12] * V2[5] - T3[16] * V2[4]) +
                             (P3[2] * (T3[16] * V2[3] - T3[8] * V2[5]) +
                              P3[3] * (T3[8] * V2[4] - T3[12] * V2[3]))) +
                    (P1[1] * (P3[0] * (T3[16] * V2[4] - T3[12] * V2[5]) +
                              (P3[2] * (T3[4] * V2[5] - T3[16] * V2[2]) +
                               P3[3] * (T3[12] * V2[2] - T3[4] * V2[4]))) +
                     (P1[2] * (P3[0] * (T3[8] * V2[5] - T3[16] * V2[3]) +
                               (P3[1] * (T3[16] * V2[2] - T3[4] * V2[5]) +
                                P3[3] * (T3[4] * V2[3] - T3[8] * V2[2]))) +
                      P1[3] * (P3[0] * (T3[12] * V2[3] - T3[8] * V2[4]) +
                               (P3[1] * (T3[4] * V2[4] - T3[12] * V2[2]) +
                                P3[2] * (T3[8] * V2[2] - T3[4] * V2[3])))))) +
           P2[3] * (P1[0] * (P3[1] * (T3[13] * V2[5] - T3[17] * V2[4]) +
                             (P3[2] * (T3[17] * V2[3] - T3[9] * V2[5]) +
                              P3[3] * (T3[9] * V2[4] - T3[13] * V2[3]))) +
                    (P1[1] * (P3[0] * (T3[17] * V2[4] - T3[13] * V2[5]) +
                              (P3[2] * (T3[5] * V2[5] - T3[17] * V2[2]) +
                               P3[3] * (T3[13] * V2[2] - T3[5] * V2[4]))) +
                     (P1[2] * (P3[0] * (T3[9] * V2[5] - T3[17] * V2[3]) +
                               (P3[1] * (T3[17] * V2[2] - T3[5] * V2[5]) +
                                P3[3] * (T3[5] * V2[3] - T3[9] * V2[2]))) +
                      P1[3] * (P3[0] * (T3[13] * V2[3] - T3[9] * V2[4]) +
                               (P3[1] * (T3[5] * V2[4] - T3[13] * V2[2]) +
                                P3[2] * (T3[9] * V2[2] - T3[5] * V2[3])))))))));
    TMP14 = (V2[2] * P3[0] - V2[3] * P3[1] - V2[4] * P3[2] - V2[5] * P3[3]);
    TMP17 = (V1[2] * P3[0] - V1[3] * P3[1] - V1[4] * P3[2] - V1[5] * P3[3]);
    TMP30 =
        -1. *
        (P2[0] * (P1[0] * (P3[1] * (T3[14] * V1[4] - T3[10] * V1[5]) +
                           (P3[2] * (T3[6] * V1[5] - T3[14] * V1[3]) +
                            P3[3] * (T3[10] * V1[3] - T3[6] * V1[4]))) +
                  (P1[1] * (P3[0] * (T3[10] * V1[5] - T3[14] * V1[4]) +
                            (P3[2] * (T3[14] * V1[2] - T3[2] * V1[5]) +
                             P3[3] * (T3[2] * V1[4] - T3[10] * V1[2]))) +
                   (P1[2] * (P3[0] * (T3[14] * V1[3] - T3[6] * V1[5]) +
                             (P3[1] * (T3[2] * V1[5] - T3[14] * V1[2]) +
                              P3[3] * (T3[6] * V1[2] - T3[2] * V1[3]))) +
                    P1[3] * (P3[0] * (T3[6] * V1[4] - T3[10] * V1[3]) +
                             (P3[1] * (T3[10] * V1[2] - T3[2] * V1[4]) +
                              P3[2] * (T3[2] * V1[3] - T3[6] * V1[2])))))) +
         (P2[1] * (P1[0] * (P3[1] * (T3[11] * V1[5] - T3[15] * V1[4]) +
                            (P3[2] * (T3[15] * V1[3] - T3[7] * V1[5]) +
                             P3[3] * (T3[7] * V1[4] - T3[11] * V1[3]))) +
                   (P1[1] * (P3[0] * (T3[15] * V1[4] - T3[11] * V1[5]) +
                             (P3[2] * (T3[3] * V1[5] - T3[15] * V1[2]) +
                              P3[3] * (T3[11] * V1[2] - T3[3] * V1[4]))) +
                    (P1[2] * (P3[0] * (T3[7] * V1[5] - T3[15] * V1[3]) +
                              (P3[1] * (T3[15] * V1[2] - T3[3] * V1[5]) +
                               P3[3] * (T3[3] * V1[3] - T3[7] * V1[2]))) +
                     P1[3] * (P3[0] * (T3[11] * V1[3] - T3[7] * V1[4]) +
                              (P3[1] * (T3[3] * V1[4] - T3[11] * V1[2]) +
                               P3[2] * (T3[7] * V1[2] - T3[3] * V1[3])))))) +
          (P2[2] * (P1[0] * (P3[1] * (T3[12] * V1[5] - T3[16] * V1[4]) +
                             (P3[2] * (T3[16] * V1[3] - T3[8] * V1[5]) +
                              P3[3] * (T3[8] * V1[4] - T3[12] * V1[3]))) +
                    (P1[1] * (P3[0] * (T3[16] * V1[4] - T3[12] * V1[5]) +
                              (P3[2] * (T3[4] * V1[5] - T3[16] * V1[2]) +
                               P3[3] * (T3[12] * V1[2] - T3[4] * V1[4]))) +
                     (P1[2] * (P3[0] * (T3[8] * V1[5] - T3[16] * V1[3]) +
                               (P3[1] * (T3[16] * V1[2] - T3[4] * V1[5]) +
                                P3[3] * (T3[4] * V1[3] - T3[8] * V1[2]))) +
                      P1[3] * (P3[0] * (T3[12] * V1[3] - T3[8] * V1[4]) +
                               (P3[1] * (T3[4] * V1[4] - T3[12] * V1[2]) +
                                P3[2] * (T3[8] * V1[2] - T3[4] * V1[3])))))) +
           P2[3] * (P1[0] * (P3[1] * (T3[13] * V1[5] - T3[17] * V1[4]) +
                             (P3[2] * (T3[17] * V1[3] - T3[9] * V1[5]) +
                              P3[3] * (T3[9] * V1[4] - T3[13] * V1[3]))) +
                    (P1[1] * (P3[0] * (T3[17] * V1[4] - T3[13] * V1[5]) +
                              (P3[2] * (T3[5] * V1[5] - T3[17] * V1[2]) +
                               P3[3] * (T3[13] * V1[2] - T3[5] * V1[4]))) +
                     (P1[2] * (P3[0] * (T3[9] * V1[5] - T3[17] * V1[3]) +
                               (P3[1] * (T3[17] * V1[2] - T3[5] * V1[5]) +
                                P3[3] * (T3[5] * V1[3] - T3[9] * V1[2]))) +
                      P1[3] * (P3[0] * (T3[13] * V1[3] - T3[9] * V1[4]) +
                               (P3[1] * (T3[5] * V1[4] - T3[13] * V1[2]) +
                                P3[2] * (T3[9] * V1[2] - T3[5] * V1[3])))))))));
...
void FFT1_2_3_5_0(complex<double> F1[], complex<double> F2[],
                  complex<double> T3[], complex<double> COUP1,
                  complex<double> COUP2, complex<double> COUP3,
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    TMP10 = (P1[0] * -1. * (T3[6] * P2[1] + T3[10] * P2[2] + T3[14] * P2[3] -
             ...
             (P1[1] * (T3[7] * P2[1] + T3[11] * P2[2] + T3[15] * P2[3] -
              ...
              (P1[2] * (T3[8] * P2[1] + T3[12] * P2[2] + T3[16] * P2[3] -
               ...
               P1[3] * (T3[9] * P2[1] + T3[13] * P2[2] + T3[17] * P2[3] -
                        T3[5] * P2[0]))));
    TMP35 = -1. * (P1[0] * (P2[1] * (V2[4] * V1[5] - V2[5] * V1[4]) +
    ...
    TMP36 = -1. * (P1[0] * (P2[1] * (V2[5] * V1[4] - V2[4] * V1[5]) +
    ...
    vertex = COUP * (TMP10 * (-cI * (TMP36) + cI * (TMP35)) +
                     TMP11 * (-cI * (TMP36) + cI * (TMP35)));
}
             ...
             double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] =
        denom * (TMP9 * (TMP12 * (OM1 * P1[0] * (-cI * (TMP29 + TMP32) +
                                                 cI * (TMP35 + TMP36)) +
                                  (V2[3] * (+cI * (T3[6] + T3[3])) +
                                   (V2[4] * (+cI * (T3[10] + T3[4])) +
                                    (V2[5] * (+cI * (T3[14] + T3[5])) -
                                     2. * cI * (T3[2] * V2[2]))))) +
                         TMP38 * (OM1 * P1[0] * (-cI * (TMP34) + cI * (TMP13)) +
                                  (P2[1] * -1. * (+cI * (T3[3] + T3[6])) +
                                   (P2[2] * -1. * (+cI * (T3[4] + T3[10])) +
                                    (P2[3] * -1. * (+cI * (T3[5] + T3[14])) +
                                     2. * cI * (P2[0] * T3[2])))))) +
                 P3[0] * (TMP12 * (+cI * (TMP29 + TMP32)) -
                          TMP38 * (+cI * (TMP13 + TMP15))));
    V1[3] =
        denom * (TMP9 * (TMP12 * (OM1 * P1[1] * (-cI * (TMP29 + TMP32) +
                                                 cI * (TMP35 + TMP36)) +
                                  (V2[2] * -1. * (+cI * (T3[3] + T3[6])) +
                                   (V2[4] * (+cI * (T3[11] + T3[8])) +
                                    (V2[5] * (+cI * (T3[15] + T3[9])) +
                                     2. * cI * (T3[7] * V2[3]))))) +
                         TMP38 * (OM1 * P1[1] * (-cI * (TMP34) + cI * (TMP13)) +
                                  (P2[0] * (+cI * (T3[6] + T3[3])) +
                                   (P2[2] * -1. * (+cI * (T3[8] + T3[11])) +
                                    (P2[3] * -1. * (+cI * (T3[9] + T3[15])) -
                                     2. * cI * (P2[1] * T3[7])))))) +
                 P3[1] * (TMP12 * (+cI * (TMP29 + TMP32)) -
                          TMP38 * (+cI * (TMP13 + TMP15))));
    V1[4] =
        denom * (TMP9 * (TMP12 * (OM1 * P1[2] * (-cI * (TMP29 + TMP32) +
                                                 cI * (TMP35 + TMP36)) +
                                  (V2[2] * -1. * (+cI * (T3[4] + T3[10])) +
                                   (V2[3] * (+cI * (T3[8] + T3[11])) +
                                    (V2[5] * (+cI * (T3[16] + T3[13])) +
                                     2. * cI * (T3[12] * V2[4]))))) +
                         TMP38 * (OM1 * P1[2] * (-cI * (TMP34) + cI * (TMP13)) +
                                  (P2[0] * (+cI * (T3[10] + T3[4])) +
                                   (P2[1] * -1. * (+cI * (T3[11] + T3[8])) +
                                    (P2[3] * -1. * (+cI * (T3[13] + T3[16])) -
                                     2. * cI * (P2[2] * T3[12])))))) +
                 P3[2] * (TMP12 * (+cI * (TMP29 + TMP32)) -
                          TMP38 * (+cI * (TMP13 + TMP15))));
    V1[5] =
        denom * (TMP9 * (TMP12 * (OM1 * P1[3] * (-cI * (TMP29 + TMP32) +
                                                 cI * (TMP35 + TMP36)) +
                                  (V2[2] * -1. * (+cI * (T3[5] + T3[14])) +
                                   (V2[3] * (+cI * (T3[9] + T3[15])) +
                                    (V2[4] * (+cI * (T3[13] + T3[16])) +
                                     2. * cI * (T3[17] * V2[5]))))) +
                         TMP38 * (OM1 * P1[3] * (-cI * (TMP34) + cI * (TMP13)) +
                                  (P2[0] * (+cI * (T3[14] + T3[5])) +
                                   (P2[1] * -1. * (+cI * (T3[15] + T3[9])) +
                                    (P2[2] * -1. * (+cI * (T3[16] + T3[13])) -
                                     2. * cI * (P2[3] * T3[17])))))) +
                 P3[3] * (TMP12 * (+cI * (TMP29 + TMP32)) -
                          TMP38 * (+cI * (TMP13 + TMP15))));
}
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    P2[2] = F2[1].imag();
    P2[3] = F2[0].imag();
    TMP5 = -1. * (P2[0] * (F1[2] * (F2[4] * (T3[2] + T3[14]) +
                                    F2[5] * (T3[6] + cI * (T3[10]))) +
                           (F1[3] * (F2[4] * (T3[6] - cI * (T3[10])) +
                                     F2[5] * (T3[2] - T3[14])) +
                            (F1[4] * (F2[2] * (T3[14] - T3[2]) +
                                      F2[3] * (T3[6] + cI * (T3[10]))) +
                             F1[5] * (F2[2] * (T3[6] - cI * (T3[10])) -
                                      F2[3] * (T3[2] + T3[14]))))) +
                  (P2[1] * (F1[2] * (F2[4] * -1. * (T3[3] + T3[15]) -
                                     F2[5] * (T3[7] + cI * (T3[11]))) +
                            (F1[3] * (F2[4] * (+cI * (T3[11]) - T3[7]) +
                                      F2[5] * (T3[15] - T3[3])) +
                             (F1[4] * (F2[2] * (T3[3] - T3[15]) -
                                       F2[3] * (T3[7] + cI * (T3[11]))) +
                              F1[5] * (F2[2] * (+cI * (T3[11]) - T3[7]) +
                                       F2[3] * (T3[3] + T3[15]))))) +
                   (P2[2] * (F1[2] * (F2[4] * -1. * (T3[4] + T3[16]) -
                                      F2[5] * (T3[8] + cI * (T3[12]))) +
                             (F1[3] * (F2[4] * (+cI * (T3[12]) - T3[8]) +
                                       F2[5] * (T3[16] - T3[4])) +
                              (F1[4] * (F2[2] * (T3[4] - T3[16]) -
                                        F2[3] * (T3[8] + cI * (T3[12]))) +
                               F1[5] * (F2[2] * (+cI * (T3[12]) - T3[8]) +
                                        F2[3] * (T3[4] + T3[16]))))) +
                    P2[3] * (F1[2] * (F2[4] * -1. * (T3[5] + T3[17]) -
                                      F2[5] * (T3[9] + cI * (T3[13]))) +
                             (F1[3] * (F2[4] * (+cI * (T3[13]) - T3[9]) +
                                       F2[5] * (T3[17] - T3[5])) +
                              (F1[4] * (F2[2] * (T3[5] - T3[17]) -
                                        F2[3] * (T3[9] + cI * (T3[13]))) +
                               F1[5] * (F2[2] * (+cI * (T3[13]) - T3[9]) +
                                        F2[3] * (T3[5] + T3[17]))))))));
    TMP4 = -1. * (P1[0] * (F1[2] * (F2[4] * (T3[2] + T3[14]) +
                                    F2[5] * (T3[6] + cI * (T3[10]))) +
                           (F1[3] * (F2[4] * (T3[6] - cI * (T3[10])) +
                                     F2[5] * (T3[2] - T3[14])) +
                            (F1[4] * (F2[2] * (T3[14] - T3[2]) +
                    ...
                    P1[3] * (F1[2] * (F2[4] * -1. * (T3[5] + T3[17]) -
                             ...
                             (F1[3] * (F2[4] * (+cI * (T3[13]) - T3[9]) +
                              ...
                              (F1[4] * (F2[2] * (T3[5] - T3[17]) -
                               ...
                               F1[5] * (F2[2] * (+cI * (T3[13]) - T3[9]) +
                                        F2[3] * (T3[5] + T3[17]))))))));
    TMP7 = -1. * (P2[0] * (F1[2] * (F2[4] * (T3[2] + T3[5]) +
                                    F2[5] * (T3[3] + cI * (T3[4]))) +
                           (F1[3] * (F2[4] * (T3[3] - cI * (T3[4])) +
                                     F2[5] * (T3[2] - T3[5])) +
                            (F1[4] * (F2[2] * (T3[5] - T3[2]) +
                                      F2[3] * (T3[3] + cI * (T3[4]))) +
                             F1[5] * (F2[2] * (T3[3] - cI * (T3[4])) -
                                      F2[3] * (T3[2] + T3[5]))))) +
                  (P2[1] * (F1[2] * (F2[4] * -1. * (T3[6] + T3[9]) -
                                     F2[5] * (T3[7] + cI * (T3[8]))) +
                            (F1[3] * (F2[4] * (+cI * (T3[8]) - T3[7]) +
                             ...
                             (F1[4] * (F2[2] * (T3[6] - T3[9]) -
                                       F2[3] * (T3[7] + cI * (T3[8]))) +
                              F1[5] * (F2[2] * (+cI * (T3[8]) - T3[7]) +
                                       F2[3] * (T3[6] + T3[9]))))) +
                   (P2[2] * (F1[2] * (F2[4] * -1. * (T3[10] + T3[13]) -
                                      F2[5] * (T3[11] + cI * (T3[12]))) +
                             (F1[3] * (F2[4] * (+cI * (T3[12]) - T3[11]) +
                                       F2[5] * (T3[13] - T3[10])) +
                              (F1[4] * (F2[2] * (T3[10] - T3[13]) -
                                        F2[3] * (T3[11] + cI * (T3[12]))) +
                               F1[5] * (F2[2] * (+cI * (T3[12]) - T3[11]) +
                                        F2[3] * (T3[10] + T3[13]))))) +
                    P2[3] * (F1[2] * (F2[4] * -1. * (T3[14] + T3[17]) -
                                      F2[5] * (T3[15] + cI * (T3[16]))) +
                             (F1[3] * (F2[4] * (+cI * (T3[16]) - T3[15]) +
                                       F2[5] * (T3[17] - T3[14])) +
                              (F1[4] * (F2[2] * (T3[14] - T3[17]) -
                                        F2[3] * (T3[15] + cI * (T3[16]))) +
                               F1[5] * (F2[2] * (+cI * (T3[16]) - T3[15]) +
                                        F2[3] * (T3[14] + T3[17]))))))));
    TMP6 = -1. * (P1[0] * (F1[2] * (F2[4] * (T3[2] + T3[5]) +
                                    F2[5] * (T3[3] + cI * (T3[4]))) +
                           (F1[3] * (F2[4] * (T3[3] - cI * (T3[4])) +
                                     F2[5] * (T3[2] - T3[5])) +
                            (F1[4] * (F2[2] * (T3[5] - T3[2]) +
            ...
            double M1, double W1, complex<double> F1[])
{
    ...
    F1[2] =
        ...
        (F2[3] *
             (P1[0] *
              ...
              (P1[1] * (P1[2] * -1. * (T3[4] + T3[16] + T3[10] + T3[13] +
                       ...
                       (P2[2] * (T3[4] + T3[10] - T3[16] - T3[13]) +
                        (P1[0] * -1. * (T3[14] + T3[5] - 2. * (T3[2])) +
                         (P2[0] * (T3[14] + T3[5] - 2. * (T3[2])) +
                          P2[3] * (T3[5] + T3[14] - 2. * (T3[17]))))))))) +
               (P1[3] * (P1[1] * -1. * (T3[3] + T3[6] + cI * (T3[13] + T3[16]) -
                                        2. * (T3[9] + T3[15])) +
                         (P1[2] * (+2. * (T3[13] + T3[16]) +
                           ...
                           (P2[2] * -1. * (T3[4] + T3[16] + T3[10] + T3[13]) +
                            (P1[0] * -1. * (T3[14] + T3[5] + 2. * (T3[2])) +
                             (P2[0] * (T3[14] + T3[5] + 2. * (T3[2])) -
                              P2[3] * (T3[5] + T3[14] + 2. * (T3[17]))))))))) +
               (P1[3] *
                    (P1[1] * -1. * (T3[3] + T3[6] + 2. * (T3[9] + T3[15]) +
                                    cI * (T3[13] + T3[16])) +
                     (P1[2] * -1. * (T3[4] + T3[10] - cI * (T3[9] + T3[15]) +
                                     2. * (T3[13] + T3[16])) +
                      (P2[1] * (T3[3] + T3[15] + T3[6] + T3[9]) +
                       (P2[2] * (T3[4] + T3[16] + T3[10] + T3[13]) +
                        (P1[3] * -1. * (T3[5] + T3[14] + 2. * (T3[17])) +
    ...
    F1[4] =
        ...
        (F2[5] *
             (P1[0] *
                  (P1[3] * -1. * (T3[9] + T3[6] + T3[15] + T3[3] +
                                  cI * (T3[13] + T3[10] + T3[16] + T3[4])) +
                   (P1[1] * -1. * (+2. * (T3[7] + T3[2]) +
                                   cI * (T3[11] + T3[8]) - T3[14] - T3[5]) +
                    (P1[2] * -1. * (T3[8] + T3[11] - cI * (T3[14] + T3[5]) +
                                    2. * cI * (T3[12] + T3[2])) +
                     (P1[0] * (T3[6] + T3[3] + cI * (T3[10] + T3[4])) +
                      (P2[0] * -1. * (T3[6] + T3[3] + cI * (T3[10] + T3[4])) +
                       (P2[3] * (T3[9] + T3[15] + cI * (T3[13] + T3[16])) +
         ...
         (F2[4] *
              (P1[0] *
                   (P1[1] * -1. * (T3[15] + T3[9] + 2. * (T3[3] + T3[6]) -
                                   cI * (T3[10] + T3[4])) +
                    (P1[2] * -1. * (T3[16] + T3[13] + 2. * (T3[4] + T3[10]) +
                                    cI * (T3[6] + T3[3])) +
                     (P1[3] * -2. * (T3[5] + T3[17] + T3[2] + T3[14]) +
                      (P2[1] * (T3[3] + T3[15] + T3[6] + T3[9]) +
                       (P2[2] * (T3[4] + T3[16] + T3[10] + T3[13]) +
                     ...
                     (P2[0] * (+cI * (T3[10] + T3[4]) - T3[6] - T3[3]) +
                      (P2[3] * (T3[9] + T3[15] - cI * (T3[13] + T3[16])) +
                       (P2[1] * -1. * (+cI * (T3[11] + T3[8]) - 2. * (T3[7])) +
                        P2[2] * (T3[8] + T3[11] - 2. * cI * (T3[12]))))))))) +
         (F2[5] *
              (P1[0] * (P1[1] * -1. * (+2. * (T3[3] + T3[6]) +
                                       cI * (T3[10] + T3[4]) - T3[15] - T3[9]) +
                           ...
                           (P2[2] * (T3[4] + T3[10] - T3[16] - T3[13]) +
                            (P1[0] * -1. * (T3[14] + T3[5] - 2. * (T3[2])) +
                             (P2[0] * (T3[14] + T3[5] - 2. * (T3[2])) +
                              P2[3] * (T3[5] + T3[14] - 2. * (T3[17]))))))))) +
               (P1[3] *
                    (P1[1] * (+2. * (T3[9] + T3[15]) + cI * (T3[13] + T3[16]) -
                              T3[3] - T3[6]) +
                     (P1[2] * -1. * (T3[4] + T3[10] + cI * (T3[9] + T3[15]) -
                                     2. * (T3[13] + T3[16])) +
                      (P2[1] * (T3[3] + T3[6] - T3[15] - T3[9]) +
        ...
        (P1[0] * (P1[1] * (P2[2] * (P3[3] * -1. * (T3[7] + T3[2]) +
         ...
         (P1[1] * (P1[2] * (P2[0] * (P3[3] * (T3[7] - T3[12]) +
          ...
          (P1[2] * (P1[3] * (P2[0] * (P3[1] * (T3[12] - T3[17]) +
           ...
           P1[3] * P1[3] * (P2[0] * (P3[1] * T3[16] - P3[2] * T3[15]) +
        ...
        (P1[0] * (P1[1] * (P2[2] * (P3[3] * -1. * (T3[7] + T3[2]) +
         ...
         (P1[1] * (P1[2] * (P2[0] * (P3[3] * (T3[7] - T3[12]) +
          ...
          (P1[2] * (P1[3] * (P2[0] * (P3[1] * (T3[12] - T3[17]) +
           ...
           P1[3] * P1[3] * (P2[0] * (P3[1] * T3[13] - P3[2] * T3[9]) +
                     ...
                     (P1[2] * (P2[0] * (+cI * (T3[3] + T3[6])) +
                      ...
                      (P1[0] * (P2[1] * -1. * (+cI * (T3[4] + T3[10])) +
                       ...
                       P1[3] * (P2[1] * (+cI * (T3[16] + T3[13])) -
                                P2[2] * (+cI * (T3[15] + T3[9])))))) +
                OM1 * P1[0] * (+cI * (TMP63 + TMP64))))) +
         (OM1 * P1[0] * TMP9 * (+cI * (TMP55 + TMP57 + TMP59 + TMP61)) -
          P3[0] * (+cI * (TMP55 + TMP57 + TMP59 + TMP61))));
    V1[3] =
        denom *
        (TMP38 *
             (P3[0] *
                         ...
                         (P1[2] * (P2[0] * 2. * (+cI * (T3[12] + T3[2])) +
                          ...
                          (P1[1] * (P2[0] * (+cI * (T3[8] + T3[11])) -
                           ...
                           P1[3] * (P2[0] * (+cI * (T3[16] + T3[13])) -
                                    P2[2] * (+cI * (T3[14] + T3[5])))))) +
                OM1 * P1[1] * (+cI * (TMP63 + TMP64))))) +
         (OM1 * P1[1] * TMP9 * (+cI * (TMP55 + TMP57 + TMP59 + TMP61)) -
          P3[1] * (+cI * (TMP55 + TMP57 + TMP59 + TMP61))));
    V1[4] =
        denom *
        (TMP38 *
                         ...
                         (P1[1] * (P2[0] * -2. * (+cI * (T3[7] + T3[2])) +
                          ...
                          (P1[2] * (P2[0] * -1. * (+cI * (T3[11] + T3[8])) +
                           ...
                           P1[3] * (P2[0] * -1. * (+cI * (T3[15] + T3[9])) +
                                    P2[1] * (+cI * (T3[14] + T3[5])))))) +
                OM1 * P1[2] * (+cI * (TMP63 + TMP64))))) +
         (OM1 * P1[2] * TMP9 * (+cI * (TMP55 + TMP57 + TMP59 + TMP61)) -
          P3[2] * (+cI * (TMP55 + TMP57 + TMP59 + TMP61))));
    V1[5] =
        denom *
        (TMP38 *
                         ...
                         (P1[1] * (P2[0] * 2. * (+cI * (T3[7] + T3[2])) +
                          ...
                          (P1[2] * (P2[0] * (+cI * (T3[11] + T3[8])) -
                           ...
                           P1[3] * (P2[0] * (+cI * (T3[15] + T3[9])) -
                                    P2[1] * (+cI * (T3[14] + T3[5])))))) +
                OM1 * P1[3] * (+cI * (TMP63 + TMP64))))) +
         (OM1 * P1[3] * TMP9 * (+cI * (TMP55 + TMP57 + TMP59 + TMP61)) -
          P3[3] * (+cI * (TMP55 + TMP57 + TMP59 + TMP61))));
}
                       ...
                       (OM3 * (TMP12 * (TMP9 *
                        ...
                        (TMP16 * (TMP25 * -1. / 3. * (-2. * cI * (TMP16) +
                         ...
                         (TMP26 * (TMP30 * 1. / 3. * (+cI * (TMP46 + TMP47)) +
                          ...
                          (TMP25 * -1. / 3. *
                               (+cI * (TMP12 * TMP46 + TMP9 * TMP47)) +
                           1. / 3. * (TMP30 * (+cI * (TMP38 * TMP46 +
                                                      TMP9 * TMP49))))))) +
                   (TMP12 * (TMP26 * (P1[1] * 1. / 2. *
                                          (-cI * (TMP37) + 2. * cI * (TMP30)) +
                                      (-1. / 2. * cI * (TMP9 * V1[3]) +
                                       P2[1] * -1. * (+cI * (TMP30 + TMP37)))) +
                             (+1. / 2. * (V2[3] * (-cI * (TMP9 * TMP30) +
                                                   cI * (TMP16 * TMP37))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[0] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[0] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[0] * (P1[1] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[3] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[1] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[0] * (P2[1] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[3] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[0] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[0] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[0] * (P1[2] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[4] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[2] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[0] * (P2[2] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[4] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[0] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[0] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[0] * (P1[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[5] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[3] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[0] * (P2[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[5] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[1] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[1] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[1] * (P1[2] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[4] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[2] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[1] * (P2[2] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[4] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                     P1[2] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[1] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[1] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[1] * (P1[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[5] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[3] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[1] * (P2[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[5] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                     P1[3] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
                        ...
                        (TMP16 *
                         ...
                         2. * (TMP30 * 1. / 2. *
                               (P2[2] * (-cI * (TMP38) + 2. * cI * (TMP26)) +
                                2. * (P1[2] * -1. *
                                      (+cI * (TMP26 + TMP38))))))))) +
         (P1[2] * (P1[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP12)) +
                            TMP30 * (+cI * (TMP26 + TMP38))) +
                   (+1. / 2. * (V1[5] * (-cI * (TMP16 * TMP38) +
                                         cI * (TMP12 * TMP26))) +
                    P2[3] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
          (P2[2] * (P2[3] * (TMP25 * -1. * (+cI * (TMP16 + TMP9)) +
                             TMP26 * (+cI * (TMP30 + TMP37))) +
                    (+1. / 2. * (V2[5] * (-cI * (TMP16 * TMP37) +
                                          cI * (TMP9 * TMP30))) +
                     P1[3] * (-cI * (TMP26 * TMP30) + cI * (TMP16 * TMP25)))) +
             ...
             double M1, double W1, complex<double> V1[])
{
    ...
    V1[3] =
        denom * cI * (OM1 * P1[1] * (TMP35 + TMP36) +
                      (V2[2] * -1. * (T3[3] + T3[6]) +
                       (V2[4] * (T3[11] + T3[8]) +
                        (V2[5] * (T3[15] + T3[9]) + 2. * (T3[7] * V2[3])))));
    V1[4] =
        denom * cI * (OM1 * P1[2] * (TMP35 + TMP36) +
                      (V2[2] * -1. * (T3[4] + T3[10]) +
                       (V2[3] * (T3[8] + T3[11]) +
                        (V2[5] * (T3[16] + T3[13]) + 2. * (T3[12] * V2[4])))));
    V1[5] =
        denom * cI * (OM1 * P1[3] * (TMP35 + TMP36) +
                      (V2[2] * -1. * (T3[5] + T3[14]) +
                       (V2[3] * (T3[9] + T3[15]) +
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    T3[2] = denom * 2. *
            (OM3 * (P3[0] * (P3[0] * (OM3 * 2. / 3. * TMP12 * TMP9 *
                                          (-cI * (TMP65) + cI * (TMP66)) +
                                      1. / 3. * (TMP16 * (-cI * (TMP65) +
                                                          cI * (TMP66)))) +
    ...
    T3[6] = denom *
            (OM3 * (P3[0] * (P3[1] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                          (-cI * (TMP65) + cI * (TMP66)) +
                                      2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                          cI * (TMP66)))) +
    ...
    T3[10] = denom *
             (OM3 * (P3[0] * (P3[2] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                           (-cI * (TMP65) + cI * (TMP66)) +
                                       2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                           cI * (TMP66)))) +
    ...
    T3[14] = denom *
             (OM3 * (P3[0] * (P3[3] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                           (-cI * (TMP65) + cI * (TMP66)) +
                                       2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                           cI * (TMP66)))) +
    ...
    T3[3] = denom *
            (OM3 * (P3[0] * (P3[1] * (OM3 * 4. / 3. * TMP12 * TMP9 *
             ...
             (P1[0] * P2[1] * (-cI * (TMP65) + cI * (TMP66)) +
              P1[1] * P2[0] * (-cI * (TMP65) + cI * (TMP66))));
    T3[7] = denom * 2. *
            (OM3 * (P3[1] * (P3[1] * (OM3 * 2. / 3. * TMP12 * TMP9 *
                                          (-cI * (TMP65) + cI * (TMP66)) +
                                      1. / 3. * (TMP16 * (-cI * (TMP65) +
                                                          cI * (TMP66)))) +
                             (P1[1] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
    ...
    T3[11] = denom *
             (OM3 * (P3[1] * (P3[2] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                           (-cI * (TMP65) + cI * (TMP66)) +
                                       2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                           cI * (TMP66)))) +
                              (P1[2] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
    ...
    T3[15] = denom *
             (OM3 * (P3[1] * (P3[3] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                           (-cI * (TMP65) + cI * (TMP66)) +
                                       2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                           cI * (TMP66)))) +
                              (P1[3] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
    ...
    T3[12] =
        denom * 2. *
        (OM3 * (P3[2] * (P3[2] * (OM3 * 2. / 3. * TMP12 * TMP9 *
                                      (-cI * (TMP65) + cI * (TMP66)) +
                                  1. / 3. * (TMP16 *
                                             (-cI * (TMP65) + cI * (TMP66)))) +
                         (P1[2] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
         ...
         (P1[2] * P2[2] * (-cI * (TMP65) + cI * (TMP66)) +
          1. / 3. * (TMP16 * (-cI * (TMP65) + cI * (TMP66)))));
    T3[16] = denom *
             (OM3 * (P3[2] * (P3[3] * (OM3 * 4. / 3. * TMP12 * TMP9 *
                                           (-cI * (TMP65) + cI * (TMP66)) +
                                       2. / 3. * (TMP16 * (-cI * (TMP65) +
                                                           cI * (TMP66)))) +
                              (P1[3] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
    ...
    T3[17] =
        denom * 2. *
        (OM3 * (P3[3] * (P3[3] * (OM3 * 2. / 3. * TMP12 * TMP9 *
                                      (-cI * (TMP65) + cI * (TMP66)) +
                                  1. / 3. * (TMP16 *
                                             (-cI * (TMP65) + cI * (TMP66)))) +
                         (P1[3] * TMP12 * (-cI * (TMP66) + cI * (TMP65)) +
             ...
             (P3[0] *
                  (TMP37 *
                   ...
                   TMP38 * (TMP9 * (P2[0] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                            ...
                            2. / 3. * (P3[1] * TMP53))) +
              P3[1] *
                  (TMP12 * TMP37 * (P1[1] * (P3[3] * V2[4] - P3[2] * V2[5]) +
                                    (P1[2] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                                     P1[3] * (P3[2] * V2[3] - P3[1] * V2[4]))) +
                   TMP38 * TMP9 *
             ...
             (P3[1] *
                  (TMP37 *
                   ...
                   TMP38 * (TMP9 * (P2[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                            ...
                            2. / 3. * (P3[2] * TMP53))) +
              P3[2] *
                  (TMP12 * TMP37 * (P1[0] * (P3[3] * V2[4] - P3[2] * V2[5]) +
                                    (P1[2] * (P3[0] * V2[5] - P3[3] * V2[2]) +
                                     P1[3] * (P3[2] * V2[2] - P3[0] * V2[4]))) +
                   TMP38 * TMP9 *
             ...
             (P3[2] *
                  (TMP37 *
                   ...
                   TMP38 * (TMP9 * (P2[0] * (P3[2] * V1[3] - P3[1] * V1[4]) +
                            ...
                            2. / 3. * (P3[3] * TMP53))) +
              P3[3] *
                  (TMP12 * TMP37 * (P1[0] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                                    (P1[1] * (P3[3] * V2[2] - P3[0] * V2[5]) +
                                     P1[3] * (P3[0] * V2[3] - P3[1] * V2[2]))) +
                   TMP38 * TMP9 *
            ...
            double M2, double W2, complex<double> F2[])
{
        ...
        (F1[3] *
             (P2[0] *
                  (P2[3] * (T3[9] + T3[6] + T3[15] + T3[3] -
                            cI * (T3[13] + T3[10] + T3[16] + T3[4])) +
                   (P2[1] * -1. * (T3[14] + T3[5] + cI * (T3[11] + T3[8]) -
                                   2. * (T3[7] + T3[2])) +
                           ...
                           (P2[3] * 2. * (T3[5] + T3[17] + T3[2] + T3[14]) +
                            (P1[0] * (T3[14] + T3[5] + 2. * (T3[2])) +
                             (P1[3] * -1. * (T3[5] + T3[14] + 2. * (T3[17])) -
                              P2[0] * (T3[14] + T3[5] + 2. * (T3[2]))))))))) +
               (P2[3] *
                    (P2[1] * -1. * (T3[3] + T3[6] + 2. * (T3[9] + T3[15]) +
                                    cI * (T3[13] + T3[16])) +
                     (P2[2] * -1. * (T3[4] + T3[10] - cI * (T3[9] + T3[15]) +
                                     2. * (T3[13] + T3[16])) +
                      (P1[1] * (T3[3] + T3[15] + T3[6] + T3[9]) +
                       (P1[2] * (T3[4] + T3[16] + T3[10] + T3[13]) +
                        (P1[0] * -1. * (T3[14] + T3[5] + 2. * (T3[2])) +
                     ...
                     (P1[0] * (T3[6] + T3[3] + cI * (T3[10] + T3[4])) +
                      (P1[3] * -1. * (T3[9] + T3[15] + cI * (T3[13] + T3[16])) +
                       (P2[0] * -1. * (T3[6] + T3[3] + cI * (T3[10] + T3[4])) +
                        (P1[1] * -1. * (+2. * (T3[7]) + cI * (T3[11] + T3[8])) -
                         P1[2] * (T3[8] + T3[11] + 2. * cI * (T3[12]))))))))) +
              (P2[1] * (P2[2] * -1. * (T3[4] + T3[16] + T3[10] + T3[13] +
                                       cI * (T3[3] + T3[15] + T3[6] + T3[9])) +
                     ...
                     (P1[3] * -1. * (T3[9] + T3[15] + cI * (T3[13] + T3[16])) +
                      (P2[3] * (T3[9] + T3[15] + cI * (T3[13] + T3[16])) +
                       (P1[1] * -1. * (+2. * (T3[7]) + cI * (T3[11] + T3[8])) -
                        P1[2] * (T3[8] + T3[11] + 2. * cI * (T3[12]))))))))) +
         (F1[3] *
              (P2[0] * (P2[1] * -1. * (T3[15] + T3[9] + cI * (T3[10] + T3[4]) -
                                       2. * (T3[3] + T3[6])) +
                        (P2[2] * (+2. * (T3[4] + T3[10]) +
                                  cI * (T3[6] + T3[3]) - T3[16] - T3[13]) +
        ...
        (F1[5] *
         ...
         (F1[4] *
              (P2[0] * (P2[1] * (+2. * (T3[3] + T3[6]) + cI * (T3[10] + T3[4]) -
                                 T3[15] - T3[9]) +
                        (P2[2] * -1. * (T3[16] + T3[13] + cI * (T3[6] + T3[3]) -
                                        2. * (T3[4] + T3[10])) +
                         (P1[1] * (T3[15] + T3[9] - T3[3] - T3[6]) +
                          (P1[2] * (T3[16] + T3[13] - T3[4] - T3[10]) +
                           (P2[3] * 2. * (T3[5] + T3[14] - T3[17] - T3[2]) +
    ...
    F2[5] =
        ...
        (F1[4] *
         ...
         (F1[5] *
              (P2[0] *
                   (P2[1] * -1. * (T3[15] + T3[9] + 2. * (T3[3] + T3[6]) -
                                   cI * (T3[10] + T3[4])) +
                    (P2[2] * -1. * (T3[16] + T3[13] + 2. * (T3[4] + T3[10]) +
                                    cI * (T3[6] + T3[3])) +
                     (P1[1] * (T3[3] + T3[15] + T3[6] + T3[9]) +
                      (P1[2] * (T3[4] + T3[16] + T3[10] + T3[13]) +
                       (P2[3] * -2. * (T3[5] + T3[17] + T3[2] + T3[14]) +
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        denom * 2. * cI *
        (OM3 * (P3[0] * (TMP12 * -1. * (F1[2] * F2[4] + F1[3] * F2[5] +
                                        2. / 3. * (P3[0] * OM3 * TMP10) -
                                        F1[4] * F2[2] - F1[5] * F2[3]) +
         ...
         (P1[0] *
          ...
          (P2[0] *
           ...
           (-1. / 3. * (TMP8) + 1. / 3. * (TMP11)))));
    T3[3] = denom * cI *
            (OM3 * (P3[0] * (TMP12 * (F1[2] * F2[5] + F1[3] * F2[4] +
                                      F1[4] * F2[3] + F1[5] * F2[2] -
                                      4. / 3. * (P3[1] * OM3 * TMP10)) +
                             (TMP9 * -1. * (F1[2] * F2[5] + F1[3] * F2[4] +
                                            F1[4] * F2[3] + F1[5] * F2[2] -
                                            4. / 3. * (P3[1] * OM3 * TMP10)) +
                              (P3[1] * 2. / 3. * (TMP8 - TMP11) +
                               TMP10 * (P2[1] - P1[1])))) +
    ...
    T3[4] =
        denom * cI *
        (OM3 * (P3[0] * (TMP12 * -1. * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
          ...
          (F1[3] * (F2[4] * (-cI * (P1[0]) + cI * (P2[0])) +
           ...
           (F1[4] * (F2[2] * (P1[2] - P2[2]) +
            ...
            F1[5] * (F2[2] * (-cI * (P1[0]) + cI * (P2[0])) +
                     F2[3] * (P1[2] - P2[2]))))));
    T3[5] = denom * cI *
            (OM3 * (P3[0] * (TMP12 * -1. * (F1[3] * F2[5] + F1[5] * F2[3] +
                                            4. / 3. * (P3[3] * OM3 * TMP10) -
                                            F1[2] * F2[4] - F1[4] * F2[2]) +
    ...
    T3[8] =
        denom * cI *
        (OM3 * (P3[1] * (TMP12 * -1. * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
                                        cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
                                        4. / 3. * (P3[2] * OM3 * TMP10)) +
                         (TMP9 * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
                                  cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
    ...
    T3[9] = denom * cI *
            (OM3 * (P3[1] * (TMP12 * -1. * (F1[3] * F2[5] + F1[5] * F2[3] +
                                            4. / 3. * (P3[3] * OM3 * TMP10) -
                                            F1[2] * F2[4] - F1[4] * F2[2]) +
                             (TMP9 * (F1[3] * F2[5] + F1[5] * F2[3] +
                                      4. / 3. * (P3[3] * OM3 * TMP10) -
    ...
    T3[12] =
        denom * 2. * cI *
        (OM3 * (P3[2] * (TMP12 * -1. * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
                                        cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
                                        2. / 3. * (P3[2] * OM3 * TMP10)) +
                         (TMP9 * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
                                  cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
         ...
         (P1[2] * (-cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
          ...
          (P2[2] * (-cI * (F1[2] * F2[5] + F1[4] * F2[3]) +
           ...
           (-1. / 3. * (TMP11) + 1. / 3. * (TMP8)))));
    T3[13] = denom * cI *
             (OM3 * (P3[2] * (TMP12 * -1. * (F1[3] * F2[5] + F1[5] * F2[3] +
                                             4. / 3. * (P3[3] * OM3 * TMP10) -
                                             F1[2] * F2[4] - F1[4] * F2[2]) +
                              (TMP9 * (F1[3] * F2[5] + F1[5] * F2[3] +
                                       4. / 3. * (P3[3] * OM3 * TMP10) -
    ...
    T3[17] =
        denom * 2. * cI *
        (OM3 * (P3[3] * (TMP12 * -1. * (F1[3] * F2[5] + F1[5] * F2[3] +
                                        2. / 3. * (P3[3] * OM3 * TMP10) -
                                        F1[2] * F2[4] - F1[4] * F2[2]) +
                         (TMP9 * (F1[3] * F2[5] + F1[5] * F2[3] +
                                  2. / 3. * (P3[3] * OM3 * TMP10) -
         ...
         (P1[1] * (P1[2] * (P3[0] * (V2[5] * (T3[12] - T3[7]) +
          ...
          (P1[2] * (P1[3] * (P3[0] * (V2[3] * (T3[17] - T3[12]) +
                    ...
                    P1[2] * (P3[0] * (T3[16] * V2[3] - T3[8] * V2[5]) +
                             (P3[1] * (T3[4] * V2[5] - T3[16] * V2[2]) +
                              P3[3] * (T3[8] * V2[2] - T3[4] * V2[3])))) +
           P1[3] * P1[3] * (P3[0] * (T3[9] * V2[4] - T3[13] * V2[3]) +
                            (P3[1] * (T3[13] * V2[2] - T3[5] * V2[4]) +
                             P3[2] * (T3[5] * V2[3] - T3[9] * V2[2]))))));
    TMP72 =
        -1. *
         ...
         (P1[1] * (P1[2] * (P3[0] * (V2[5] * (T3[12] - T3[7]) +
          ...
          (P1[2] * (P1[3] * (P3[0] * (V2[3] * (T3[17] - T3[12]) +
                    ...
                    P1[2] * (P3[0] * (T3[13] * V2[3] - T3[11] * V2[5]) +
                             (P3[1] * (T3[10] * V2[5] - T3[13] * V2[2]) +
                              P3[3] * (T3[11] * V2[2] - T3[10] * V2[3])))) +
           P1[3] * P1[3] * (P3[0] * (T3[15] * V2[4] - T3[16] * V2[3]) +
                            (P3[1] * (T3[16] * V2[2] - T3[14] * V2[4]) +
                             P3[2] * (T3[14] * V2[3] - T3[15] * V2[2]))))));
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
             ...
             double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        ...
        (OM3 *
             (P3[0] *
                  (P3[0] * (OM3 * (TMP12 * 2. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   2. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-2. / 3. * cI * (TMP26 * TMP30) +
                             2. / 3. * cI * (TMP16 * TMP25))) +
    ...
    T3[6] =
        ...
        (OM3 *
             (P3[0] *
                  (P3[1] * (OM3 * (TMP12 * 4. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   4. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-4. / 3. * cI * (TMP26 * TMP30) +
                             4. / 3. * cI * (TMP16 * TMP25))) +
    ...
    T3[10] =
        ...
        (OM3 *
             (P3[0] *
                  (P3[2] * (OM3 * (TMP12 * 4. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   4. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-4. / 3. * cI * (TMP26 * TMP30) +
    ...
    T3[14] =
        ...
        (OM3 *
             (P3[0] *
                  (P3[3] * (OM3 * (TMP12 * 4. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   4. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-4. / 3. * cI * (TMP26 * TMP30) +
    ...
    T3[7] =
        ...
        (OM3 *
             (P3[1] *
                  (P3[1] * (OM3 * (TMP12 * 2. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   2. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-2. / 3. * cI * (TMP26 * TMP30) +
    ...
    T3[12] =
        ...
        (OM3 *
             (P3[2] *
                  (P3[2] * (OM3 * (TMP12 * 2. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   2. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-2. / 3. * cI * (TMP26 * TMP30) +
    ...
    T3[17] =
        ...
        (OM3 *
             (P3[3] *
                  (P3[3] * (OM3 * (TMP12 * 2. / 3. * (-cI * (TMP26 * TMP37) +
                                                      cI * (TMP9 * TMP25)) +
                                   2. / 3. * (TMP38 * (-cI * (TMP9 * TMP30) +
                                                       cI * (TMP16 * TMP37)))) +
                            (-2. / 3. * cI * (TMP26 * TMP30) +
            ...
            (TMP13 * (P1[1] * (P2[3] * V2[4] - P2[2] * V2[5]) +
             ...
             TMP15 * (P1[1] * (P2[3] * V2[4] - P2[2] * V2[5]) +
                      (P1[2] * (P2[1] * V2[5] - P2[3] * V2[3]) +
                       P1[3] * (P2[2] * V2[3] - P2[1] * V2[4]))));
    V1[3] =
        denom * 2. * cI * (TMP13 * (P1[0] * (P2[2] * V2[5] - P2[3] * V2[4]) +
                           ...
                           TMP15 * (P1[0] * (P2[2] * V2[5] - P2[3] * V2[4]) +
                                    (P1[2] * (P2[3] * V2[2] - P2[0] * V2[5]) +
                                     P1[3] * (P2[0] * V2[4] - P2[2] * V2[2]))));
    V1[4] =
        denom * 2. * cI * (TMP13 * (P1[0] * (P2[3] * V2[3] - P2[1] * V2[5]) +
                           ...
                           TMP15 * (P1[0] * (P2[3] * V2[3] - P2[1] * V2[5]) +
                                    (P1[1] * (P2[0] * V2[5] - P2[3] * V2[2]) +
                                     P1[3] * (P2[1] * V2[2] - P2[0] * V2[3]))));
    V1[5] =
        denom * 2. * cI * (TMP13 * (P1[0] * (P2[1] * V2[4] - P2[2] * V2[3]) +
            ...
            double M3, double W3, complex<double> T3[])
{
    ...
    T3[2] =
        denom * -2. * cI *
        (OM3 * P3[0] * (TMP12 * (P3[1] * (V2[4] * V1[5] - V2[5] * V1[4]) +
                                 (P3[2] * (V2[5] * V1[3] - V2[3] * V1[5]) +
                                  P3[3] * (V2[3] * V1[4] - V2[4] * V1[3]))) +
    ...
    T3[7] =
        denom * 2. * cI *
        (OM3 * P3[1] * (TMP12 * (P3[0] * (V2[5] * V1[4] - V2[4] * V1[5]) +
                                 (P3[2] * (V2[2] * V1[5] - V2[5] * V1[2]) +
                                  P3[3] * (V2[4] * V1[2] - V2[2] * V1[4]))) +
                        (TMP9 * (P3[0] * (V2[4] * V1[5] - V2[5] * V1[4]) +
                                 (P3[2] * (V2[5] * V1[2] - V2[2] * V1[5]) +
    ...
    T3[12] =
        denom * 2. * cI *
        (OM3 * P3[2] * (TMP12 * (P3[0] * (V2[3] * V1[5] - V2[5] * V1[3]) +
                                 (P3[1] * (V2[5] * V1[2] - V2[2] * V1[5]) +
                                  P3[3] * (V2[2] * V1[3] - V2[3] * V1[2]))) +
                        (TMP9 * (P3[0] * (V2[5] * V1[3] - V2[3] * V1[5]) +
                                 (P3[1] * (V2[2] * V1[5] - V2[5] * V1[2]) +
    ...
    T3[17] =
        denom * 2. * cI *
        (OM3 * P3[3] * (TMP12 * (P3[0] * (V2[4] * V1[3] - V2[3] * V1[4]) +
                                 (P3[1] * (V2[2] * V1[4] - V2[4] * V1[2]) +
                                  P3[2] * (V2[3] * V1[2] - V2[2] * V1[3]))) +
                        (TMP9 * (P3[0] * (V2[3] * V1[4] - V2[4] * V1[3]) +
                                 (P3[1] * (V2[4] * V1[2] - V2[2] * V1[4]) +
             ...
             double M3, double W3, complex<double> T3[])
{
    ...
    T3[6] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[0] * V2[3] + P1[1] * V2[2]) +
    ...
    T3[10] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[0] * V2[4] + P1[2] * V2[2]) +
    ...
    T3[14] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[0] * V2[5] + P1[3] * V2[2]) +
    ...
    T3[3] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[1] * V2[2] + P1[0] * V2[3]) +
                                 2. / 3. * cI * (P3[0] * P3[1] * OM3 * TMP26)) +
    ...
    T3[11] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[1] * V2[4] + P1[2] * V2[3]) +
    ...
    T3[15] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[1] * V2[5] + P1[3] * V2[3]) +
    ...
    T3[4] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[2] * V2[2] + P1[0] * V2[4]) +
                                 2. / 3. * cI * (P3[0] * P3[2] * OM3 * TMP26)) +
    ...
    T3[8] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[2] * V2[3] + P1[1] * V2[4]) +
                                 2. / 3. * cI * (P3[1] * P3[2] * OM3 * TMP26)) +
    ...
    T3[16] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[2] * V2[5] + P1[3] * V2[4]) +
    ...
    T3[5] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[3] * V2[2] + P1[0] * V2[5]) +
                                 2. / 3. * cI * (P3[0] * P3[3] * OM3 * TMP26)) +
    ...
    T3[9] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[3] * V2[3] + P1[1] * V2[5]) +
                                 2. / 3. * cI * (P3[1] * P3[3] * OM3 * TMP26)) +
    ...
    T3[13] =
        denom *
        (TMP12 * (TMP37 * -1. * (+cI * (P1[3] * V2[4] + P1[2] * V2[5]) +
                                 2. / 3. * cI * (P3[2] * P3[3] * OM3 * TMP26)) +
                  ...
                  (TMP37 * (TMP9 * (P2[0] * (P3[3] * V2[4] - P3[2] * V2[5]) +
                   ...
                   TMP38 *
                       (TMP12 * (P1[0] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                        ...
                        2. / 3. * (P3[1] * TMP52))) +
              P3[1] *
                  (TMP12 * TMP38 * (P1[1] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                                    (P1[2] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                                     P1[3] * (P3[2] * V1[3] - P3[1] * V1[4]))) +
                   TMP37 * TMP9 *
                  ...
                  (TMP37 * (TMP9 * (P2[0] * (P3[1] * V2[5] - P3[3] * V2[3]) +
                   ...
                   TMP38 *
                       (TMP12 * (P1[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                        ...
                        2. / 3. * (P3[2] * TMP52))) +
              P3[2] *
                  (TMP12 * TMP38 * (P1[0] * (P3[3] * V1[4] - P3[2] * V1[5]) +
                                    (P1[2] * (P3[0] * V1[5] - P3[3] * V1[2]) +
                                     P1[3] * (P3[2] * V1[2] - P3[0] * V1[4]))) +
                   TMP37 * TMP9 *
                  ...
                  (TMP37 * (TMP9 * (P2[0] * (P3[2] * V2[3] - P3[1] * V2[4]) +
                   ...
                   TMP38 *
                       (TMP12 * (P1[0] * (P3[2] * V1[3] - P3[1] * V1[4]) +
                        ...
                        2. / 3. * (P3[3] * TMP52))) +
              P3[3] *
                  (TMP12 * TMP38 * (P1[0] * (P3[1] * V1[5] - P3[3] * V1[3]) +
                                    (P1[1] * (P3[3] * V1[2] - P3[0] * V1[5]) +
                                     P1[3] * (P3[0] * V1[3] - P3[1] * V1[2]))) +
                   TMP37 * TMP9 *
            ...
            double M3, double W3, complex<double> T3[])
{
        ...
        (OM3 * (P3[0] *
         ...
         (P1[0] *
          ...
          (P2[0] * -1. *
           ...
           (-1. / 3. * (TMP22) + 1. / 3. * (TMP24)))));
    T3[3] = denom * cI *
            (OM3 * (P3[0] * (TMP12 * -1. * (F1[2] * F2[5] + F1[3] * F2[4] +
                                            4. / 3. * (P3[1] * OM3 * TMP23) -
                                            F1[4] * F2[3] - F1[5] * F2[2]) +
    ...
    T3[4] =
        denom * cI *
        (OM3 * (P3[0] * (TMP12 * -1. * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
          ...
          (F1[3] * (F2[4] * (-cI * (P2[0]) + cI * (P1[0])) +
           ...
           (F1[4] * (F2[2] * (P1[2] - P2[2]) +
            ...
            F1[5] * (F2[2] * (-cI * (P1[0]) + cI * (P2[0])) +
                     F2[3] * (P1[2] - P2[2]))))));
    T3[5] = denom * cI *
            (OM3 * (P3[0] * (TMP12 * -1. * (F1[2] * F2[4] + F1[5] * F2[3] +
                                            4. / 3. * (P3[3] * OM3 * TMP23) -
                                            F1[3] * F2[5] - F1[4] * F2[2]) +
    ...
    T3[7] =
        denom * 2. * cI *
        (OM3 * (P3[1] * (TMP12 * -1. * (F1[2] * F2[5] + F1[3] * F2[4] +
                                        2. / 3. * (P3[1] * OM3 * TMP23) -
                                        F1[4] * F2[3] - F1[5] * F2[2]) +
                         (TMP9 * (F1[2] * F2[5] + F1[3] * F2[4] +
                                  2. / 3. * (P3[1] * OM3 * TMP23) -
    ...
    T3[8] =
        denom * cI *
        (OM3 * (P3[1] * (TMP12 * -1. * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
                                        cI * (F1[2] * F2[5] + F1[5] * F2[2]) +
                                        4. / 3. * (P3[2] * OM3 * TMP23)) +
                         (TMP9 * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
                                  cI * (F1[2] * F2[5] + F1[5] * F2[2]) +
         ...
         (F1[2] * F2[5] * (P2[2] - cI * (P1[1]) + cI * (P2[1]) - P1[2]) +
          (F1[3] * F2[4] * (P2[2] - cI * (P2[1]) + cI * (P1[1]) - P1[2]) +
           (F1[4] * F2[3] * (P1[2] - cI * (P2[1]) + cI * (P1[1]) - P2[2]) +
            F1[5] * F2[2] * (P1[2] - cI * (P1[1]) + cI * (P2[1]) - P2[2])))));
    T3[9] = denom * cI *
            (OM3 * (P3[1] * (TMP12 * -1. * (F1[2] * F2[4] + F1[5] * F2[3] +
                                            4. / 3. * (P3[3] * OM3 * TMP23) -
                                            F1[3] * F2[5] - F1[4] * F2[2]) +
                             (TMP9 * (F1[2] * F2[4] + F1[5] * F2[3] +
                                      4. / 3. * (P3[3] * OM3 * TMP23) -
    ...
    T3[12] =
        denom * 2. * cI *
        (OM3 * (P3[2] * (TMP12 * -1. * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
                                        cI * (F1[2] * F2[5] + F1[5] * F2[2]) +
                                        2. / 3. * (P3[2] * OM3 * TMP23)) +
                         (TMP9 * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
                                  cI * (F1[2] * F2[5] + F1[5] * F2[2]) +
         ...
         (P1[2] * (-cI * (F1[2] * F2[5] + F1[5] * F2[2]) +
          ...
          (P2[2] * (-cI * (F1[3] * F2[4] + F1[4] * F2[3]) +
           ...
           (-1. / 3. * (TMP24) + 1. / 3. * (TMP22)))));
    T3[13] = denom * cI *
             (OM3 * (P3[2] * (TMP12 * -1. * (F1[2] * F2[4] + F1[5] * F2[3] +
                                             4. / 3. * (P3[3] * OM3 * TMP23) -
                                             F1[3] * F2[5] - F1[4] * F2[2]) +
                              (TMP9 * (F1[2] * F2[4] + F1[5] * F2[3] +
                                       4. / 3. * (P3[3] * OM3 * TMP23) -
    ...
    T3[17] =
        denom * 2. * cI *
        (OM3 * (P3[3] * (TMP12 * -1. * (F1[2] * F2[4] + F1[5] * F2[3] +
                                        2. / 3. * (P3[3] * OM3 * TMP23) -
                                        F1[3] * F2[5] - F1[4] * F2[2]) +
                         (TMP9 * (F1[2] * F2[4] + F1[5] * F2[3] +
                                  2. / 3. * (P3[3] * OM3 * TMP23) -
            ...
            double M2, double W2, complex<double> F2[])
{
    ...
    denom = COUP / (pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) -
                    pow(P2[3], 2) - M2 * (M2 - cI * W2));
    F2[2] =
        denom * cI * (TMP11 * (F1[4] * (P2[3] - P2[0]) +
                               (F1[5] * (P2[1] - cI * (P2[2])) + F1[2] * M2)) +
                      TMP9 * (F1[4] * (P2[0] - P2[3]) +
                              (F1[5] * (+cI * (P2[2]) - P2[1]) - F1[2] * M2)));
    F2[3] =
        denom * cI * (TMP11 * (F1[4] * (P2[1] + cI * (P2[2])) +
                               (F1[5] * -1. * (P2[0] + P2[3]) + F1[3] * M2)) +
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * (OM3 * P3[0] * (TMP10 * (+cI * (TMP17 + TMP18)) +
                                    (-cI * (TMP12 * TMP19 + TMP14 * TMP20))) +
                     (TMP10 * -1. * (+cI * (P1[0] + P2[0])) +
                      (+cI * (V1[2] * TMP12 + V2[2] * TMP14))));
    V3[3] = denom * (OM3 * P3[1] * (TMP10 * (+cI * (TMP17 + TMP18)) +
                                    (-cI * (TMP12 * TMP19 + TMP14 * TMP20))) +
                     (TMP10 * -1. * (+cI * (P1[1] + P2[1])) +
                      (+cI * (V1[3] * TMP12 + V2[3] * TMP14))));
    V3[4] = denom * (OM3 * P3[2] * (TMP10 * (+cI * (TMP17 + TMP18)) +
                                    (-cI * (TMP12 * TMP19 + TMP14 * TMP20))) +
                     (TMP10 * -1. * (+cI * (P1[2] + P2[2])) +
                      (+cI * (V1[4] * TMP12 + V2[4] * TMP14))));
    V3[5] = denom * (OM3 * P3[3] * (TMP10 * (+cI * (TMP17 + TMP18)) +
                                    (-cI * (TMP12 * TMP19 + TMP14 * TMP20))) +
            ...
            double M1, double W1, complex<double> F1[])
{
    ...
    F1[2] = denom * -cI *
            (TMP11 * (F2[4] * -1. * (P1[0] + P1[3]) +
             ...
             TMP9 * (F2[4] * (P1[0] + P1[3]) +
                     (F2[5] * (P1[1] + cI * (P1[2])) - F2[2] * M1)));
    F1[3] = denom * -cI * (TMP11 * (F2[4] * (+cI * (P1[2]) - P1[1]) +
                                    (F2[5] * (P1[3] - P1[0]) + F2[3] * M1)) +
    ...
    F1[5] =
        denom * -cI * (TMP11 * (F2[2] * (P1[1] - cI * (P1[2])) +
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI * (F1[4] * F2[2] + F1[5] * F2[3] - F1[2] * F2[4] -
                           F1[3] * F2[5] - P3[0] * OM3 * TMP22);
    V3[3] = denom * -cI * (F1[2] * F2[5] + F1[3] * F2[4] + F1[4] * F2[3] +
                           F1[5] * F2[2] - P3[1] * OM3 * TMP22);
    V3[4] = denom * -cI *
            (-cI * (F1[3] * F2[4] + F1[5] * F2[2]) +
             cI * (F1[2] * F2[5] + F1[4] * F2[3]) - P3[2] * OM3 * TMP22);
    V3[5] = denom * -cI * (F1[2] * F2[4] + F1[4] * F2[2] - F1[3] * F2[5] -
                           F1[5] * F2[3] - P3[3] * OM3 * TMP22);
}
    ...
    F2[3] =
        denom * cI * (TMP11 * (F1[4] * (P2[1] + cI * (P2[2])) +
                      ...
                      TMP9 * (F1[4] * -1. * (P2[1] + cI * (P2[2])) +
                              (F1[5] * (P2[0] + P2[3]) + F1[3] * M2)));
    F2[4] =
        denom * cI * (TMP11 * (F1[2] * -1. * (P2[0] + P2[3]) +
                               (F1[3] * (+cI * (P2[2]) - P2[1]) - F1[4] * M2)) +
                      TMP9 * (F1[2] * (P2[0] + P2[3]) +
                              (F1[3] * (P2[1] - cI * (P2[2])) + F1[4] * M2)));
    F2[5] = denom * cI * (TMP11 * (F1[2] * -1. * (P2[1] + cI * (P2[2])) +
             ...
             (F1[3] * (P2[0] * (V3[2] - V3[5]) +
                       (P2[1] * (+cI * (V3[4]) - V3[3]) +
                        (P2[2] * -1. * (V3[4] + cI * (V3[3])) +
                         P2[3] * (V3[2] - V3[5])))) +
              M2 * (F1[4] * (V3[3] + cI * (V3[4])) - F1[5] * (V3[2] + V3[5]))));
    F2[4] = denom * cI * (F1[4] * (P2[0] * (V3[2] - V3[5]) +
                                   (P2[1] * -1. * (V3[3] + cI * (V3[4])) +
                                    (P2[2] * (+cI * (V3[3]) - V3[4]) +
                                     P2[3] * (V3[2] - V3[5])))) +
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * TMP23 * (OM3 * P3[0] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[0]) + cI * (P2[0])));
    V3[3] = denom * TMP23 * (OM3 * P3[1] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[1]) + cI * (P2[1])));
    V3[4] = denom * TMP23 * (OM3 * P3[2] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[2]) + cI * (P2[2])));
    V3[5] = denom * TMP23 * (OM3 * P3[3] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[3]) + cI * (P2[3])));
}
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * TMP24 * (OM3 * P3[0] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[0]) + cI * (P2[0])));
    V3[3] = denom * TMP24 * (OM3 * P3[1] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[1]) + cI * (P2[1])));
    V3[4] = denom * TMP24 * (OM3 * P3[2] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[2]) + cI * (P2[2])));
    V3[5] = denom * TMP24 * (OM3 * P3[3] * (-cI * (TMP18) + cI * (TMP17)) +
                             (-cI * (P1[3]) + cI * (P2[3])));
}
            ...
            double M1, double W1, complex<double> V1[])
{
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - M1 * (M1 - cI * W1));
    V1[2] =
        denom * -2. * cI * S3[2] * (P1[1] * (P2[3] * V2[4] - P2[2] * V2[5]) +
                                    (P1[2] * (P2[1] * V2[5] - P2[3] * V2[3]) +
                                     P1[3] * (P2[2] * V2[3] - P2[1] * V2[4])));
    V1[3] =
        denom * 2. * cI * S3[2] * (P1[0] * (P2[2] * V2[5] - P2[3] * V2[4]) +
                                   (P1[2] * (P2[3] * V2[2] - P2[0] * V2[5]) +
                                    P1[3] * (P2[0] * V2[4] - P2[2] * V2[2])));
    V1[4] =
        denom * 2. * cI * S3[2] * (P1[0] * (P2[3] * V2[3] - P2[1] * V2[5]) +
                                   (P1[1] * (P2[0] * V2[5] - P2[3] * V2[2]) +
                                    P1[3] * (P2[1] * V2[2] - P2[0] * V2[3])));
    V1[5] =
        denom * 2. * cI * S3[2] * (P1[0] * (P2[1] * V2[4] - P2[2] * V2[3]) +
                                   (P1[1] * (P2[2] * V2[2] - P2[0] * V2[4]) +
                                    P1[2] * (P2[0] * V2[3] - P2[1] * V2[2])));
}
            ...
            complex<double> COUP, complex<double> &vertex)
{
    ...
    vertex =
        COUP * S3[2] * (TMP10 * (-cI * (TMP12 * TMP15) + cI * (TMP9 * TMP11)) +
