...
#ifndef MG5_Sigma_HiggsPO_UFO_gg_mummupmummup_H
#define MG5_Sigma_HiggsPO_UFO_gg_mummupmummup_H
...
class gg_Spin0_SF
{
  public:
    ...
    std::string name() const { return "g g > mu- mu+ mu- mu+ (HiggsPO_UFO)"; }
  ...
  private:
    ...
    double matrix_2_gg_h_h_mummupmummup();
...
#endif // MG5_Sigma_HiggsPO_UFO_gg_mummupmummup_H
