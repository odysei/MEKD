             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    V3[2] = denom * -cI *
            (OM3 * P3[0] * (+2. * (TMP11)-TMP10) +
             (F2[4] * F1[2] + F2[5] * F1[3] -
              2. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI *
            (OM3 * P3[1] * (+2. * (TMP11)-TMP10) +
             (-2. * (F2[3] * F1[4] + F2[2] * F1[5]) - F2[5] * F1[2] -
              F2[4] * F1[3]));
    V3[4] = denom * -cI *
            (OM3 * P3[2] * (+2. * (TMP11)-TMP10) +
             (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
              2. * cI * (F2[3] * F1[4]) + 2. * cI * (F2[2] * F1[5])));
    V3[5] = denom * -cI *
            (OM3 * P3[3] * (+2. * (TMP11)-TMP10) +
             (F2[5] * F1[3] + 2. * (F2[3] * F1[5]) - 2. * (F2[2] * F1[4]) -
              F2[4] * F1[2]));
}
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI *
            (OM3 * -P3[0] * (TMP10 + 4. * (TMP11)) +
             (F2[4] * F1[2] + F2[5] * F1[3] +
              4. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI *
            (OM3 * -P3[1] * (TMP10 + 4. * (TMP11)) +
             (+4. * (F2[3] * F1[4] + F2[2] * F1[5]) - F2[5] * F1[2] -
              F2[4] * F1[3]));
    V3[4] = denom * -cI *
            (OM3 * -P3[2] * (TMP10 + 4. * (TMP11)) +
             (-4. * cI * (F2[2] * F1[5]) - cI * (F2[5] * F1[2]) +
              cI * (F2[4] * F1[3]) + 4. * cI * (F2[3] * F1[4])));
    V3[5] = denom * -cI *
            (OM3 * -P3[3] * (TMP10 + 4. * (TMP11)) +
             (F2[5] * F1[3] + 4. * (F2[2] * F1[4]) - 4. * (F2[3] * F1[5]) -
              F2[4] * F1[2]));
}
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI *
            (OM3 * -P3[0] * (TMP10 + 2. * (TMP11)) +
             (F2[4] * F1[2] + F2[5] * F1[3] +
              2. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI *
            (OM3 * -P3[1] * (TMP10 + 2. * (TMP11)) +
             (+2. * (F2[3] * F1[4] + F2[2] * F1[5]) - F2[5] * F1[2] -
              F2[4] * F1[3]));
    V3[4] = denom * -cI *
            (OM3 * -P3[2] * (TMP10 + 2. * (TMP11)) +
             (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
              2. * cI * (F2[2] * F1[5]) + 2. * cI * (F2[3] * F1[4])));
    V3[5] = denom * -cI *
            (OM3 * -P3[3] * (TMP10 + 2. * (TMP11)) +
             (F2[5] * F1[3] + 2. * (F2[2] * F1[4]) - 2. * (F2[3] * F1[5]) -
              F2[4] * F1[2]));
}
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    V3[4] =
        denom * -cI *
        (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) - P3[2] * OM3 * TMP10);
