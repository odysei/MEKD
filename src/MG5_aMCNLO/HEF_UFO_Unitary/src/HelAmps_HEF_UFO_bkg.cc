             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    V3[2] = denom * -cI * (OM3 * P3[0] * (+2. * (TMP11)-TMP10) +
                           (F2[4] * F1[2] + F2[5] * F1[3] -
                            2. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI * (OM3 * P3[1] * (+2. * (TMP11)-TMP10) +
                           (-2. * (F2[3] * F1[4] + F2[2] * F1[5]) -
                            F2[5] * F1[2] - F2[4] * F1[3]));
    V3[4] =
        denom * -cI * (OM3 * P3[2] * (+2. * (TMP11)-TMP10) +
                       (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
                        2. * cI * (F2[3] * F1[4]) + 2. * cI * (F2[2] * F1[5])));
    V3[5] = denom * -cI * (OM3 * P3[3] * (+2. * (TMP11)-TMP10) +
                           (F2[5] * F1[3] + 2. * (F2[3] * F1[5]) -
                            2. * (F2[2] * F1[4]) - F2[4] * F1[2]));
}
    ...
    F2[3] = denom * cI * (F1[2] * (P2[0] * (V3[3] + cI * (V3[4])) +
                          ...
                          (F1[3] * (P2[0] * (V3[2] - V3[5]) +
                           ...
                           M2 * (F1[4] * -2. * (V3[3] + cI * (V3[4])) +
                                 2. * (F1[5] * (V3[2] + V3[5])))));
    F2[4] = denom * cI *
            (F1[4] * (P2[0] * 2. * (V3[2] - V3[5]) +
                      (P2[1] * -2. * (V3[3] + cI * (V3[4])) +
                       (P2[2] * 2. * (+cI * (V3[3]) - V3[4]) +
                        2. * (P2[3] * (V3[2] - V3[5]))))) +
             (F1[5] * (P2[0] * 2. * (+cI * (V3[4]) - V3[3]) +
                       (P2[1] * 2. * (V3[2] + V3[5]) +
                        (P2[2] * -2. * (+cI * (V3[2] + V3[5])) +
                         2. * (P2[3] * (+cI * (V3[4]) - V3[3]))))) +
              M2 * (F1[2] * (V3[2] + V3[5]) + F1[3] * (V3[3] - cI * (V3[4])))));
    F2[5] = denom * cI *
            (F1[4] * (P2[0] * -2. * (V3[3] + cI * (V3[4])) +
                      (P2[1] * 2. * (V3[2] - V3[5]) +
                       (P2[2] * 2. * (-cI * (V3[5]) + cI * (V3[2])) +
                        2. * (P2[3] * (V3[3] + cI * (V3[4])))))) +
             (F1[5] * (P2[0] * 2. * (V3[2] + V3[5]) +
                       (P2[1] * 2. * (+cI * (V3[4]) - V3[3]) +
                        (P2[2] * -2. * (V3[4] + cI * (V3[3])) -
                         2. * (P2[3] * (V3[2] + V3[5]))))) +
                          ...
                          F1[3] * (P2[0] * (V3[2] - V3[5]) +
                                   (P2[1] * (+cI * (V3[4]) - V3[3]) +
                                    (P2[2] * -1. * (V3[4] + cI * (V3[3])) +
                                     P2[3] * (V3[2] - V3[5])))));
    F2[4] = denom * cI * M2 *
            (F1[2] * (V3[2] + V3[5]) + F1[3] * (V3[3] - cI * (V3[4])));
    F2[5] = denom * cI * M2 *
            (F1[2] * (V3[3] + cI * (V3[4])) + F1[3] * (V3[2] - V3[5]));
}

void FFV42_43_2(complex<double> F1[], complex<double> V3[],
                complex<double> COUP1, complex<double> COUP2, double M2,
...
void FFV42_44_2(complex<double> F1[], complex<double> V3[],
                complex<double> COUP1, complex<double> COUP2, double M2,
                double W2, complex<double> F2[])
{
    //   complex<double> cI = complex<double> (0., 1.);
...
void FFV42_45_2(complex<double> F1[], complex<double> V3[],
                complex<double> COUP1, complex<double> COUP2, double M2,
                double W2, complex<double> F2[])
{
    //   complex<double> cI = complex<double> (0., 1.);
...
void FFV42_45_0(complex<double> F1[], complex<double> F2[],
...
void FFV42_43_0(complex<double> F1[], complex<double> F2[],
                complex<double> V3[], complex<double> COUP1,
                complex<double> COUP2, complex<double> &vertex)
{
    //   complex<double> cI = complex<double> (0., 1.);
...
void FFV42_44_0(complex<double> F1[], complex<double> F2[],
                complex<double> V3[], complex<double> COUP1,
                complex<double> COUP2, complex<double> &vertex)
{
    //   complex<double> cI = complex<double> (0., 1.);
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI * (OM3 * -P3[0] * (TMP10 + 4. * (TMP11)) +
                           (F2[4] * F1[2] + F2[5] * F1[3] +
                            4. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI * (OM3 * -P3[1] * (TMP10 + 4. * (TMP11)) +
                           (+4. * (F2[3] * F1[4] + F2[2] * F1[5]) -
                            F2[5] * F1[2] - F2[4] * F1[3]));
    V3[4] = denom * -cI * (OM3 * -P3[2] * (TMP10 + 4. * (TMP11)) +
                           (-4. * cI * (F2[2] * F1[5]) - cI * (F2[5] * F1[2]) +
                            cI * (F2[4] * F1[3]) + 4. * cI * (F2[3] * F1[4])));
    V3[5] = denom * -cI * (OM3 * -P3[3] * (TMP10 + 4. * (TMP11)) +
                           (F2[5] * F1[3] + 4. * (F2[2] * F1[4]) -
                            4. * (F2[3] * F1[5]) - F2[4] * F1[2]));
}
    ...
    F2[3] = denom * cI * (F1[2] * (P2[0] * (V3[3] + cI * (V3[4])) +
                          ...
                          (F1[3] * (P2[0] * (V3[2] - V3[5]) +
                           ...
                           M2 * (F1[4] * 2. * (V3[3] + cI * (V3[4])) -
                                 2. * (F1[5] * (V3[2] + V3[5])))));
    F2[4] = denom * cI *
            (F1[4] * (P2[0] * 2. * (V3[5] - V3[2]) +
                      (P2[1] * 2. * (V3[3] + cI * (V3[4])) +
                       (P2[2] * 2. * (V3[4] - cI * (V3[3])) +
                        2. * (P2[3] * (V3[5] - V3[2]))))) +
             (F1[5] * (P2[0] * 2. * (V3[3] - cI * (V3[4])) +
                       (P2[1] * -2. * (V3[2] + V3[5]) +
                        (P2[2] * 2. * (+cI * (V3[2] + V3[5])) +
                         2. * (P2[3] * (V3[3] - cI * (V3[4])))))) +
              M2 * (F1[2] * (V3[2] + V3[5]) + F1[3] * (V3[3] - cI * (V3[4])))));
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * -cI * (OM3 * -P3[0] * (TMP10 + 2. * (TMP11)) +
                           (F2[4] * F1[2] + F2[5] * F1[3] +
                            2. * (F2[2] * F1[4] + F2[3] * F1[5])));
    V3[3] = denom * -cI * (OM3 * -P3[1] * (TMP10 + 2. * (TMP11)) +
                           (+2. * (F2[3] * F1[4] + F2[2] * F1[5]) -
                            F2[5] * F1[2] - F2[4] * F1[3]));
    V3[4] =
        denom * -cI * (OM3 * -P3[2] * (TMP10 + 2. * (TMP11)) +
                       (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
                        2. * cI * (F2[2] * F1[5]) + 2. * cI * (F2[3] * F1[4])));
    V3[5] = denom * -cI * (OM3 * -P3[3] * (TMP10 + 2. * (TMP11)) +
                           (F2[5] * F1[3] + 2. * (F2[2] * F1[4]) -
                            2. * (F2[3] * F1[5]) - F2[4] * F1[2]));
}
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    V3[3] =
        denom * -cI * (-F2[5] * F1[2] - F2[4] * F1[3] - P3[1] * OM3 * TMP10);
    V3[4] = denom * -cI * (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) -
                           P3[2] * OM3 * TMP10);
    V3[5] = denom * -cI * (F2[5] * F1[3] - F2[4] * F1[2] - P3[3] * OM3 * TMP10);
}

void FFV42_43_3(complex<double> F1[], complex<double> F2[],
                complex<double> COUP1, complex<double> COUP2, double M3,
...
void FFV42_44_3(complex<double> F1[], complex<double> F2[],
                complex<double> COUP1, complex<double> COUP2, double M3,
                double W3, complex<double> V3[])
{
    //   complex<double> cI = complex<double> (0., 1.);
...
void FFV42_45_3(complex<double> F1[], complex<double> F2[],
                complex<double> COUP1, complex<double> COUP2, double M3,
                double W3, complex<double> V3[])
{
    //   complex<double> cI = complex<double> (0., 1.);
             ...
             double M1, double W1, complex<double> F1[])
{
    ...
    F1[2] = denom * cI *
            (F2[2] * (P1[0] * 2. * (V3[5] - V3[2]) +
                      (P1[1] * 2. * (V3[3] - cI * (V3[4])) +
                       (P1[2] * 2. * (V3[4] + cI * (V3[3])) +
                        2. * (P1[3] * (V3[5] - V3[2]))))) +
             (F2[3] * (P1[0] * 2. * (V3[3] + cI * (V3[4])) +
                       (P1[1] * -2. * (V3[2] + V3[5]) +
                        (P1[2] * -2. * (+cI * (V3[2] + V3[5])) +
                         2. * (P1[3] * (V3[3] + cI * (V3[4])))))) +
              M1 * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * (V3[4])))));
    F1[3] = denom * cI *
            (F2[2] * (P1[0] * 2. * (V3[3] - cI * (V3[4])) +
                      (P1[1] * 2. * (V3[5] - V3[2]) +
                       (P1[2] * 2. * (-cI * (V3[5]) + cI * (V3[2])) +
                        2. * (P1[3] * (+cI * (V3[4]) - V3[3]))))) +
             (F2[3] * (P1[0] * -2. * (V3[2] + V3[5]) +
                       (P1[1] * 2. * (V3[3] + cI * (V3[4])) +
                        (P1[2] * 2. * (V3[4] - cI * (V3[3])) +
                         2. * (P1[3] * (V3[2] + V3[5]))))) +
             ...
             double M1, double W1, complex<double> F1[])
{
    ...
    F1[3] = denom * cI * M1 *
            (F2[4] * (V3[3] - cI * (V3[4])) + F2[5] * (V3[2] - V3[5]));
    F1[4] = denom * -cI * (F2[4] * (P1[0] * (V3[2] + V3[5]) +
                                    (P1[1] * (+cI * (V3[4]) - V3[3]) +
                                     (P1[2] * -1. * (V3[4] + cI * (V3[3])) -
                                      P1[3] * (V3[2] + V3[5])))) +
...
void FFV42_44_1(complex<double> F2[], complex<double> V3[],
                complex<double> COUP1, complex<double> COUP2, double M1,
    ...
    F2[3] = denom * cI * (F1[2] * (P2[0] * (V3[3] + cI * (V3[4])) +
                          ...
                          (F1[3] * (P2[0] * (V3[2] - V3[5]) +
                           ...
                           M2 * (F1[4] * -4. * (V3[3] + cI * (V3[4])) +
                                 4. * (F1[5] * (V3[2] + V3[5])))));
    F2[4] = denom * cI *
            (F1[4] * (P2[0] * 4. * (V3[2] - V3[5]) +
                      (P2[1] * -4. * (V3[3] + cI * (V3[4])) +
                       (P2[2] * 4. * (+cI * (V3[3]) - V3[4]) +
                        4. * (P2[3] * (V3[2] - V3[5]))))) +
             (F1[5] * (P2[0] * 4. * (+cI * (V3[4]) - V3[3]) +
                       (P2[1] * 4. * (V3[2] + V3[5]) +
                        (P2[2] * -4. * (+cI * (V3[2] + V3[5])) +
                         4. * (P2[3] * (+cI * (V3[4]) - V3[3]))))) +
              M2 * (F1[2] * (V3[2] + V3[5]) + F1[3] * (V3[3] - cI * (V3[4])))));
    F2[5] = denom * cI *
            (F1[4] * (P2[0] * -4. * (V3[3] + cI * (V3[4])) +
                      (P2[1] * 4. * (V3[2] - V3[5]) +
                       (P2[2] * 4. * (-cI * (V3[5]) + cI * (V3[2])) +
                        4. * (P2[3] * (V3[3] + cI * (V3[4])))))) +
             (F1[5] * (P2[0] * 4. * (V3[2] + V3[5]) +
                       (P2[1] * 4. * (+cI * (V3[4]) - V3[3]) +
                        (P2[2] * -4. * (V3[4] + cI * (V3[3])) -
                         4. * (P2[3] * (V3[2] + V3[5]))))) +
              M2 * (F1[2] * (V3[3] + cI * (V3[4])) + F1[3] * (V3[2] - V3[5]))));
             ...
             double M3, double W3, complex<double> V3[])
{
    ...
    V3[2] = denom * -cI * (F2[4] * F1[2] + F2[5] * F1[3] + F2[2] * F1[4] +
                           F2[3] * F1[5] - P3[0] * OM3 * TMP15);
    V3[3] = denom * -cI * (F2[3] * F1[4] + F2[2] * F1[5] - F2[5] * F1[2] -
                           F2[4] * F1[3] - P3[1] * OM3 * TMP15);
    V3[4] = denom * -cI *
            (-cI * (F2[5] * F1[2] + F2[2] * F1[5]) +
             cI * (F2[4] * F1[3] + F2[3] * F1[4]) - P3[2] * OM3 * TMP15);
    V3[5] = denom * -cI * (F2[5] * F1[3] + F2[2] * F1[4] - F2[4] * F1[2] -
                           F2[3] * F1[5] - P3[3] * OM3 * TMP15);
}
