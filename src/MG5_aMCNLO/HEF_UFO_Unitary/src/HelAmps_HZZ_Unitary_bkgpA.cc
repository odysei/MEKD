            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    V3[2] = denom * -4. * cI *
            (OM3 * -0.250000000 * P3[0] * (TMP1 + 4. * (TMP5)) +
             (+0.250000000 * (F1[2] * F2[4] + F1[3] * F2[5]) + F1[4] * F2[2] +
              F1[5] * F2[3]));
    V3[3] = denom * -4. * cI *
            (OM3 * -0.250000000 * P3[1] * (TMP1 + 4. * (TMP5)) +
             (-0.250000000 * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] +
              F1[5] * F2[2]));
    V3[4] = denom * 4. * cI *
            (OM3 * 0.250000000 * P3[2] * (TMP1 + 4. * (TMP5)) +
             (+0.250000000 * cI * (F1[2] * F2[5]) -
              0.250000000 * cI * (F1[3] * F2[4]) - cI * (F1[4] * F2[3]) +
              cI * (F1[5] * F2[2])));
    V3[5] = denom * 4. * cI *
            ...
            double M3, double W3, complex<double> V3[])
{
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - M3 * (M3 - cI * W3));
    V3[2] = denom * 2. * cI *
            (OM3 * 0.500000000 * P3[0] * (TMP1 - 2. * (TMP5)) +
             (-0.500000000 * (F1[2] * F2[4] + F1[3] * F2[5]) + F1[4] * F2[2] +
              F1[5] * F2[3]));
    V3[3] = denom * 2. * cI *
            (OM3 * 0.500000000 * P3[1] * (TMP1 - 2. * (TMP5)) +
             (+0.500000000 * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] +
              F1[5] * F2[2]));
    V3[4] = denom * -2. * cI *
            (OM3 * 0.500000000 * P3[2] * (+2. * (TMP5)-TMP1) +
             (-0.500000000 * cI * (F1[2] * F2[5]) +
              0.500000000 * cI * (F1[3] * F2[4]) - cI * (F1[4] * F2[3]) +
              cI * (F1[5] * F2[2])));
    V3[5] = denom * -2. * cI *
    ...
    V3[3] = denom * -2. * cI *
            (OM3 * -0.500000000 * P3[1] * (TMP1 + 2. * (TMP5)) +
             (-0.500000000 * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] +
              F1[5] * F2[2]));
    V3[4] = denom * 2. * cI *
            (OM3 * 0.500000000 * P3[2] * (TMP1 + 2. * (TMP5)) +
             (+0.500000000 * cI * (F1[2] * F2[5]) -
              0.500000000 * cI * (F1[3] * F2[4]) - cI * (F1[4] * F2[3]) +
              cI * (F1[5] * F2[2])));
    V3[5] = denom * 2. * cI *
