...
void qq_ZZ_DN_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_ZZ_DN_OF::matrix_ssx_emepmummup_no_hxg()
{
    int i, j;
    // Local variables
