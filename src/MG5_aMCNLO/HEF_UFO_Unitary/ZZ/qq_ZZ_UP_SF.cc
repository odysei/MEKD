...
void qq_ZZ_UP_SF::initProc(string param_card_name)
{
...
void qq_ZZ_UP_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_ZZ_UP_SF::matrix_ccx_mummupmummup_no_hxg()
{
    int i, j;
    // Local variables
