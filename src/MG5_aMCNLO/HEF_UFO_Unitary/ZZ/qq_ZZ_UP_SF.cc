...
void qq_ZZ_UP_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
	...
	FFV42_45_2(w[0], w[23], pars->GC_110, pars->GC_115, pars->mdl_MC, pars->ZERO,
			   w[26]);
	...
	FFV42_45_2(w[0], w[20], pars->GC_110, pars->GC_115, pars->mdl_MC, pars->ZERO,
			   w[30]);
	FFV42_45_2(w[0], w[16], pars->GC_110, pars->GC_115, pars->mdl_MC, pars->ZERO,
			   w[31]);
