...
void qq_ZZ_UP_OF::initProc(string param_card_name)
{
...
void qq_ZZ_UP_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_ZZ_UP_OF::matrix_ccx_emepmummup_no_hxg()
{
    int i, j;
    // Local variables
