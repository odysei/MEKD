...
void qq_ZZ_DN_OFpA::initProc(string param_card_name)
{
...
void qq_ZZ_DN_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_ZZ_DN_OFpA::matrix_ssx_emepmummupa_no_hzpxg()
{
    int i, j;
    // Local variables
