			...
			double M1, double W1, complex<double> F1[])
{
	...
	F1[2] =
		...
		(F2[2] * (P1[0] * (V3[5] - V3[2]) + (P1[1] * (V3[3] - cI * (V3[4])) +
											 (P1[2] * (V3[4] + cI * (V3[3])) +
											  P1[3] * (V3[5] - V3[2])))) +
		 (+0.500000000 * (M1 * (+2. * (F2[4] * -0.500000000 * (V3[2] + V3[5])) -
								F2[5] * (V3[3] + cI * (V3[4])))) +
	...
	F1[3] =
		...
		(F2[2] * (P1[0] * (V3[3] - cI * (V3[4])) +
		 ...
		 (+0.500000000 *
			  (M1 * (F2[5] * (V3[5] - V3[2]) +
					 2. * (F2[4] * 0.500000000 * (+cI * (V3[4]) - V3[3])))) +
		  F2[3] *
			  (P1[0] * -1. * (V3[2] + V3[5]) +
			   (P1[1] * (V3[3] + cI * (V3[4])) +
			...
			double M3, double W3, complex<double> V3[])
{
	...
	V3[2] =
		denom * -4. * cI * (OM3 * -0.250000000 * P3[0] * (TMP1 + 4. * (TMP5)) +
							(+0.250000000 * (F1[2] * F2[4] + F1[3] * F2[5]) +
							 F1[4] * F2[2] + F1[5] * F2[3]));
	V3[3] =
		denom * -4. * cI * (OM3 * -0.250000000 * P3[1] * (TMP1 + 4. * (TMP5)) +
							(-0.250000000 * (F1[2] * F2[5] + F1[3] * F2[4]) +
							 F1[4] * F2[3] + F1[5] * F2[2]));
	V3[4] =
		denom * 4. * cI * (OM3 * 0.250000000 * P3[2] * (TMP1 + 4. * (TMP5)) +
						   (+0.250000000 * cI * (F1[2] * F2[5]) -
							0.250000000 * cI * (F1[3] * F2[4]) -
							cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
	V3[5] = denom * 4. * cI *
			(OM3 * 0.250000000 * P3[3] * (TMP1 + 4. * (TMP5)) +
			 (+0.250000000 * (F1[2] * F2[4]) - 0.250000000 * (F1[3] * F2[5]) -
			  F1[4] * F2[2] + F1[5] * F2[3]));
}
			...
			double M3, double W3, complex<double> V3[])
{
	...
	denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
					pow(P3[3], 2) - M3 * (M3 - cI * W3));
	V3[2] =
		denom * 2. * cI * (OM3 * 0.500000000 * P3[0] * (TMP1 - 2. * (TMP5)) +
						   (-0.500000000 * (F1[2] * F2[4] + F1[3] * F2[5]) +
							F1[4] * F2[2] + F1[5] * F2[3]));
	V3[3] =
		denom * 2. * cI * (OM3 * 0.500000000 * P3[1] * (TMP1 - 2. * (TMP5)) +
						   (+0.500000000 * (F1[2] * F2[5] + F1[3] * F2[4]) +
							F1[4] * F2[3] + F1[5] * F2[2]));
	V3[4] =
		denom * -2. * cI * (OM3 * 0.500000000 * P3[2] * (+2. * (TMP5)-TMP1) +
							(-0.500000000 * cI * (F1[2] * F2[5]) +
							 0.500000000 * cI * (F1[3] * F2[4]) -
							 cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
	V3[5] = denom * -2. * cI *
			(OM3 * 0.500000000 * P3[3] * (+2. * (TMP5)-TMP1) +
			 (-0.500000000 * (F1[2] * F2[4]) + 0.500000000 * (F1[3] * F2[5]) -
			  F1[4] * F2[2] + F1[5] * F2[3]));
}
			...
			double M1, double W1, complex<double> F1[])
{
	...
	F1[2] =
		...
		(F2[2] * (P1[0] * (V3[5] - V3[2]) + (P1[1] * (V3[3] - cI * (V3[4])) +
											 (P1[2] * (V3[4] + cI * (V3[3])) +
											  P1[3] * (V3[5] - V3[2])))) +
		 (+0.250000000 * (M1 * (F2[5] * (V3[3] + cI * (V3[4])) +
								4. * (F2[4] * 0.250000000 * (V3[2] + V3[5])))) +
		  F2[3] * (P1[0] * (V3[3] + cI * (V3[4])) +
				   (P1[1] * -1. * (V3[2] + V3[5]) +
					(P1[2] * -1. * (+cI * (V3[2] + V3[5])) +
					 P1[3] * (V3[3] + cI * (V3[4])))))));
	F1[3] =
		...
		(F2[2] * (P1[0] * (V3[3] - cI * (V3[4])) +
		 ...
		 (+0.250000000 *
			  (M1 * (F2[5] * (V3[2] - V3[5]) +
					 4. * (F2[4] * 0.250000000 * (V3[3] - cI * (V3[4]))))) +
		  F2[3] *
			  (P1[0] * -1. * (V3[2] + V3[5]) +
			   (P1[1] * (V3[3] + cI * (V3[4])) +
				(P1[2] * (V3[4] - cI * (V3[3])) + P1[3] * (V3[2] + V3[5]))))));
			...
			double M2, double W2, complex<double> F2[])
{
	...
	F2[5] =
		...
		(F1[4] * (P2[0] * (V3[3] + cI * (V3[4])) +
		 ...
		 (+0.500000000 *
			  (M2 * (F1[3] * (V3[5] - V3[2]) +
					 2. * (F1[2] * -0.500000000 * (V3[3] + cI * (V3[4]))))) +
		  F1[5] *
			  (P2[0] * -1. * (V3[2] + V3[5]) +
			   (P2[1] * (V3[3] - cI * (V3[4])) +
...
void FFV2_4_2(complex<double> F1[], complex<double> V3[], complex<double> COUP1,
			  complex<double> COUP2, double M2, double W2, complex<double> F2[])
{
	//   complex<double> cI = complex<double> (0., 1.);
	complex<double> Ftmp[6];
...
void FFV2_4_3(complex<double> F1[], complex<double> F2[], complex<double> COUP1,
			  complex<double> COUP2, double M3, double W3, complex<double> V3[])
{
	//   complex<double> cI = complex<double> (0., 1.);
	complex<double> denom;
			...
			double M2, double W2, complex<double> F2[])
{
	...
	F2[5] =
		...
		(F1[4] * (P2[0] * (V3[3] + cI * (V3[4])) +
		 ...
		 (+0.250000000 *
			  (M2 * (F1[3] * (V3[5] - V3[2]) +
					 4. * (F1[2] * -0.250000000 * (V3[3] + cI * (V3[4]))))) +
		  F1[5] *
			  (P2[0] * -1. * (V3[2] + V3[5]) +
			   (P2[1] * (V3[3] - cI * (V3[4])) +
				(P2[2] * (V3[4] + cI * (V3[3])) + P2[3] * (V3[2] + V3[5]))))));
...
void FFV2_4_1(complex<double> F2[], complex<double> V3[], complex<double> COUP1,
			  complex<double> COUP2, double M1, double W1, complex<double> F1[])
{
	//   complex<double> cI = complex<double> (0., 1.);
	//   double P1[4];
			...
			double M2, double W2, complex<double> F2[])
{
	...
	F2[4] =
		...
		(F1[4] * (P2[0] * (V3[5] - V3[2]) + (P2[1] * (V3[3] + cI * (V3[4])) +
											 (P2[2] * (V3[4] - cI * (V3[3])) +
											  P2[3] * (V3[5] - V3[2])))) +
		 (+0.500000000 * (M2 * (F1[3] * (V3[3] - cI * (V3[4])) +
								2. * (F1[2] * 0.500000000 * (V3[2] + V3[5])))) +
		  F1[5] * (P2[0] * (V3[3] - cI * (V3[4])) +
				   (P2[1] * -1. * (V3[2] + V3[5]) +
					(P2[2] * (+cI * (V3[2] + V3[5])) +
			...
			double M1, double W1, complex<double> F1[])
{
	...
	F1[2] =
		...
		(F2[2] * (P1[0] * (V3[5] - V3[2]) + (P1[1] * (V3[3] - cI * (V3[4])) +
											 (P1[2] * (V3[4] + cI * (V3[3])) +
											  P1[3] * (V3[5] - V3[2])))) +
		 (+0.500000000 * (M1 * (F2[5] * (V3[3] + cI * (V3[4])) +
								2. * (F2[4] * 0.500000000 * (V3[2] + V3[5])))) +
		  F2[3] * (P1[0] * (V3[3] + cI * (V3[4])) +
				   (P1[1] * -1. * (V3[2] + V3[5]) +
					(P1[2] * -1. * (+cI * (V3[2] + V3[5])) +
					 P1[3] * (V3[3] + cI * (V3[4])))))));
	F1[3] =
		...
		(F2[2] * (P1[0] * (V3[3] - cI * (V3[4])) +
		 ...
		 (+0.500000000 *
			  (M1 * (F2[5] * (V3[2] - V3[5]) +
					 2. * (F2[4] * 0.500000000 * (V3[3] - cI * (V3[4]))))) +
		  F2[3] *
			  (P1[0] * -1. * (V3[2] + V3[5]) +
			   (P1[1] * (V3[3] + cI * (V3[4])) +
				(P1[2] * (V3[4] - cI * (V3[3])) + P1[3] * (V3[2] + V3[5]))))));
	...
	V3[3] =
		denom * -2. * cI * (OM3 * -0.500000000 * P3[1] * (TMP1 + 2. * (TMP5)) +
							(-0.500000000 * (F1[2] * F2[5] + F1[3] * F2[4]) +
							 F1[4] * F2[3] + F1[5] * F2[2]));
	V3[4] =
		denom * 2. * cI * (OM3 * 0.500000000 * P3[2] * (TMP1 + 2. * (TMP5)) +
						   (+0.500000000 * cI * (F1[2] * F2[5]) -
							0.500000000 * cI * (F1[3] * F2[4]) -
							cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
	V3[5] = denom * 2. * cI *
			(OM3 * 0.500000000 * P3[3] * (TMP1 + 2. * (TMP5)) +
			 (+0.500000000 * (F1[2] * F2[4]) - 0.500000000 * (F1[3] * F2[5]) -
			  F1[4] * F2[2] + F1[5] * F2[3]));
}
