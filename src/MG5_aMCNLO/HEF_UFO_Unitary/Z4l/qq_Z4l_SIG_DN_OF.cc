...
void qq_Z4l_SIG_DN_OF::initProc(string param_card_name)
{
...
void qq_Z4l_SIG_DN_OF::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
	ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_SIG_DN_OF::sigmaKin()
{
...
double qq_Z4l_SIG_DN_OF::sigmaHat()
{
...
void qq_Z4l_SIG_DN_OF::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	FFV42_44_3(w[5], w[4], pars->GC_109, pars->GC_116, pars->mdl_MZ, pars->mdl_WZ,
			   w[17]);
	FFV42_44_1(w[2], w[11], pars->GC_109, pars->GC_116, pars->mdl_Me, pars->ZERO,
			   w[18]);
	FFV42_44_2(w[3], w[11], pars->GC_109, pars->GC_116, pars->mdl_Me, pars->ZERO,
			   w[19]);
	//   FFV41_2(w[0], w[7], pars->GC_1, pars->mdl_MS, pars->ZERO, w[20]);
	//   FFV41_2(w[0], w[14], pars->GC_1, pars->mdl_MS, pars->ZERO, w[21]);
	//   FFV42_43_2(w[0], w[17], pars->GC_109, pars->GC_115, pars->mdl_MS,
	//   pars->ZERO,
	//       w[22]);
...
double qq_Z4l_SIG_DN_OF::matrix_ssx_emepmummup_no_hxg()
{
	int i, j;
	// Local variables
