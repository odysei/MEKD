...
#ifndef MG5_Sigma_HEF_MEKD_ssx_Z4l_BKG_mummupmummup_H
#define MG5_Sigma_HEF_MEKD_ssx_Z4l_BKG_mummupmummup_H
...
class qq_Z4l_BKG_DN_SF
{
  public:
    ...
    string name() const { return "s s~ > mu- mu+ mu- mu+ (HEF_MEKD)"; }
