...
#ifndef MG5_Sigma_HEF_MEKD_ssx_Z4l_BKG_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD_ssx_Z4l_BKG_mummupmummupa_H
...
class qq_Z4l_BKG_DN_SFpA
{
  public:
    ...
    string name() const { return "s s~ > mu- mu+ mu- mu+ a (HZZ_Unitary)"; }
