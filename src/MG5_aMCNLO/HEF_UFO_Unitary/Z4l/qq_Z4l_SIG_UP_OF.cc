...
void qq_Z4l_SIG_UP_OF::initProc(string param_card_name)
{
...
void qq_Z4l_SIG_UP_OF::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
	ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_SIG_UP_OF::sigmaKin()
{
...
double qq_Z4l_SIG_UP_OF::sigmaHat()
{
...
void qq_Z4l_SIG_UP_OF::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	//   FFV42_45_2(w[0], w[17], pars->GC_110, pars->GC_115, pars->mdl_MC,
	//   pars->ZERO,
	//       w[22]);
...
double qq_Z4l_SIG_UP_OF::matrix_ccx_emepmummup_no_hxg()
{
	int i, j;
	// Local variables
