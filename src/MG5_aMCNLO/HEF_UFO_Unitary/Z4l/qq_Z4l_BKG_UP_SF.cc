...
void qq_Z4l_BKG_UP_SF::initProc(string param_card_name)
{
...
void qq_Z4l_BKG_UP_SF::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_BKG_UP_SF::sigmaKin()
{
...
double qq_Z4l_BKG_UP_SF::sigmaHat()
{
...
void qq_Z4l_BKG_UP_SF::calculate_wavefunctions(const int perm[],
                                               const int hel[])
{
...
double qq_Z4l_BKG_UP_SF::matrix_ccx_mummupmummup_no_hxg()
{
    int i, j;
    // Local variables
