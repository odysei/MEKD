                                               ...
                                               const int hel[])
{
    ...
    FFV42_44_3(w[3], w[2], pars->GC_109, pars->GC_116, pars->mdl_MZ,
               pars->mdl_WZ, w[10]);
    FFV42_45_3(w[0], w[1], pars->GC_110, pars->GC_115, pars->mdl_MZ,
               pars->mdl_WZ, w[11]);
    ...
    FFV42_44_3(w[5], w[2], pars->GC_109, pars->GC_116, pars->mdl_MZ,
               pars->mdl_WZ, w[16]);
    FFV42_44_2(w[3], w[11], pars->GC_109, pars->GC_116, pars->mdl_MM,
               pars->ZERO, w[17]);
    FFV41_3(w[3], w[4], pars->GC_3, pars->ZERO, pars->ZERO, w[18]);
    FFV41_1(w[2], w[6], pars->GC_3, pars->mdl_MM, pars->ZERO, w[19]);
    FFV42_44_3(w[3], w[4], pars->GC_109, pars->GC_116, pars->mdl_MZ,
               pars->mdl_WZ, w[20]);
    FFV42_44_1(w[2], w[11], pars->GC_109, pars->GC_116, pars->mdl_MM,
               pars->ZERO, w[21]);
    FFV41_3(w[5], w[4], pars->GC_3, pars->ZERO, pars->ZERO, w[22]);
    FFV42_44_3(w[5], w[4], pars->GC_109, pars->GC_116, pars->mdl_MZ,
               pars->mdl_WZ, w[23]);
