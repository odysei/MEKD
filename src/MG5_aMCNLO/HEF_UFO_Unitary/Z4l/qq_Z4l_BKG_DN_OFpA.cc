...
void qq_Z4l_BKG_DN_OFpA::initProc(string param_card_name)
{
...
void qq_Z4l_BKG_DN_OFpA::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_BKG_DN_OFpA::sigmaKin()
{
...
double qq_Z4l_BKG_DN_OFpA::sigmaHat()
{
...
void qq_Z4l_BKG_DN_OFpA::calculate_wavefunctions(const int perm[],
                                                 const int hel[])
{
...
double qq_Z4l_BKG_DN_OFpA::matrix_ssx_emepmummupa_no_hzpxg()
{
    int i, j;
    // Local variables
