...
#ifndef MG5_Sigma_HEF_MEKD_ssx_Z4l_SIG_emepmummupa_H
#define MG5_Sigma_HEF_MEKD_ssx_Z4l_SIG_emepmummupa_H
...
class qq_Z4l_SIG_DN_OFpA
{
  public:
    ...
    std::string name() const { return "s s~ > e- e+ mu- mu+ a (HZZ_Unitary)"; }
