...
void qq_Z4l_SIG_DN_SF::initProc(string param_card_name)
{
...
void qq_Z4l_SIG_DN_SF::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
	ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_SIG_DN_SF::sigmaKin()
{
...
double qq_Z4l_SIG_DN_SF::sigmaHat()
{
...
void qq_Z4l_SIG_DN_SF::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	//   FFV42_43_2(w[0], w[23], pars->GC_109, pars->GC_115, pars->mdl_MS,
	//   pars->ZERO,
	//       w[26]);
	//   FFV42_43_2(w[0], w[10], pars->GC_109, pars->GC_115, pars->mdl_MS,
	//   pars->ZERO,
	//       w[27]);
	//   FFV41_2(w[0], w[14], pars->GC_1, pars->mdl_MS, pars->ZERO, w[28]);
	//   FFV41_2(w[0], w[18], pars->GC_1, pars->mdl_MS, pars->ZERO, w[29]);
	//   FFV42_43_2(w[0], w[20], pars->GC_109, pars->GC_115, pars->mdl_MS,
	//   pars->ZERO,
	//       w[30]);
	//   FFV42_43_2(w[0], w[16], pars->GC_109, pars->GC_115, pars->mdl_MS,
	//   pars->ZERO,
	//       w[31]);
...
double qq_Z4l_SIG_DN_SF::matrix_ssx_mummupmummup_no_hxg()
{
	int i, j;
	// Local variables
