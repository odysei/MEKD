...
void qq_Z4l_SIG_UP_SFpA::calculate_wavefunctions(const int perm[],
                                                 const int hel[])
{
    ...
    //   FFV1_2(w[0], w[6], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[69]);
    ...
    //   FFV1_1(w[1], w[6], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[80]);
    ...
    //   FFV1_2(w[0], w[8], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[83]);
    //   FFV1_2(w[0], w[45], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[84]);
    ...
    //   FFV1_2(w[0], w[25], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[87]);
    //   FFV1_2(w[0], w[41], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[88]);
    ...
    //   FFV1_1(w[1], w[45], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[91]);
    //   FFV1_1(w[1], w[8], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[92]);
    ...
    //   FFV1_1(w[1], w[41], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[95]);
    //   FFV1_1(w[1], w[25], pars->Unitary_GC_6, pars->mdl_MC, pars->ZERO,
    //   w[96]);
