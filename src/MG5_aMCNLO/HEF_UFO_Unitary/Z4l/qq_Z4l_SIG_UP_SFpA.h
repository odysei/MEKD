...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Z4l_SIG_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD_ccx_Z4l_SIG_mummupmummupa_H
...
class qq_Z4l_SIG_UP_SFpA
{
  public:
    ...
    string name() const { return "c c~ > mu- mu+ mu- mu+ a (HZZ_Unitary)"; }
