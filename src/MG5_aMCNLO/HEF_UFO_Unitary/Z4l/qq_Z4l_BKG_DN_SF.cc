...
void qq_Z4l_BKG_DN_SF::initProc(string param_card_name)
{
...
void qq_Z4l_BKG_DN_SF::updateProc(SLHAReader_MEKD &slha)
{
    pars->setIndependentParameters(slha);
    pars->setIndependentCouplings();
    ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void qq_Z4l_BKG_DN_SF::sigmaKin()
{
...
double qq_Z4l_BKG_DN_SF::sigmaHat()
{
...
void qq_Z4l_BKG_DN_SF::calculate_wavefunctions(const int perm[],
                                               const int hel[])
{
    ...
    FFV42_44_3(w[3], w[2], pars->GC_109, pars->GC_116, pars->mdl_MZ,
               pars->mdl_WZ, w[10]);
    //   FFV42_43_3(w[0], w[1], pars->GC_109, pars->GC_115, pars->mdl_MZ,
    //   pars->mdl_WZ,
    //       w[11]);
...
double qq_Z4l_BKG_DN_SF::matrix_ssx_mummupmummup_no_hxg()
{
    int i, j;
    // Local variables
