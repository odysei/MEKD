...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Z4l_BKG_emepmummupa_H
#define MG5_Sigma_HEF_MEKD_ccx_Z4l_BKG_emepmummupa_H
...
class qq_Z4l_BKG_UP_OFpA
{
  public:
    ...
    std::string name() const { return "c c~ > e- e+ mu- mu+ a (HZZ_Unitary)"; }
