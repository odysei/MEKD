...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Z4l_SIG_emepmummup_H
#define MG5_Sigma_HEF_MEKD_ccx_Z4l_SIG_emepmummup_H
...
class qq_Z4l_SIG_UP_OF
{
  public:
    ...
    std::string name() const { return "c c~ > e- e+ mu- mu+ (HEF_MEKD)"; }
