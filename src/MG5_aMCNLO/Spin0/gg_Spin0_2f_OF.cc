...
void gg_Spin0_2f_OF::initProc(string param_card_name)
{
...
double gg_Spin0_2f_OF::sigmaHat()
{
...
void gg_Spin0_2f_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
	...
	VVS3_4_5_3(w[0], w[1], pars->HEF_MEKD2_1_GC_13, pars->HEF_MEKD2_1_GC_15,
			   pars->HEF_MEKD2_1_GC_19, pars->mdl_MH, pars->mdl_WH, w[6]);
	FFV2P0_3(w[3], w[2], pars->HEF_MEKD2_1_GC_5, pars->ZERO, pars->ZERO, w[7]);
	FFS1_2_1(w[4], w[6], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[8]);
	FFS1_2_2(w[5], w[6], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[9]);
	FFV5_7_3(w[3], w[2], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188,
			 pars->mdl_MZ, pars->mdl_WZ, w[10]);
	VVS1_3(w[0], w[1], pars->HEF_MEKD2_1_GC_23, pars->mdl_MH, pars->mdl_WH, w[11]);
	FFS1_2_1(w[4], w[11], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[12]);
	FFS1_2_2(w[5], w[11], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136,
			 pars->mdl_MM, pars->ZERO, w[13]);
	...
	FFS1_2_1(w[2], w[6], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126,
			 pars->mdl_Me, pars->ZERO, w[16]);
	FFS1_2_2(w[3], w[6], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126,
			 pars->mdl_Me, pars->ZERO, w[17]);
	FFS1_2_1(w[2], w[11], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126,
			 pars->mdl_Me, pars->ZERO, w[18]);
	FFS1_2_2(w[3], w[11], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126,
			 pars->mdl_Me, pars->ZERO, w[19]);
	...
	//   VVS3_4_5_0(w[10], w[14], w[6], pars->HEF_MEKD2_1_GC_14,
	//   pars->HEF_MEKD2_1_GC_18, pars->HEF_MEKD2_1_GC_22,
	//       amp[8]);	//ZZ
	//   VVS2_0(w[10], w[14], w[6], pars->HEF_MEKD2_1_GC_25, amp[9]);	//ZZ
	//   VVS3_4_5_0(w[10], w[14], w[11], pars->HEF_MEKD2_1_GC_14,
	//   pars->HEF_MEKD2_1_GC_18, pars->HEF_MEKD2_1_GC_22,
	//       amp[10]);	//ZZ
	//   VVS2_0(w[10], w[14], w[11], pars->HEF_MEKD2_1_GC_25, amp[11]);	//ZZ
	FFV2_0(w[3], w[16], w[15], pars->HEF_MEKD2_1_GC_5, amp[12]);
	FFV2_0(w[17], w[2], w[15], pars->HEF_MEKD2_1_GC_5, amp[13]);
	FFV5_7_0(w[3], w[16], w[14], pars->HEF_MEKD2_1_GC_181,
			 pars->HEF_MEKD2_1_GC_188, amp[14]);
	FFV5_7_0(w[17], w[2], w[14], pars->HEF_MEKD2_1_GC_181,
			 pars->HEF_MEKD2_1_GC_188, amp[15]);
	FFV2_0(w[3], w[18], w[15], pars->HEF_MEKD2_1_GC_5, amp[16]);
	FFV2_0(w[19], w[2], w[15], pars->HEF_MEKD2_1_GC_5, amp[17]);
	FFV5_7_0(w[3], w[18], w[14], pars->HEF_MEKD2_1_GC_181,
			 pars->HEF_MEKD2_1_GC_188, amp[18]);
	FFV5_7_0(w[19], w[2], w[14], pars->HEF_MEKD2_1_GC_181,
