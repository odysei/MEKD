...
#ifndef MG5_Sigma_HEF_MEKD2_1_h_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_h_mummup_H
...
class Spin0_2l
{
  public:
	...
	virtual string name() const { return "h > mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_h_mummup_no_zpxg();
...
#endif // MG5_Sigma_HEF_MEKD2_1_h_mummup_H
