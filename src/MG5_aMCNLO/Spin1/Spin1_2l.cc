...
// Process: zp > mu- mu+ / h xg

//--------------------------------------------------------------------------
// Initialize process.

void Spin1_2l::initProc(string param_card_name)
{
...
void Spin1_2l::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void Spin1_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
	...
	FFV1_2_3_4_0(w[2], w[1], w[0], pars->HEF_MEKD2_1_GC_141,
				 pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
				 pars->HEF_MEKD2_1_GC_140, amp[0]);
}
double Spin1_2l::matrix_zp_mummup_no_hxg()
{
	int i, j;
	// Local variables
