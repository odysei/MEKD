...
void qq_Spin1_UP_2lpA::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_Spin1_UP_2lpA::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	FFV2_2(w[0], w[4], pars->HEF_MEKD2_1_GC_4, pars->mdl_MC, pars->ZERO, w[8]);
	FFV1_2_3_4_3(w[3], w[2], pars->HEF_MEKD2_1_GC_141, pars->HEF_MEKD2_1_GC_138,
				 pars->HEF_MEKD2_1_GC_139, pars->HEF_MEKD2_1_GC_140, pars->mdl_MZp,
				 pars->mdl_WZp, w[9]);
	FFV2_1(w[1], w[4], pars->HEF_MEKD2_1_GC_4, pars->mdl_MC, pars->ZERO, w[10]);
	...
	FFV1_2_3_4_0(w[8], w[1], w[9], pars->HEF_MEKD2_1_GC_111,
				 pars->HEF_MEKD2_1_GC_108, pars->HEF_MEKD2_1_GC_109,
				 pars->HEF_MEKD2_1_GC_110, amp[2]);
	FFV1_2_3_4_0(w[0], w[10], w[9], pars->HEF_MEKD2_1_GC_111,
				 pars->HEF_MEKD2_1_GC_108, pars->HEF_MEKD2_1_GC_109,
