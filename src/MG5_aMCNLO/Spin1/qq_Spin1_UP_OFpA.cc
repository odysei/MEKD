...
void qq_Spin1_UP_OFpA::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	FFV1_2_3_4_3(w[16], w[1], pars->HEF_MEKD_GC_111, pars->HEF_MEKD_GC_108,
				 pars->HEF_MEKD_GC_109, pars->HEF_MEKD_GC_110, pars->mdl_MZp,
				 pars->mdl_WZp, w[17]);
	FFV2_1(w[1], w[6], pars->HEF_MEKD_GC_4, pars->mdl_MC, pars->ZERO, w[18]);
	FFV1_2_3_4_3(w[0], w[18], pars->HEF_MEKD_GC_111, pars->HEF_MEKD_GC_108,
				 pars->HEF_MEKD_GC_109, pars->HEF_MEKD_GC_110, pars->mdl_MZp,
				 pars->mdl_WZp, w[19]);
