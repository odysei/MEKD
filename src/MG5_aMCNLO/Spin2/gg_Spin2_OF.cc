...
void gg_Spin2_OF::initProc(string param_card_name)
{
...
void gg_Spin2_OF::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
	ntry = 0, sum_hel = 0, ngood = 0; // moved here by Ghost remover v. 0.1
...
void gg_Spin2_OF::sigmaKin()
{
	...
	// remover v. 0.1
	static int igood[ncomb]; // static
	static int jhel; // static
...
void gg_Spin2_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double gg_Spin2_OF::matrix_gg_xg_emepmummup_no_g()
{
	int i, j;
	// Local variables
	//   const int ngraphs = 2;
