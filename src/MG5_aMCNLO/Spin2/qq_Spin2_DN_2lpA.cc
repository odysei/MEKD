...
// Process: s s~ > xg > mu- mu+ a WEIGHTED=4 / h zp

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin2_DN_2lpA::initProc(string param_card_name)
{
...
void qq_Spin2_DN_2lpA::updateProc(SLHAReader_MEKD &slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_Spin2_DN_2lpA::sigmaKin()
{
...
double qq_Spin2_DN_2lpA::sigmaHat()
{
...
void qq_Spin2_DN_2lpA::calculate_wavefunctions(const int perm[],
											   const int hel[])
{
	...
	FFV2_2(w[0], w[4], pars->HEF_MEKD2_1_GC_3, pars->MS, pars->ZERO, w[8]);
	FFT1_2_3_5_3(w[3], w[2], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142,
				 pars->HEF_MEKD2_1_GC_143, pars->HEF_MEKD2_1_GC_144, pars->MXG,
				 pars->WXG, w[9]);
	FFV2_1(w[1], w[4], pars->HEF_MEKD2_1_GC_3, pars->MS, pars->ZERO, w[10]);

	// Calculate all amplitudes
	// Amplitude(s) for diagram number 0
	FFT1_2_3_5_0(w[3], w[6], w[5], pars->HEF_MEKD2_1_GC_145,
				 pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
				 pars->HEF_MEKD2_1_GC_144, amp[0]);
	FFT1_2_3_5_0(w[7], w[2], w[5], pars->HEF_MEKD2_1_GC_145,
				 pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
				 pars->HEF_MEKD2_1_GC_144, amp[1]);
	FFT1_2_3_5_0(w[8], w[1], w[9], pars->HEF_MEKD2_1_GC_155,
				 pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
				 pars->HEF_MEKD2_1_GC_154, amp[2]);
	FFT1_2_3_5_0(w[0], w[10], w[9], pars->HEF_MEKD2_1_GC_155,
				 pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
				 pars->HEF_MEKD2_1_GC_154, amp[3]);
}
double qq_Spin2_DN_2lpA::matrix_ssx_xg_mummupa_no_hzp()
{
	int i, j;
	// Local variables
