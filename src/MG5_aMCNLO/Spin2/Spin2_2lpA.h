...
#ifndef MG5_Sigma_HEF_MEKD2_1_xg_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_xg_mummupa_H
...
class Spin2_2lpA
{
  public:
	...
	virtual string name() const { return "xg > mu- mu+ a (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_xg_mummupa_no_hzp();
...
#endif // MG5_Sigma_HEF_MEKD2_1_xg_mummupa_H
