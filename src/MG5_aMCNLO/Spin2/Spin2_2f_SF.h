...
#ifndef MG5_Sigma_HEF_MEKD2_1_xg_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_xg_mummupmummup_H
...
class Spin2_2f_SF
{
  public:
	...
	virtual string name() const { return "xg > mu- mu+ mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_xg_mummupmummup_no_hzp();
...
#endif // MG5_Sigma_HEF_MEKD2_1_xg_mummupmummup_H
