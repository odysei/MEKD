...
#ifndef MG5_Sigma_HEF_MEKD2_1_xg_mummup_H
#define MG5_Sigma_HEF_MEKD2_1_xg_mummup_H
...
class Spin2_2l
{
  public:
	...
	virtual string name() const { return "xg > mu- mu+ (HEF_MEKD2_1)"; }
  ...
  private:
	...
	double matrix_xg_mummup_no_hzp();
...
#endif // MG5_Sigma_HEF_MEKD2_1_xg_mummup_H
