...
// Process: c c~ > e- e+ mu- mu+ a WEIGHTED<=10 / h @3

//--------------------------------------------------------------------------
// Initialize process.

void qq_z_zp_UP_OFpA::initProc(string param_card_name)
{
...
void qq_z_zp_UP_OFpA::updateProc()
{
    ntry = 0, sum_hel = 0, ngood = 0;
    // Set external particle masses for this matrix element
    mME[0] = (pars->mdl_MC);
    ...
    if (sum_hel == 0 || ntry < 10) {
        ...
        for (int ihel = 0; ihel < ncomb; ihel++) {
            if (goodhel[ihel] || ntry < 2) {
                ...
                t[0] = matrix_3_ccx_emepmummupa_no_h();
                ...
                t[1] = matrix_3_ccx_emepmummupa_no_h();
                double tsum = 0;
...
double qq_z_zp_UP_OFpA::sigmaHat()
{
...
void qq_z_zp_UP_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV2_5_3(w[25], w[4], pars->GC_29, pars->GC_34, pars->mdl_MZ, pars->mdl_WZ,
             w[58]);
    FFV1_2(w[0], w[6], pars->GC_2, pars->mdl_MC, pars->ZERO, w[59]);
    FFV1P0_3(w[59], w[1], pars->GC_2, pars->ZERO, pars->ZERO, w[60]);
    FFV2_6_3(w[59], w[1], pars->GC_30, pars->GC_33, pars->mdl_MZ, pars->mdl_WZ,
             w[61]);
    FFV1_2(w[59], w[13], pars->GC_2, pars->mdl_MC, pars->ZERO, w[62]);
    FFV1_2(w[59], w[35], pars->GC_2, pars->mdl_MC, pars->ZERO, w[63]);
    FFV2_6_2(w[59], w[36], pars->GC_30, pars->GC_33, pars->mdl_MC, pars->ZERO,
             w[64]);
    FFV2_6_2(w[59], w[16], pars->GC_30, pars->GC_33, pars->mdl_MC, pars->ZERO,
             w[65]);
    FFV1_1(w[1], w[6], pars->GC_2, pars->mdl_MC, pars->ZERO, w[66]);
    FFV1P0_3(w[0], w[66], pars->GC_2, pars->ZERO, pars->ZERO, w[67]);
    FFV2_6_3(w[0], w[66], pars->GC_30, pars->GC_33, pars->mdl_MZ, pars->mdl_WZ,
             w[68]);
    FFV1_2(w[0], w[13], pars->GC_2, pars->mdl_MC, pars->ZERO, w[69]);
    FFV1_2(w[0], w[35], pars->GC_2, pars->mdl_MC, pars->ZERO, w[70]);
    FFV2_6_2(w[0], w[36], pars->GC_30, pars->GC_33, pars->mdl_MC, pars->ZERO,
             w[71]);
    FFV2_6_2(w[0], w[16], pars->GC_30, pars->GC_33, pars->mdl_MC, pars->ZERO,
             w[72]);
    FFV1_1(w[1], w[35], pars->GC_2, pars->mdl_MC, pars->ZERO, w[73]);
    FFV1_1(w[1], w[13], pars->GC_2, pars->mdl_MC, pars->ZERO, w[74]);
    FFV2_6_1(w[1], w[36], pars->GC_30, pars->GC_33, pars->mdl_MC, pars->ZERO,
             w[75]);
    ...
    FFV1_0(w[62], w[1], w[35], pars->GC_2, amp[132]);
    FFV1_0(w[63], w[1], w[13], pars->GC_2, amp[133]);
    FFV2_6_0(w[62], w[1], w[36], pars->GC_30, pars->GC_33, amp[134]);
    FFV1_0(w[64], w[1], w[13], pars->GC_2, amp[135]);
    FFV1_0(w[65], w[1], w[35], pars->GC_2, amp[136]);
    FFV2_6_0(w[63], w[1], w[16], pars->GC_30, pars->GC_33, amp[137]);
    FFV2_6_0(w[65], w[1], w[36], pars->GC_30, pars->GC_33, amp[138]);
    FFV2_6_0(w[64], w[1], w[16], pars->GC_30, pars->GC_33, amp[139]);
    ...
    FFV1_0(w[69], w[66], w[35], pars->GC_2, amp[164]);
    FFV1_0(w[70], w[66], w[13], pars->GC_2, amp[165]);
    FFV2_6_0(w[69], w[66], w[36], pars->GC_30, pars->GC_33, amp[166]);
    FFV1_0(w[71], w[66], w[13], pars->GC_2, amp[167]);
    FFV1_0(w[72], w[66], w[35], pars->GC_2, amp[168]);
    FFV2_6_0(w[70], w[66], w[16], pars->GC_30, pars->GC_33, amp[169]);
    FFV2_6_0(w[72], w[66], w[36], pars->GC_30, pars->GC_33, amp[170]);
    FFV2_6_0(w[71], w[66], w[16], pars->GC_30, pars->GC_33, amp[171]);
    ...
    FFV1_0(w[69], w[73], w[6], pars->GC_2, amp[184]);
    FFV1_0(w[70], w[74], w[6], pars->GC_2, amp[185]);
    FFV1_0(w[69], w[75], w[6], pars->GC_2, amp[186]);
    FFV1_0(w[71], w[74], w[6], pars->GC_2, amp[187]);
    FFV1_0(w[72], w[73], w[6], pars->GC_2, amp[188]);
    FFV1_0(w[70], w[76], w[6], pars->GC_2, amp[189]);
    FFV1_0(w[72], w[75], w[6], pars->GC_2, amp[190]);
    FFV1_0(w[71], w[76], w[6], pars->GC_2, amp[191]);
    FFV1_0(w[69], w[1], w[54], pars->GC_2, amp[192]);
    FFV2_6_0(w[69], w[1], w[55], pars->GC_30, pars->GC_33, amp[193]);
    FFV1_0(w[0], w[74], w[54], pars->GC_2, amp[194]);
    FFV2_6_0(w[0], w[74], w[55], pars->GC_30, pars->GC_33, amp[195]);
    FFV1_0(w[72], w[1], w[54], pars->GC_2, amp[196]);
    FFV2_6_0(w[72], w[1], w[55], pars->GC_30, pars->GC_33, amp[197]);
    FFV1_0(w[0], w[76], w[54], pars->GC_2, amp[198]);
    FFV2_6_0(w[0], w[76], w[55], pars->GC_30, pars->GC_33, amp[199]);
    FFV1_0(w[69], w[1], w[57], pars->GC_2, amp[200]);
    FFV2_6_0(w[69], w[1], w[58], pars->GC_30, pars->GC_33, amp[201]);
    FFV1_0(w[0], w[74], w[57], pars->GC_2, amp[202]);
    FFV2_6_0(w[0], w[74], w[58], pars->GC_30, pars->GC_33, amp[203]);
    FFV1_0(w[72], w[1], w[57], pars->GC_2, amp[204]);
    FFV2_6_0(w[72], w[1], w[58], pars->GC_30, pars->GC_33, amp[205]);
    FFV1_0(w[0], w[76], w[57], pars->GC_2, amp[206]);
    FFV2_6_0(w[0], w[76], w[58], pars->GC_30, pars->GC_33, amp[207]);
    FFV1_0(w[70], w[1], w[30], pars->GC_2, amp[208]);
    FFV2_6_0(w[70], w[1], w[31], pars->GC_30, pars->GC_33, amp[209]);
    FFV1_0(w[0], w[73], w[30], pars->GC_2, amp[210]);
    FFV2_6_0(w[0], w[73], w[31], pars->GC_30, pars->GC_33, amp[211]);
    FFV1_0(w[71], w[1], w[30], pars->GC_2, amp[212]);
    FFV2_6_0(w[71], w[1], w[31], pars->GC_30, pars->GC_33, amp[213]);
    FFV1_0(w[0], w[75], w[30], pars->GC_2, amp[214]);
    FFV2_6_0(w[0], w[75], w[31], pars->GC_30, pars->GC_33, amp[215]);
    FFV1_0(w[70], w[1], w[41], pars->GC_2, amp[216]);
    FFV2_6_0(w[70], w[1], w[42], pars->GC_30, pars->GC_33, amp[217]);
    FFV1_0(w[0], w[73], w[41], pars->GC_2, amp[218]);
    FFV2_6_0(w[0], w[73], w[42], pars->GC_30, pars->GC_33, amp[219]);
    FFV1_0(w[71], w[1], w[41], pars->GC_2, amp[220]);
    FFV2_6_0(w[71], w[1], w[42], pars->GC_30, pars->GC_33, amp[221]);
    FFV1_0(w[0], w[75], w[41], pars->GC_2, amp[222]);
    FFV2_6_0(w[0], w[75], w[42], pars->GC_30, pars->GC_33, amp[223]);
}
double qq_z_zp_UP_OFpA::matrix_3_ccx_emepmummupa_no_h()
{
    int i, j;
    // Local variables
