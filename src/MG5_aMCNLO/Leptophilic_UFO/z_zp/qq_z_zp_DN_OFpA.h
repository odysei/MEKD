...
#ifndef MG5_Sigma_Leptophilic_UFO_ssx_emepmummupa_H
#define MG5_Sigma_Leptophilic_UFO_ssx_emepmummupa_H
...
// Process: s s~ > e- e+ mu- mu+ a WEIGHTED<=10 / h @7
//--------------------------------------------------------------------------

class qq_z_zp_DN_OFpA
{
  public:
    // Constructor.
    qq_z_zp_DN_OFpA() {}
    ...
    string name() const
    {
        return "s s~ > e- e+ mu- mu+ a (Leptophilic_UFO)";
    }
  ...
  private:
    ...
    double matrix_7_ssx_emepmummupa_no_h();
...
#endif // MG5_Sigma_Leptophilic_UFO_ssx_emepmummupa_H
