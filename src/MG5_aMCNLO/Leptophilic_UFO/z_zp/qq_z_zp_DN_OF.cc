...
// Process: s s~ > e- e+ mu- mu+ WEIGHTED<=8 / h @1

//--------------------------------------------------------------------------
// Initialize process.

void qq_z_zp_DN_OF::initProc(string param_card_name)
{
    ...
    if (sum_hel == 0 || ntry < 10) {
        ...
        for (int ihel = 0; ihel < ncomb; ihel++) {
            if (goodhel[ihel] || ntry < 2) {
                ...
                t[0] = matrix_1_ssx_emepmummup_no_h();
                ...
                t[1] = matrix_1_ssx_emepmummup_no_h();
                double tsum = 0;
...
void qq_z_zp_DN_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV2_5_2(w[3], w[12], pars->GC_29, pars->GC_34, pars->mdl_Me, pars->ZERO,
             w[21]);
    FFV1_2(w[0], w[10], pars->GC_1, pars->mdl_MS, pars->ZERO, w[22]);
    FFV1_2(w[0], w[18], pars->GC_1, pars->mdl_MS, pars->ZERO, w[23]);
    FFV2_4_2(w[0], w[19], pars->GC_29, pars->GC_33, pars->mdl_MS, pars->ZERO,
             w[24]);
    ...
    FFV1_0(w[22], w[1], w[18], pars->GC_1, amp[24]);
    FFV1_0(w[23], w[1], w[10], pars->GC_1, amp[25]);
    FFV2_4_0(w[22], w[1], w[19], pars->GC_29, pars->GC_33, amp[26]);
    FFV1_0(w[24], w[1], w[10], pars->GC_1, amp[27]);
    FFV1_0(w[25], w[1], w[18], pars->GC_1, amp[28]);
    FFV2_4_0(w[23], w[1], w[11], pars->GC_29, pars->GC_33, amp[29]);
    FFV2_4_0(w[25], w[1], w[19], pars->GC_29, pars->GC_33, amp[30]);
    FFV2_4_0(w[24], w[1], w[11], pars->GC_29, pars->GC_33, amp[31]);
}
double qq_z_zp_DN_OF::matrix_1_ssx_emepmummup_no_h()
{
    int i, j;
    // Local variables
