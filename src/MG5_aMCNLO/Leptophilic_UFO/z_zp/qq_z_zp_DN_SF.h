...
#ifndef MG5_Sigma_Leptophilic_UFO_ssx_mummupmummup_H
#define MG5_Sigma_Leptophilic_UFO_ssx_mummupmummup_H
...
class qq_z_zp_DN_SF
{
  public:
    ...
    string name() const
    {
        return "s s~ > mu- mu+ mu- mu+ (Leptophilic_UFO)";
    }
  ...
  private:
    ...
    double matrix_2_ssx_mummupmummup_no_h();
...
#endif // MG5_Sigma_Leptophilic_UFO_ssx_mummupmummup_H
