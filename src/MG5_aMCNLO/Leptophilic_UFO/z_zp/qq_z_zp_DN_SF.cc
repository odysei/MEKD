...
// Process: s s~ > mu- mu+ mu- mu+ WEIGHTED<=8 / h @2

//--------------------------------------------------------------------------
// Initialize process.

void qq_z_zp_DN_SF::initProc(string param_card_name)
{
    ...
    if (sum_hel == 0 || ntry < 10) {
        ...
        for (int ihel = 0; ihel < ncomb; ihel++) {
            if (goodhel[ihel] || ntry < 2) {
                ...
                t[0] = matrix_2_ssx_mummupmummup_no_h();
                ...
                t[1] = matrix_2_ssx_mummupmummup_no_h();
                double tsum = 0;
...
void qq_z_zp_DN_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
    ...
    FFV2_5_3(w[5], w[4], pars->GC_29, pars->GC_34, pars->mdl_MZ, pars->mdl_WZ,
             w[27]);
    FFV1_2(w[0], w[10], pars->GC_1, pars->mdl_MS, pars->ZERO, w[28]);
    FFV1_2(w[0], w[26], pars->GC_1, pars->mdl_MS, pars->ZERO, w[29]);
    FFV2_4_2(w[0], w[27], pars->GC_29, pars->GC_33, pars->mdl_MS, pars->ZERO,
             w[30]);
    FFV2_4_2(w[0], w[11], pars->GC_29, pars->GC_33, pars->mdl_MS, pars->ZERO,
             w[31]);
    FFV1_2(w[0], w[17], pars->GC_1, pars->mdl_MS, pars->ZERO, w[32]);
    FFV1_2(w[0], w[22], pars->GC_1, pars->mdl_MS, pars->ZERO, w[33]);
    FFV2_4_2(w[0], w[23], pars->GC_29, pars->GC_33, pars->mdl_MS, pars->ZERO,
             w[34]);
    FFV2_4_2(w[0], w[18], pars->GC_29, pars->GC_33, pars->mdl_MS, pars->ZERO,
             w[35]);
    ...
    FFV1_0(w[28], w[1], w[26], pars->GC_1, amp[48]);
    FFV1_0(w[29], w[1], w[10], pars->GC_1, amp[49]);
    FFV2_4_0(w[28], w[1], w[27], pars->GC_29, pars->GC_33, amp[50]);
    FFV1_0(w[30], w[1], w[10], pars->GC_1, amp[51]);
    FFV1_0(w[31], w[1], w[26], pars->GC_1, amp[52]);
    FFV2_4_0(w[29], w[1], w[11], pars->GC_29, pars->GC_33, amp[53]);
    FFV2_4_0(w[31], w[1], w[27], pars->GC_29, pars->GC_33, amp[54]);
    FFV2_4_0(w[30], w[1], w[11], pars->GC_29, pars->GC_33, amp[55]);
    FFV1_0(w[32], w[1], w[22], pars->GC_1, amp[56]);
    FFV1_0(w[33], w[1], w[17], pars->GC_1, amp[57]);
    FFV2_4_0(w[32], w[1], w[23], pars->GC_29, pars->GC_33, amp[58]);
    FFV1_0(w[34], w[1], w[17], pars->GC_1, amp[59]);
    FFV1_0(w[35], w[1], w[22], pars->GC_1, amp[60]);
    FFV2_4_0(w[33], w[1], w[18], pars->GC_29, pars->GC_33, amp[61]);
    FFV2_4_0(w[35], w[1], w[23], pars->GC_29, pars->GC_33, amp[62]);
    FFV2_4_0(w[34], w[1], w[18], pars->GC_29, pars->GC_33, amp[63]);
}
double qq_z_zp_DN_SF::matrix_2_ssx_mummupmummup_no_h()
{
    int i, j;
    // Local variables
