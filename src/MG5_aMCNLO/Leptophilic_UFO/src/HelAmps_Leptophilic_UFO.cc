            ...
            std::complex<double> F1[])
{
    ...
    P1[2] = -F1[1].imag();
    P1[3] = -F1[0].imag();
    denom = COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) -
            ...
            std::complex<double> F1[])
{
    ...
    F1[4] = denom * -cI * M1 *
            (F2[2] * (V3[5] - V3[2]) + F2[3] * (V3[3] + cI * (V3[4])));
    F1[5] = denom * cI * M1 *
            ...
            std::complex<double> F2[])
{
    ...
    P2[2] = -F2[1].imag();
    P2[3] = -F2[0].imag();
    denom = COUP / ((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) -
            ...
            std::complex<double> V3[])
{
    ...
    denom = COUP / ((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) -
                    (P3[3] * P3[3]) - M3 * (M3 - cI * W3));
    V3[2] =
        denom * (-cI) * (F1[4] * F2[2] + F1[5] * F2[3] - P3[0] * OM3 * TMP3);
    V3[3] =
        denom * (-cI) * (F1[4] * F2[3] + F1[5] * F2[2] - P3[1] * OM3 * TMP3);
    V3[4] = denom * (-cI) *
            (-cI * (F1[5] * F2[2]) + cI * (F1[4] * F2[3]) - P3[2] * OM3 * TMP3);
    V3[5] =
        denom * (-cI) * (F1[4] * F2[2] - F1[5] * F2[3] - P3[3] * OM3 * TMP3);
}
            ...
            std::complex<double> &vertex)
{
    ...
    TMP0 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * (V3[4]))) +
            F1[3] * (F2[4] * (V3[3] - cI * (V3[4])) + F2[5] * (V3[2] - V3[5])));
    vertex = COUP * (-1.) * (+cI * (TMP0) + 4. * cI * (TMP5));
}
            ...
            std::complex<double> &vertex)
{
    ...
    TMP0 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * (V3[4]))) +
            F1[3] * (F2[4] * (V3[3] - cI * (V3[4])) + F2[5] * (V3[2] - V3[5])));
    vertex = COUP * (-1.) * (+cI * (TMP0) + 2. * cI * (TMP5));
}
            ...
            std::complex<double> F2[])
{
    ...
    denom = COUP / ((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) -
                    (P2[3] * P2[3]) - M2 * (M2 - cI * W2));
    F2[2] = denom * cI * M2 *
            (F1[4] * (V3[2] - V3[5]) + F1[5] * (+cI * (V3[4]) - V3[3]));
    F2[3] = denom * -cI * M2 *
            (F1[4] * (V3[3] + cI * (V3[4])) - F1[5] * (V3[2] + V3[5]));
    F2[4] =
        denom * cI *
        (F1[4] *
             (P2[0] * (V3[2] - V3[5]) +
    ...
    V3[3] = denom * 2. * cI *
            (OM3 * 1. / 2. * P3[1] * (TMP1 - 2. * (TMP3)) +
             (+1. / 2. * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] +
              F1[5] * F2[2]));
    V3[4] = denom * (-2. * cI) *
            (OM3 * 1. / 2. * P3[2] * (+2. * (TMP3)-TMP1) +
             (-1. / 2. * cI * (F1[2] * F2[5]) + 1. / 2. * cI * (F1[3] * F2[4]) -
              cI * (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
    V3[5] = denom * (-2. * cI) *
            (OM3 * 1. / 2. * P3[3] * (+2. * (TMP3)-TMP1) +
             (-1. / 2. * (F1[2] * F2[4]) + 1. / 2. * (F1[3] * F2[5]) -
              F1[4] * F2[2] + F1[5] * F2[3]));
}
