...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_5_3(w[0], w[1], pars->GC_51, pars->GC_58, pars->MZ, pars->WZ, w[4]); 
  
  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV2_4_0(w[3], w[2], w[4], pars->GC_50, pars->GC_59, amp[0]); 

}
double CPPProcess::matrix_uux_z_mummup() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 1; 
