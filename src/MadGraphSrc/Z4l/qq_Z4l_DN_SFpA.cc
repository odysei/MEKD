...
void qq_Z4l_DN_SFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void qq_Z4l_DN_SFpA::sigmaKin_BKG() 
{
...
void qq_Z4l_DN_SFpA::sigmaKin_SIG() 
{
  // Set the parameters which change event by event
  pars->setDependentParameters(); 
  pars->setDependentCouplings();
...
double qq_Z4l_DN_SFpA::sigmaHat() 
{
...
void qq_Z4l_DN_SFpA::calculate_wavefunctions_BKG(const int perm[], const int hel[])
{
...
void qq_Z4l_DN_SFpA::calculate_wavefunctions_SIG(const int perm[], const int hel[])
{
  // Calculate wavefunctions for all processes
//   int i, j; 
...
double qq_Z4l_DN_SFpA::matrix_ssx_mummupmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables
