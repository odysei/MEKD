...
void qq_Z4l_UP_OFpA::initProc(string param_card_name) 
{
...
void qq_Z4l_UP_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void qq_Z4l_UP_OFpA::sigmaKin_BKG() 
{
...
void qq_Z4l_UP_OFpA::sigmaKin_SIG() 
{
  // Set the parameters which change event by event
  pars->setDependentParameters(); 
  pars->setDependentCouplings();
...
double qq_Z4l_UP_OFpA::sigmaHat() 
{
...
void qq_Z4l_UP_OFpA::calculate_wavefunctions_BKG(const int perm[], const int hel[])
{
...
void qq_Z4l_UP_OFpA::calculate_wavefunctions_SIG(const int perm[], const int hel[])
{
  // Calculate wavefunctions for all processes
//   int i, j; 
...
double qq_Z4l_UP_OFpA::matrix_ccx_emepmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables
