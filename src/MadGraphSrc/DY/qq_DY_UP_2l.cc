...
// Process: c c~ > mu- mu+ WEIGHTED=4 / h zp xg

//--------------------------------------------------------------------------
// Initialize process.

void qq_DY_UP_2l::initProc(string param_card_name) 
{
...
void qq_DY_UP_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_DY_UP_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFV5_8_3(w[0], w[1], pars->HEF_MEKD2_1_GC_182, pars->HEF_MEKD2_1_GC_187, pars->MZ, pars->WZ, w[5]);
...
double qq_DY_UP_2l::matrix_ccx_mummup_no_hzpxg() 
{
  int i, j;
  // Local variables
