...
// Process: s s~ > mu- mu+ WEIGHTED=4 / h zp xg

//--------------------------------------------------------------------------
// Initialize process.

void qq_DY_DN_2l::initProc(string param_card_name) 
{
...
void qq_DY_DN_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_DY_DN_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFV2P0_3(w[0], w[1], pars->HEF_MEKD2_1_GC_3, pars->ZERO, pars->ZERO, w[4]);
  FFV5_6_3(w[0], w[1], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_187, pars->MZ, pars->WZ, w[5]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV2_0(w[3], w[2], w[4], pars->HEF_MEKD2_1_GC_5, amp[0]);
  FFV5_7_0(w[3], w[2], w[5], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[1]);

}
double qq_DY_DN_2l::matrix_ssx_mummup_no_hzpxg() 
{
  int i, j;
  // Local variables
