...
void qq_Spin0_DN_2lpA::initProc(string param_card_name) 
{
...
void qq_Spin0_DN_2lpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void qq_Spin0_DN_2lpA::sigmaKin() 
{
...
double qq_Spin0_DN_2lpA::sigmaHat() 
{
...
void qq_Spin0_DN_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_Spin0_DN_2lpA::matrix_ssx_h_mummupa_no_zpxg() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 4; 
