...
void gg_Spin0_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  VVS3_4_5_3(w[0], w[1], pars->HEF_MEKD2_1_GC_13, pars->HEF_MEKD2_1_GC_15, pars->HEF_MEKD2_1_GC_19, pars->MH,
      pars->WH, w[4]);
  VVS1_3(w[0], w[1], pars->HEF_MEKD2_1_GC_23, pars->MH, pars->WH, w[5]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFS1_2_0(w[3], w[2], w[4], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[0]);
  FFS1_2_0(w[3], w[2], w[5], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[1]);
