...
#ifndef MG5_Sigma_HEF_MEKD2_1_h_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_h_mummupmummupa_H
...
class Spin0_2f_SFpA
{
  public:
    ...
    virtual string name() const {return "h > mu- mu+ mu- mu+ a (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_h_mummupmummupa_no_zpxg();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_h_mummupmummupa_H
