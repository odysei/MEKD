...
void qq_Spin0_UP_2lpA::initProc(string param_card_name) 
{
...
void qq_Spin0_UP_2lpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings();
	ntry = 0, sum_hel = 0, ngood = 0;	// moved here by Ghost remover v. 0.1 
...
void qq_Spin0_UP_2lpA::sigmaKin() 
{
...
double qq_Spin0_UP_2lpA::sigmaHat() 
{
...
void qq_Spin0_UP_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double qq_Spin0_UP_2lpA::matrix_ccx_h_mummupa_no_zpxg() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 4; 
