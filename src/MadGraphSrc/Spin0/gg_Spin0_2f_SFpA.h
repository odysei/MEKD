...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_h_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_gg_h_mummupmummupa_H
...
class gg_Spin0_2f_SFpA
{
  ...
  private:
    ...
    static const int nwavefuncs = 85;
...
#endif  // MG5_Sigma_HEF_MEKD2_1_gg_h_mummupmummupa_H
