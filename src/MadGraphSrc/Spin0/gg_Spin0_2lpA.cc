...
void gg_Spin0_2lpA::initProc(string param_card_name) 
{
...
void gg_Spin0_2lpA::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void gg_Spin0_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  VVS1_3(w[0], w[1], pars->HEF_MEKD2_1_GC_23, pars->MH, pars->WH, w[7]);
  FFV2_2(w[3], w[4], pars->HEF_MEKD2_1_GC_5, pars->MM, pars->ZERO, w[8]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFS1_2_0(w[3], w[6], w[5], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[0]);
  FFS1_2_0(w[3], w[6], w[7], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[1]);
  FFS1_2_0(w[8], w[2], w[5], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[2]);
  FFS1_2_0(w[8], w[2], w[7], pars->HEF_MEKD2_1_GC_137, pars->HEF_MEKD2_1_GC_136, amp[3]);

}
double gg_Spin0_2lpA::matrix_gg_h_mummupa_no_zpxg() 
{
  int i, j;
  // Local variables
