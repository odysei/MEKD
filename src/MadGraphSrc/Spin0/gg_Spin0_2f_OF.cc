...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFS1_2_1(w[2], w[6], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126, pars->Me, pars->ZERO,
      w[16]);
  FFS1_2_2(w[3], w[6], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126, pars->Me, pars->ZERO,
      w[17]);
  FFS1_2_1(w[2], w[11], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126, pars->Me, pars->ZERO,
      w[18]);
  FFS1_2_2(w[3], w[11], pars->HEF_MEKD2_1_GC_127, pars->HEF_MEKD2_1_GC_126, pars->Me, pars->ZERO,
      w[19]);
...
//   VVS2_0(w[10], w[14], w[11], pars->HEF_MEKD2_1_GC_25, amp[11]);	//ZZ
  ...
  FFV5_7_0(w[3], w[16], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[14]);
  FFV5_7_0(w[17], w[2], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[15]);
  FFV2_0(w[3], w[18], w[15], pars->HEF_MEKD2_1_GC_5, amp[16]);
  FFV2_0(w[19], w[2], w[15], pars->HEF_MEKD2_1_GC_5, amp[17]);
  FFV5_7_0(w[3], w[18], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[18]);
