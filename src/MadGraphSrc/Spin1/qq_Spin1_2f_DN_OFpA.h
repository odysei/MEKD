...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_zp_emepmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_zp_emepmummupa_H
...
class qq_Spin1_2f_DN_OFpA
{
  ...
  private:
    ...
    double matrix_ssx_zp_emepmummupa_no_hxg();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_ssx_zp_emepmummupa_H
