...
// Process: c c~ > zp > mu- mu+ a WEIGHTED=4 / h xg

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin1_UP_2lpA::initProc(string param_card_name) 
{
...
void qq_Spin1_UP_2lpA::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_Spin1_UP_2lpA::sigmaKin() 
{
...
double qq_Spin1_UP_2lpA::sigmaHat() 
{
...
void qq_Spin1_UP_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFV1_2_3_4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_111, pars->HEF_MEKD2_1_GC_108, pars->HEF_MEKD2_1_GC_109,
      pars->HEF_MEKD2_1_GC_110, pars->MZp, pars->WZp, w[5]);
  ...
  FFV1_2_3_4_3(w[3], w[2], pars->HEF_MEKD2_1_GC_141, pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
      pars->HEF_MEKD2_1_GC_140, pars->MZp, pars->WZp, w[9]);
  FFV2_1(w[1], w[4], pars->HEF_MEKD2_1_GC_4, pars->MC, pars->ZERO, w[10]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_2_3_4_0(w[3], w[6], w[5], pars->HEF_MEKD2_1_GC_141, pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
      pars->HEF_MEKD2_1_GC_140, amp[0]);
  FFV1_2_3_4_0(w[7], w[2], w[5], pars->HEF_MEKD2_1_GC_141, pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
      pars->HEF_MEKD2_1_GC_140, amp[1]);
  FFV1_2_3_4_0(w[8], w[1], w[9], pars->HEF_MEKD2_1_GC_111, pars->HEF_MEKD2_1_GC_108, pars->HEF_MEKD2_1_GC_109,
      pars->HEF_MEKD2_1_GC_110, amp[2]);
  FFV1_2_3_4_0(w[0], w[10], w[9], pars->HEF_MEKD2_1_GC_111, pars->HEF_MEKD2_1_GC_108, pars->HEF_MEKD2_1_GC_109,
      pars->HEF_MEKD2_1_GC_110, amp[3]);

}
double qq_Spin1_UP_2lpA::matrix_ccx_zp_mummupa_no_hxg() 
{
  int i, j;
  // Local variables
