...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummup_H
...
class qq_Spin1_2f_DN_SF
{
  public:
    ...
    virtual string name() const {return "s s~ > mu- mu+ mu- mu+ (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_ssx_zp_mummupmummup_no_hxg();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummup_H
