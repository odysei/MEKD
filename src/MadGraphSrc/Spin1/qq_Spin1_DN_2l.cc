...
// Process: s s~ > zp > mu- mu+ WEIGHTED=2 / h xg

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin1_DN_2l::initProc(string param_card_name) 
{
...
void qq_Spin1_DN_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
double qq_Spin1_DN_2l::sigmaHat() 
{
...
void qq_Spin1_DN_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFV1_2_3_4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_151, pars->HEF_MEKD2_1_GC_148, pars->HEF_MEKD2_1_GC_149,
      pars->HEF_MEKD2_1_GC_150, pars->MZp, pars->WZp, w[4]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_2_3_4_0(w[3], w[2], w[4], pars->HEF_MEKD2_1_GC_141, pars->HEF_MEKD2_1_GC_138, pars->HEF_MEKD2_1_GC_139,
      pars->HEF_MEKD2_1_GC_140, amp[0]);

}
double qq_Spin1_DN_2l::matrix_ssx_zp_mummup_no_hxg() 
{
  int i, j;
  // Local variables
