...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummupa_H
...
class qq_Spin1_2f_DN_SFpA
{
  ...
  private:
    ...
    double matrix_ssx_zp_mummupmummupa_no_hxg();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_ssx_zp_mummupmummupa_H
