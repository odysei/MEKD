...
void qq_Spin1_DN_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFV1_2_3_4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_151, pars->HEF_MEKD2_1_GC_148, pars->HEF_MEKD2_1_GC_149,
      pars->HEF_MEKD2_1_GC_150, pars->MZp, pars->WZp, w[5]);
  ...
  FFV1_2_3_4_0(w[8], w[1], w[9], pars->HEF_MEKD2_1_GC_151, pars->HEF_MEKD2_1_GC_148, pars->HEF_MEKD2_1_GC_149,
      pars->HEF_MEKD2_1_GC_150, amp[2]);
  FFV1_2_3_4_0(w[0], w[10], w[9], pars->HEF_MEKD2_1_GC_151, pars->HEF_MEKD2_1_GC_148, pars->HEF_MEKD2_1_GC_149,
