...
// Process: g g > xg > mu- mu+ WEIGHTED=2 / h zp

//--------------------------------------------------------------------------
// Initialize process.

void gg_Spin2_2l::initProc(string param_card_name) 
{
...
void gg_Spin2_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void gg_Spin2_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  VVT1_10_11_12_13_3_5_7_8_9_3(w[0], w[1], pars->HEF_MEKD2_1_GC_86, pars->HEF_MEKD2_1_GC_72,
      ...
      pars->HEF_MEKD2_1_GC_84, pars->HEF_MEKD2_1_GC_76, pars->HEF_MEKD2_1_GC_82, pars->MXG, pars->WXG, w[4]);
  VVT4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_63, pars->MXG, pars->WXG, w[5]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFT1_2_3_5_0(w[3], w[2], w[4], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, amp[0]);
  FFT1_2_3_5_0(w[3], w[2], w[5], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, amp[1]);

}
double gg_Spin2_2l::matrix_gg_xg_mummup_no_hzp() 
{
  int i, j;
  // Local variables
