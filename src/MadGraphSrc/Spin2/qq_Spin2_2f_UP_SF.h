...
#ifndef MG5_Sigma_HEF_MEKD2_1_ccx_xg_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_ccx_xg_mummupmummup_H
...
class qq_Spin2_2f_UP_SF
{
  ...
  private:
    ...
    double matrix_ccx_xg_mummupmummup_no_zph();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_ccx_xg_mummupmummup_H
