...
// Process: s s~ > xg > mu- mu+ WEIGHTED=2 / h zp

//--------------------------------------------------------------------------
// Initialize process.

void qq_Spin2_DN_2l::initProc(string param_card_name) 
{
...
void qq_Spin2_DN_2l::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
double qq_Spin2_DN_2l::sigmaHat() 
{
...
void qq_Spin2_DN_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFT1_2_3_5_3(w[0], w[1], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
      pars->HEF_MEKD2_1_GC_154, pars->MXG, pars->WXG, w[4]);
...
double qq_Spin2_DN_2l::matrix_ssx_xg_mummup_no_hzp() 
{
  int i, j;
  // Local variables
