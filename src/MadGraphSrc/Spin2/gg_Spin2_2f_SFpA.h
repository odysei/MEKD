...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummupa_H
...
class gg_Spin2_2f_SFpA
{
  public:
    ...
    virtual string name() const {return "g g > mu- mu+ mu- mu+ a (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_gg_xg_mummupmummupa_no_zph();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummupa_H
