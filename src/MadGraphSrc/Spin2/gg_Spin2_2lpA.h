...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupa_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupa_H
...
class gg_Spin2_2lpA
{
  public:
    ...
    virtual string name() const {return "g g > mu- mu+ a (HEF_MEKD2_1)";}
...
#endif  // MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupa_H
