...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummupa_H
...
class gg_Spin2_2f_OFpA
{
  public:
    ...
    virtual string name() const {return "g g > e- e+ mu- mu+ a (HEF_MEKD2_1)";}
  ...
  private:
    ...
    static const int namplitudes = 84;
    std::complex<double> amp[namplitudes];
	int ntry, sum_hel, ngood;	// Moved here by Convert_source 0.2 
    double matrix_gg_xg_emepmummupa_no_zph();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_gg_xg_emepmummupa_H
