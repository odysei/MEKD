...
#ifndef MG5_Sigma_HEF_MEKD2_1_xg_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_xg_mummupmummupa_H
...
class Spin2_2f_SFpA
{
  public:
    ...
    virtual string name() const {return "xg > mu- mu+ mu- mu+ a (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_xg_mummupmummupa_no_hzp();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_xg_mummupmummupa_H
