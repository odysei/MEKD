...
#ifndef MG5_Sigma_HEF_MEKD2_1_ssx_xg_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD2_1_ssx_xg_mummupmummupa_H
...
class qq_Spin2_2f_DN_SFpA
{
  public:
    ...
    virtual string name() const {return "s s~ > mu- mu+ mu- mu+ a (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_ssx_xg_mummupmummupa_no_zph();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_ssx_xg_mummupmummupa_H
