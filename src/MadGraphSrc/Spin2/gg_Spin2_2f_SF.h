...
#ifndef MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummup_H
#define MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummup_H
...
class gg_Spin2_2f_SF
{
  public:
    ...
    virtual string name() const {return "g g > mu- mu+ mu- mu+ (HEF_MEKD2_1)";}
  ...
  private:
    ...
    double matrix_gg_xg_mummupmummup_no_zph();
...
#endif  // MG5_Sigma_HEF_MEKD2_1_gg_xg_mummupmummup_H
