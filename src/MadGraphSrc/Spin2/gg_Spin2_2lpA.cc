...
// Process: g g > xg > mu- mu+ a WEIGHTED=4 / h zp

//--------------------------------------------------------------------------
// Initialize process.

void gg_Spin2_2lpA::initProc(string param_card_name) 
{
...
void gg_Spin2_2lpA::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void gg_Spin2_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  VVT1_10_11_12_13_3_5_7_8_9_3(w[0], w[1], pars->HEF_MEKD2_1_GC_86, pars->HEF_MEKD2_1_GC_72,
      ...
      pars->HEF_MEKD2_1_GC_84, pars->HEF_MEKD2_1_GC_76, pars->HEF_MEKD2_1_GC_82, pars->MXG, pars->WXG, w[5]);
  FFV2_1(w[2], w[4], pars->HEF_MEKD2_1_GC_5, pars->MM, pars->ZERO, w[6]);
  VVT4_3(w[0], w[1], pars->HEF_MEKD2_1_GC_63, pars->MXG, pars->WXG, w[7]);
  ...
  FFT1_2_3_5_0(w[3], w[6], w[7], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, amp[1]);
  FFT1_2_3_5_0(w[8], w[2], w[5], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, amp[2]);
  FFT1_2_3_5_0(w[8], w[2], w[7], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, amp[3]);

}
double gg_Spin2_2lpA::matrix_gg_xg_mummupa_no_hzp() 
{
  int i, j;
  // Local variables
