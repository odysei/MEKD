...
void gg_Spin2_2f_SF::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFT1_2_3_5_2(w[3], w[6], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
      pars->HEF_MEKD2_1_GC_144, pars->MM, pars->ZERO, w[16]);
  FFV5_7_3(w[5], w[2], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, pars->MZ, pars->WZ, w[17]);
  FFT1_2_3_5_2(w[3], w[11], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
  ...
  FFT1_2_3_5_1(w[2], w[11], pars->HEF_MEKD2_1_GC_145, pars->HEF_MEKD2_1_GC_142, pars->HEF_MEKD2_1_GC_143,
...
//       pars->HEF_MEKD2_1_GC_85, pars->HEF_MEKD2_1_GC_79, pars->HEF_MEKD2_1_GC_83, amp[8]);	// ZZ
  ...
  FFV5_7_0(w[16], w[4], w[17], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[11]);
  FFV5_7_0(w[3], w[8], w[17], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[12]);
  FFV2_0(w[18], w[4], w[15], pars->HEF_MEKD2_1_GC_5, amp[13]);
  FFV2_0(w[3], w[12], w[15], pars->HEF_MEKD2_1_GC_5, amp[14]);
  FFV5_7_0(w[18], w[4], w[17], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[15]);
  FFV5_7_0(w[3], w[12], w[17], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[16]);
//   VVT10_11_12_13_2_3_6_7_8_9_0(w[17], w[19], w[6], pars->HEF_MEKD2_1_GC_75, pars->HEF_MEKD2_1_GC_81,
//       pars->HEF_MEKD2_1_GC_67, pars->HEF_MEKD2_1_GC_71, pars->HEF_MEKD2_1_GC_90, pars->HEF_MEKD2_1_GC_92, pars->HEF_MEKD2_1_GC_63,
//       pars->HEF_MEKD2_1_GC_85, pars->HEF_MEKD2_1_GC_79, pars->HEF_MEKD2_1_GC_83, amp[17]);	// ZZ
  FFV2_0(w[5], w[21], w[20], pars->HEF_MEKD2_1_GC_5, amp[18]);
  FFV2_0(w[9], w[2], w[20], pars->HEF_MEKD2_1_GC_5, amp[19]);
  FFV5_7_0(w[5], w[21], w[19], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[20]);
  FFV5_7_0(w[9], w[2], w[19], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[21]);
  FFV2_0(w[5], w[22], w[20], pars->HEF_MEKD2_1_GC_5, amp[22]);
  FFV2_0(w[13], w[2], w[20], pars->HEF_MEKD2_1_GC_5, amp[23]);
  FFV5_7_0(w[5], w[22], w[19], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[24]);
  FFV5_7_0(w[13], w[2], w[19], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[25]);
  FFV2_0(w[3], w[21], w[23], pars->HEF_MEKD2_1_GC_5, amp[26]);
  FFV2_0(w[16], w[2], w[23], pars->HEF_MEKD2_1_GC_5, amp[27]);
  FFV5_7_0(w[3], w[21], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[28]);
  FFV5_7_0(w[16], w[2], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[29]);
  FFV2_0(w[3], w[22], w[23], pars->HEF_MEKD2_1_GC_5, amp[30]);
  FFV2_0(w[18], w[2], w[23], pars->HEF_MEKD2_1_GC_5, amp[31]);
  FFV5_7_0(w[3], w[22], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[32]);
  FFV5_7_0(w[18], w[2], w[14], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_188, amp[33]);
...
//  const int ngraphs = 34;
  ...
  jamp[0] = +2. * (+amp[0] + amp[1] + amp[2] + amp[3] + amp[4] + amp[5] +
      ...
      amp[28] + amp[29] + amp[30] + amp[31] + amp[32] + amp[33]);
