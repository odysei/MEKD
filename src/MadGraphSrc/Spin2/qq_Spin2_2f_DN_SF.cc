...
void qq_Spin2_2f_DN_SF::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_Spin2_2f_DN_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//       w[38]);
//   FFT1_2_3_5_2(w[0], w[23], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
...
//   FFT1_2_3_5_2(w[0], w[27], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
...
//   FFT1_2_3_5_0(w[34], w[1], w[12], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[39]);	// t ch.
//   FFV5_6_0(w[33], w[1], w[18], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_187, amp[40]);	// t ch.
//   FFT1_2_3_5_0(w[35], w[1], w[12], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[41]);	// t ch.
//   FFT1_2_3_5_0(w[36], w[1], w[19], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[42]);	// t ch.
//   FFV2_0(w[37], w[1], w[7], pars->HEF_MEKD2_1_GC_3, amp[43]);	// t ch.
//   FFT1_2_3_5_0(w[38], w[1], w[19], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[44]);	// t ch.
//   FFV5_6_0(w[37], w[1], w[10], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_187, amp[45]);	// t ch.
//   FFV2_0(w[39], w[1], w[28], pars->HEF_MEKD2_1_GC_3, amp[46]);	// t ch.
//   FFT1_2_3_5_0(w[40], w[1], w[23], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[47]);	// t ch.
//   FFV5_6_0(w[39], w[1], w[26], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_187, amp[48]);	// t ch.
//   FFT1_2_3_5_0(w[41], w[1], w[23], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[49]);	// t ch.
//   FFT1_2_3_5_0(w[42], w[1], w[27], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[50]);	// t ch.
//   FFV2_0(w[43], w[1], w[20], pars->HEF_MEKD2_1_GC_3, amp[51]);	// t ch.
//   FFT1_2_3_5_0(w[44], w[1], w[27], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
//       pars->HEF_MEKD2_1_GC_154, amp[52]);	// t ch.
//   FFV5_6_0(w[43], w[1], w[22], pars->HEF_MEKD2_1_GC_181, pars->HEF_MEKD2_1_GC_187, amp[53]);	// t ch.
