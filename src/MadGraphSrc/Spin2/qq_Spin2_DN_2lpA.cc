...
void qq_Spin2_DN_2lpA::updateProc(SLHAReader slha)
{
	pars->setIndependentParameters(slha);
	pars->setIndependentCouplings();
...
void qq_Spin2_DN_2lpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//	int i, j;	// Changed by Convert_source 0.2
  ...
  FFT1_2_3_5_3(w[0], w[1], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
      pars->HEF_MEKD2_1_GC_154, pars->MXG, pars->WXG, w[5]);
  ...
  FFT1_2_3_5_0(w[8], w[1], w[9], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
      pars->HEF_MEKD2_1_GC_154, amp[2]);
  FFT1_2_3_5_0(w[0], w[10], w[9], pars->HEF_MEKD2_1_GC_155, pars->HEF_MEKD2_1_GC_152, pars->HEF_MEKD2_1_GC_153,
