...
/*
 * 
 * TEST Block "on the fly". Legacy functionality
 *
 */
...
int MEKD_Test_Functionality_Test1(input &in)
{
	...
	test1.computeKD((string) "ggSpin0Pm", (string) "ZZ",
					(*in.p)[0], (*in.id)[0], (*in.p)[1], (*in.id)[1],
					(*in.p)[2], (*in.id)[2], (*in.p)[3], (*in.id)[3],
					KD1, ME11, ME21);
...
// {
// 	if (!Reference_is_calculated)
// 		MEKD_Test_Functionality_Test1();
// 	/// TEST 2
// 	if (Show_Description)
// 		cout << "\n -- STARTING TEST 2 -- \n";
...
// 	}
// 
// 	if (fabs(KD1 - KD2) < Precision_of_interest &&
// 		fabs(ME11 - ME12) < Precision_of_interest &&
// 		fabs(ME21 - ME22) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	}
// 
// 	if (fabs(KD1 - KD3) < Precision_of_interest &&
// 		fabs(ME11 - ME13) < Precision_of_interest &&
// 		fabs(ME21 - ME23) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	}
// 
// 	if (fabs(KD1 - KD4) < Precision_of_interest &&
// 		fabs(ME11 - ME14) < Precision_of_interest &&
// 		fabs(ME21 - ME24) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	}
// 
// 	if (fabs(KD1 - KD1_p2) < Precision_of_interest &&
// 		fabs(ME11 - ME11_p2) < Precision_of_interest &&
// 		fabs(ME21 - ME21_p2) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	}
// 
// 	if (fabs(KD1 - KD2_p2) < Precision_of_interest &&
// 		fabs(ME11 - ME12_p2) < Precision_of_interest &&
// 		fabs(ME21 - ME22_p2) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	}
// 
// 	if (fabs(KD1 - KD3_p2) < Precision_of_interest &&
// 		fabs(ME11 - ME13_p2) < Precision_of_interest &&
// 		fabs(ME21 - ME23_p2) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
// 
...
// 	test4_p2.computeKD((string) "ggSpin0Pm", (string) "ZZ", KD4_p2, ME14_p2,
// 					   ME24_p2);
// 
// 	if (Show_Basic_Data) {
// 		cout << "Output: ME1 ME2 KD\n";
...
// 	}
// 
// 	if (fabs(KD1 - KD4_p2) < Precision_of_interest &&
// 		fabs(ME11 - ME14_p2) < Precision_of_interest &&
// 		fabs(ME21 - ME24_p2) < Precision_of_interest)
// 		return 0;
// 	return 1;
// }
