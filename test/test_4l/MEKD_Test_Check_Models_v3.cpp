...
vector<string> MEKD_Test_Check_Models_Test2_make_list_str();	// v2 legacy
...
vector<string> MEKD_Test_Check_Models_Test3_make_list_str();	// v2 legacy
...
int MEKD_Test_Check_Models_Test2(input &in)
{
	...
	vector<string> models_v2 =
		MEKD_Test_Check_Models_Test2_make_list_str();
	vector<double> MEs, MEsA;
	
	if (models.size() != modelsA.size() ||
		models.size() != models_v2.size()) {
	...
	// setting collinear to the first lepton
	inA.p->push_back(new double[4] {0.4, 0.23,
								    0.221, -0.24136902});
...
int MEKD_Test_Check_Models_Test3(input &in)
{
	...
	vector<string> models_v2 =
		MEKD_Test_Check_Models_Test3_make_list_str();
	vector<double> MEs, MEsA;
