...
// 								   25.779897736999999, 140.32608132999999});
	...
	in.p->push_back(new double[4] {412.3504456163, 300,
								   200, 100});
	
	in.p->push_back(new double[4] {269.3193086283, -200,
								   -40, 30});
	
	in.p->push_back(new double[4] {111.881510536, 100,
								   40, -30});
	
	in.p->push_back(new double[4] {47.3547505537, -10,
								   -45, -10});
