...
class MEKD
{
  ...
  public:
    ...
    // RAW MG5_aMC ME
    int Run_ME_Configurator_CPPProcess(const process_description &, data &);
    ...
    void Run_ME_Configurator_Spin2_decay(const std::complex<double> *c,
                                         ...
                                         SLHAReader_MEKD &par_MG);
    // SM Higgs
    int Run_ME_Configurator_Spin0Pm(const process_description &, data &);
    // Exotic models
    int Run_ME_Configurator_Spin0M(const process_description &, data &);
    int Run_ME_Configurator_Spin0Ph(const process_description &, data &);
    int Run_ME_Configurator_Spin1P(const process_description &, data &);
    int Run_ME_Configurator_Spin1M(const process_description &, data &);
    int Run_ME_Configurator_Spin2Pm(const process_description &, data &);
    int Run_ME_Configurator_Spin2Ph(const process_description &, data &);
    int Run_ME_Configurator_Spin2Mh(const process_description &, data &);
    int Run_ME_Configurator_Spin2Pb(const process_description &, data &);
    int Run_ME_Configurator_Spin2Ph2(const process_description &, data &);
    int Run_ME_Configurator_Spin2Ph3(const process_description &, data &);
    int Run_ME_Configurator_Spin2Ph6(const process_description &, data &);
    int Run_ME_Configurator_Spin2Ph7(const process_description &, data &);
    int Run_ME_Configurator_Spin2Mh9(const process_description &, data &);
    int Run_ME_Configurator_Spin2Mh10(const process_description &, data &);
    // A mixed state of two contributions
    int Run_ME_Configurator_Spin0Pm_Spin0M(const process_description &, data &);
    int Run_ME_Configurator_Spin0Pm_Spin0Ph(const process_description &,
                                            data &);
    int Run_ME_Configurator_Spin0M_Spin0Ph(const process_description &, data &);
  ...
  private:
    ...
    int Run_ME_Dispatcher_BKG_ZZ(const process_description &, data &);
    int Run_ME_Dispatcher_Z4l_BKG(const process_description &, data &);
    int Run_ME_Dispatcher_Z4l_SIG(const process_description &, data &);
    int Run_ME_Dispatcher_SIG_Spin0(const process_description &, data &);
    int Run_ME_Dispatcher_SIG_Spin1(const process_description &, data &);
    int Run_ME_Dispatcher_SIG_Spin2(const process_description &, data &);

    /// Evaluators. Blind-calculation functions. Handles MEs from Dispatchers.
    /// Tier 1
    template <class Generic_MEKD_ME>
    int Run_MEs_Evaluator_Initial_State_NO(data &da, const bool photon,
                                           Generic_MEKD_ME &Generic_ME);

    template <class Generic_MEKD_ME>
    int Run_MEs_Evaluator_Initial_State_gg(data &da, const bool photon,
                                           Generic_MEKD_ME &Generic_ME);
